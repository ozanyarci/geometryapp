...
Q11 EF 5.0 FK 7.000000000000001 EFK 119.99999999999999 area 60.62177826491071 35√3 60.6217782649107
  ...
  // ---------------------------------------------------------------- 134
  {
    id: 'quadrilaterals-134',
    topic: 'Dikdörtgende köşegene dikme ve Öklit bağıntısı',
    figure: {
      viewBox: '0 0 400 181',
      caption: 'Şekil 134',
      label:
        'ABCD dikdörtgeninde [AC] köşegen; D den [AC] ye inen dikmenin ayağı H; HBC üçgeni taralı.',
      svg: `
          <path class="shade" d="M124.9,128.2 L325.2,153.2 L325.2,28.0 Z"/>
          <path class="ln" d="M74.8,153.2 L325.2,153.2 L325.2,28.0 L74.8,28.0 Z"/>
          <path class="ln" d="M74.8,153.2 L325.2,28.0"/>
          <path class="ln" d="M74.8,28.0 L124.9,128.2 L325.2,153.2"/>
          <path class="arc" d="M120.8,120.1 L128.9,116.1 L132.9,124.2"/>
          <circle class="pt" cx="74.8" cy="153.2" r="3.2"/>
          <circle class="pt" cx="325.2" cy="153.2" r="3.2"/>
          <circle class="pt" cx="325.2" cy="28.0" r="3.2"/>
          <circle class="pt" cx="74.8" cy="28.0" r="3.2"/>
          <circle class="pt" cx="124.9" cy="128.2" r="3.2"/>
          <text x="64.8" y="168.2" text-anchor="end">A</text>
          <text x="335.2" y="168.2">B</text>
          <text x="335.2" y="23.0">C</text>
          <text x="64.8" y="23.0" text-anchor="end">D</text>
          <text x="128.9" y="150.2" text-anchor="middle">H</text>
        `,
    },
    given: [
      'ABCD dikdörtgen',
    ...
    stem: [],
    ask: 'Yukarıdaki verilere göre, A(HBC) kaç cm² dir?',
    choices: [
      { key: 'A', text: '48' },
      { key: 'B', text: '56' },
      { key: 'C', text: '60' },
    ...
    answer: 'D',
    hint: 'ADC dik üçgeninde Öklit bağıntısıyla |DH| yi bul; B nin [AC] ye uzaklığı da |DH| ye eşittir.',
    solution: [
      {
        title: 'Öklit bağıntısı',
        detail:
          'ADC dik üçgeninde |DH|² = |AH| · |HC| = 4 · 16 = 64, |DH| = 8 cm.',
      },
      {
        title: 'B nin köşegene uzaklığı',
        detail:
          'ABC ve CDA üçgenleri eş olduğundan B den [AC] ye inen dikme de 8 cm dir.',
      },
      {
        title: 'Alan',
        detail:
          'HBC üçgeninin tabanı |HC| = 16 cm, yüksekliği 8 cm: A(HBC) = 16 · 8 / 2.',
      },
      {
        title: 'Sonuç',
        detail:
  ...
  // ---------------------------------------------------------------- 135
  {
    id: 'quadrilaterals-135',
    topic: 'Karede eş üçgenler ve açı',
    figure: {
      viewBox: '0 0 400 292',
      caption: 'Şekil 135',
      label:
        'ABCD karesinde E noktası [AB] üzerinde, F noktası [BC] üzerinde; m(ADE) = m(FDC) = 20°; m(DEF) = α.',
      svg: `
          <path class="ln" d="M82.0,264.0 L318.0,264.0 L318.0,28.0 L82.0,28.0 Z"/>
          <path class="ln" d="M167.9,264.0 L82.0,28.0 L318.0,113.9 L167.9,264.0"/>
          <path class="arc" d="M82.0,68.0 A40,40 0 0 0 95.7,65.6"/>
          <path class="arc" d="M125.2,43.7 A46,46 0 0 0 128.0,28.0"/>
          <path class="arc" d="M186.3,245.6 A26,26 0 0 0 159.0,239.6"/>
          <text class="val" x="98.3" y="125.6" text-anchor="middle">20°</text>
          <text class="val" x="174.6" y="49.3" text-anchor="middle">20°</text>
          <text class="val" x="177.0" y="228.0" text-anchor="middle">α</text>
          <circle class="pt" cx="82.0" cy="264.0" r="3.2"/>
          <circle class="pt" cx="318.0" cy="264.0" r="3.2"/>
          <circle class="pt" cx="318.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="82.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="167.9" cy="264.0" r="3.2"/>
          <circle class="pt" cx="318.0" cy="113.9" r="3.2"/>
          <text x="72.0" y="279.0" text-anchor="end">A</text>
          <text x="328.0" y="279.0">B</text>
          <text x="328.0" y="23.0">C</text>
          <text x="72.0" y="23.0" text-anchor="end">D</text>
          <text x="167.9" y="283.0" text-anchor="middle">E</text>
          <text x="328.0" y="118.9">F</text>
        `,
    },
    given: [
      'ABCD kare',
    ...
    answer: 'C',
    hint: 'DAE ve DCF üçgenlerinin eş olduğunu göster; DEF üçgeni ikizkenar olur.',
    solution: [
      {
        title: 'Eş üçgenler',
        detail:
          '|DA| = |DC|, m(A) = m(C) = 90° ve m(ADE) = m(CDF) = 20° olduğundan DAE ≅ DCF; buradan |DE| = |DF|.',
      },
      {
        title: 'Tepe açısı',
        detail:
      ...
      },
      {
        title: 'İkizkenar üçgen',
        detail:
          'DEF üçgeninde taban açıları eşittir: α = (180° − 50°) / 2.',
      },
      {
        title: 'Sonuç',
        detail:
  ...
  // ---------------------------------------------------------------- 136
  {
    id: 'quadrilaterals-136',
    topic: 'Dikdörtgende köşegene dikme ve alan',
    figure: {
      viewBox: '0 0 400 215',
      caption: 'Şekil 136',
      label:
        'ABCD dikdörtgeninde [BD] köşegen; C den [BD] ye inen dikmenin ayağı H.',
      svg: `
          <path class="ln" d="M81.0,186.6 L319.0,186.6 L319.0,28.0 L81.0,28.0 Z"/>
          <path class="ln" d="M81.0,28.0 L319.0,186.6"/>
          <path class="ln" d="M319.0,28.0 L245.8,137.8"/>
          <path class="arc" d="M250.8,130.3 L258.2,135.3 L253.3,142.8"/>
          <circle class="pt" cx="81.0" cy="186.6" r="3.2"/>
          <circle class="pt" cx="319.0" cy="186.6" r="3.2"/>
          <circle class="pt" cx="319.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="81.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="245.8" cy="137.8" r="3.2"/>
          <text x="71.0" y="201.6" text-anchor="end">A</text>
          <text x="329.0" y="201.6">B</text>
          <text x="329.0" y="23.0">C</text>
          <text x="71.0" y="23.0" text-anchor="end">D</text>
          <text x="229.8" y="149.8" text-anchor="middle">H</text>
        `,
    },
    given: [
      'ABCD dikdörtgen',
    ...
    answer: 'D',
    hint: 'BCD dik üçgeninde Öklit bağıntısıyla |CH| yi bul; dikdörtgenin alanı BCD üçgeninin alanının iki katıdır.',
    solution: [
      {
        title: 'Öklit bağıntısı',
        detail:
          'BCD dik üçgeninde |CH|² = |DH| · |HB| = 18 · 8 = 144, |CH| = 12 cm.',
      },
      {
        title: 'Köşegen',
        detail:
      ...
      },
      {
        title: 'BCD üçgeni',
        detail:
          'A(BCD) = |BD| · |CH| / 2 = 26 · 12 / 2 = 156 cm².',
      },
      {
        title: 'Sonuç',
        detail:
          'A(ABCD) = 2 · 156 = 312 cm² bulunur.',
      },
    ],
  },
  // ---------------------------------------------------------------- 137
  {
    id: 'quadrilaterals-137',
    topic: 'Dikdörtgende dik açıyla benzerlik',
    figure: {
      viewBox: '0 0 400 176',
      caption: 'Şekil 137',
      label:
        'ABCD dikdörtgeninde E noktası [AB] üzerinde; [DE] ile [EC] dik.',
      svg: `
          <path class="ln" d="M70.0,148.0 L330.0,148.0 L330.0,28.0 L70.0,28.0 Z"/>
          <path class="ln" d="M70.0,28.0 L150.0,148.0 L330.0,28.0"/>
          <path class="arc" d="M145.0,140.5 L152.5,135.5 L157.5,143.0"/>
          <circle class="pt" cx="70.0" cy="148.0" r="3.2"/>
          <circle class="pt" cx="330.0" cy="148.0" r="3.2"/>
          <circle class="pt" cx="330.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="70.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="150.0" cy="148.0" r="3.2"/>
          <text x="60.0" y="163.0" text-anchor="end">A</text>
          <text x="340.0" y="163.0">B</text>
          <text x="340.0" y="23.0">C</text>
          <text x="60.0" y="23.0" text-anchor="end">D</text>
          <text x="150.0" y="167.0" text-anchor="middle">E</text>
        `,
    },
    given: [
      'ABCD dikdörtgen',
    ...
    answer: 'B',
    hint: 'm(ADE) = m(BEC) olduğundan DAE ve EBC dik üçgenleri benzerdir.',
    solution: [
      {
        title: 'Açılar',
        detail:
          'm(AED) + m(BEC) = 90° ve m(AED) + m(ADE) = 90° olduğundan m(ADE) = m(BEC).',
      },
      {
        title: 'Benzerlik',
        detail:
          'DAE ∼ EBC: |AD| / |EB| = |AE| / |BC|. |BC| = |AD| = 6 cm.',
      },
      {
        title: 'EB',
        detail:
          '6 / |EB| = 4 / 6 ise |EB| = 9 cm, |AB| = 4 + 9 = 13 cm.',
      },
      {
        title: 'Sonuç',
        detail:
          'A(ABCD) = 13 · 6 = 78 cm² bulunur.',
      },
    ],
  },
  // ---------------------------------------------------------------- 138
  {
    id: 'quadrilaterals-138',
    topic: 'Deltoidde simetri ekseni ve alan oranı',
    figure: {
      viewBox: '0 0 400 300',
      caption: 'Şekil 138',
      label:
        'ABCD deltoidinde |AB| = |AD| ve |CB| = |CD|; köşegenler E noktasında kesişiyor; P noktası [AC] üzerinde; PBC üçgeni taralı.',
      svg: `
          <path class="shade" d="M220.0,154.0 L240.0,34.0 L300.0,154.0 Z"/>
          <path class="ln" d="M100.0,154.0 L240.0,34.0 L300.0,154.0 L240.0,274.0 Z"/>
          <path class="ln" d="M100.0,154.0 L300.0,154.0"/>
          <path class="ln" d="M240.0,34.0 L240.0,274.0"/>
          <path class="ln" d="M240.0,34.0 L220.0,154.0"/>
          <path class="tick" d="M166.1,89.4 L173.9,98.6"/>
          <path class="tick" d="M173.9,209.4 L166.1,218.6"/>
          <path class="tick" d="M274.2,89.1 L263.5,94.4"/>
          <path class="tick" d="M276.5,93.6 L265.8,98.9"/>
          <path class="tick" d="M263.5,213.6 L274.2,218.9"/>
          <path class="tick" d="M265.8,209.1 L276.5,214.4"/>
          <circle class="pt" cx="100.0" cy="154.0" r="3.2"/>
          <circle class="pt" cx="240.0" cy="34.0" r="3.2"/>
          <circle class="pt" cx="300.0" cy="154.0" r="3.2"/>
          <circle class="pt" cx="240.0" cy="274.0" r="3.2"/>
          <circle class="pt" cx="240.0" cy="154.0" r="3.2"/>
          <circle class="pt" cx="220.0" cy="154.0" r="3.2"/>
          <text x="90.0" y="159.0" text-anchor="end">A</text>
          <text x="240.0" y="24.0" text-anchor="middle">B</text>
          <text x="310.0" y="159.0">C</text>
          <text x="240.0" y="293.0" text-anchor="middle">D</text>
          <text x="250.0" y="172.0">E</text>
          <text x="216.0" y="172.0" text-anchor="middle">P</text>
        `,
    },
    given: [
      'ABCD deltoid',
    ...
    stem: [],
    ask: 'Yukarıdaki verilere göre, taralı PBC üçgeninin alanı kaç cm² dir?',
    choices: [
      { key: 'A', text: '9' },
      { key: 'B', text: '10' },
      { key: 'C', text: '12' },
    ...
    answer: 'C',
    hint: '[AC] deltoidin simetri eksenidir; ABC üçgeni deltoidin yarısıdır.',
    solution: [
      {
        title: 'Simetri',
        detail:
          '[AC] simetri ekseni olduğundan ABC ≅ ADC; A(ABC) = 60 / 2 = 30 cm².',
      },
      {
        title: 'Oran',
        detail:
          '2|AP| = 3|PC| ise |AP| : |PC| = 3 : 2, yani |PC| = |AC| · 2/5.',
      },
      {
        title: 'Aynı yükseklik',
        detail:
          'ABC ve PBC üçgenlerinin B den [AC] ye inen yüksekliği ortaktır; alanlar tabanlarla orantılıdır.',
      },
      {
        title: 'Sonuç',
        detail:
          'A(PBC) = 30 · 2/5 = 12 cm² bulunur.',
      },
    ],
  },
  // ---------------------------------------------------------------- 139
  {
    id: 'quadrilaterals-139',
    topic: 'Karede köşegen üzerinde nokta ve Pisagor',
    figure: {
      viewBox: '0 0 400 296',
      caption: 'Şekil 139',
      label:
        'ABCD karesinde [BD] köşegen; E noktası [BD] üzerinde; A ile E birleştirilmiş; |AE| = x.',
      svg: `
          <path class="ln" d="M80.0,28.0 L320.0,28.0 L320.0,268.0 L80.0,268.0 Z"/>
          <path class="ln" d="M80.0,268.0 L320.0,28.0"/>
          <path class="ln" d="M80.0,28.0 L140.0,208.0"/>
          <text class="val" x="122.0" y="122.0">x</text>
          <circle class="pt" cx="80.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="80.0" cy="268.0" r="3.2"/>
          <circle class="pt" cx="320.0" cy="268.0" r="3.2"/>
          <circle class="pt" cx="320.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="140.0" cy="208.0" r="3.2"/>
          <text x="70.0" y="23.0" text-anchor="end">A</text>
          <text x="70.0" y="283.0" text-anchor="end">B</text>
          <text x="330.0" y="283.0">C</text>
          <text x="330.0" y="23.0">D</text>
          <text x="152.0" y="222.0">E</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 296',
      caption: 'Şekil 139',
      label:
        'ABCD karesinde [BD] köşegen; E noktası [BD] üzerinde; A ile E birleştirilmiş; |AE| = x; E den [AB] ye inen dikmenin ayağı K.',
      svg: `
          <path class="ln" d="M80.0,28.0 L320.0,28.0 L320.0,268.0 L80.0,268.0 Z"/>
          <path class="ln" d="M80.0,268.0 L320.0,28.0"/>
          <path class="ln" d="M80.0,28.0 L140.0,208.0"/>
          <path class="aux" d="M140.0,208.0 L80.0,208.0"/>
          <path class="arc" d="M89.0,208.0 L89.0,217.0 L80.0,217.0"/>
          <text class="val" x="122.0" y="122.0">x</text>
          <circle class="pt" cx="80.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="80.0" cy="268.0" r="3.2"/>
          <circle class="pt" cx="320.0" cy="268.0" r="3.2"/>
          ...
          <text x="330.0" y="23.0">D</text>
          <text x="152.0" y="222.0">E</text>
          <circle class="pt" cx="80.0" cy="208.0" r="3.2"/>
          <text x="70.0" y="213.0" text-anchor="end">K</text>
        `,
    },
    given: [
      'ABCD kare',
    ...
    answer: 'B',
    hint: 'E den [AB] ye bir dikme in; köşegen kenarla 45° açı yapar.',
    solution: [
      {
        title: 'Dikme',
        detail:
          'E den [AB] ye inen dikmenin ayağı K olsun. m(KBE) = 45° olduğundan KBE ikizkenar dik üçgendir.',
      },
      {
        title: 'KBE',
        detail:
          '|BE| = 2√2 ise |BK| = |KE| = 2 cm.',
      },
      {
        title: 'AK',
        detail:
  ...
  // ---------------------------------------------------------------- 140
  {
    id: 'quadrilaterals-140',
    topic: 'Dikdörtgende eş köşegen ve ikizkenar üçgen',
    figure: {
      viewBox: '0 0 400 157.7',
      caption: 'Şekil 140',
      label:
        'ABCD dikdörtgeninde [AC] köşegen; [DE] doğru parçası [BC] yi F noktasında, [AB] nin uzantısını E noktasında kesiyor; m(DCA) = 28°, m(ADE) = α.',
      svg: `
          <path class="ln" d="M30.0,127.7 L195.0,127.7 L195.0,40.0 L30.0,40.0 Z"/>
          <path class="ln" d="M195.0,127.7 L381.9,127.7"/>
          <path class="ln" d="M30.0,127.7 L195.0,40.0"/>
          <path class="ln" d="M30.0,40.0 L381.9,127.7"/>
          <path class="arc" d="M169.0,40.0 A26,26 0 0 0 172.0,52.2"/>
          <text class="val" x="128.0" y="56.0">28°</text>
          <path class="arc" d="M30.0,62.0 A22,22 0 0 0 51.3,45.3"/>
          <text class="val" x="38.0" y="80.0">α</text>
          <circle class="pt" cx="30.0" cy="127.7" r="3.2"/>
          <circle class="pt" cx="195.0" cy="127.7" r="3.2"/>
          <circle class="pt" cx="195.0" cy="40.0" r="3.2"/>
          <circle class="pt" cx="30.0" cy="40.0" r="3.2"/>
          <circle class="pt" cx="381.9" cy="127.7" r="3.2"/>
          <circle class="pt" cx="195.0" cy="81.1" r="3.2"/>
          <text x="22.0" y="143.7" text-anchor="end">A</text>
          <text x="195.0" y="146.7" text-anchor="middle">B</text>
          <text x="195.0" y="31.0" text-anchor="middle">C</text>
          <text x="22.0" y="36.0" text-anchor="end">D</text>
          <text x="381.9" y="146.7" text-anchor="middle">E</text>
          <text x="203.0" y="75.1">F</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 157.7',
      caption: 'Şekil 140',
      label:
        'ABCD dikdörtgeninde [AC] köşegen; [DE] doğru parçası [BC] yi F noktasında, [AB] nin uzantısını E noktasında kesiyor; m(DCA) = 28°, m(ADE) = α; [BD] köşegeni çizilmiş.',
      svg: `
          <path class="ln" d="M30.0,127.7 L195.0,127.7 L195.0,40.0 L30.0,40.0 Z"/>
          <path class="ln" d="M195.0,127.7 L381.9,127.7"/>
          <path class="ln" d="M30.0,127.7 L195.0,40.0"/>
          ...
          <path class="arc" d="M30.0,62.0 A22,22 0 0 0 51.3,45.3"/>
          <text class="val" x="38.0" y="80.0">α</text>
          <path class="aux" d="M30.0,40.0 L195.0,127.7"/>
          <circle class="pt" cx="30.0" cy="127.7" r="3.2"/>
          <circle class="pt" cx="195.0" cy="127.7" r="3.2"/>
          <circle class="pt" cx="195.0" cy="40.0" r="3.2"/>
          <circle class="pt" cx="30.0" cy="40.0" r="3.2"/>
    ...
    stem: [],
    ask: 'Yukarıdaki verilere göre, m(ADE) = α kaç derecedir?',
    choices: [
      { key: 'A', text: '62' },
      { key: 'B', text: '68' },
      { key: 'C', text: '72' },
    ...
    answer: 'D',
    hint: '[BD] köşegenini çiz; dikdörtgenin köşegenleri eşit olduğundan |BD| = |BE| olur.',
    solution: [
      {
        title: 'Köşegen',
        detail:
          '[BD] çizilirse |BD| = |AC| = |BE|; DBE üçgeni ikizkenardır.',
      },
      {
        title: 'm(ABD)',
        detail:
          '[DC] ∥ [AB] olduğundan m(BAC) = m(DCA) = 28°. ABD ≅ BAC olduğundan m(ABD) = m(BAC) = 28°.',
      },
      {
        title: 'm(BED)',
        detail:
          'm(DBE) = 180° − 28° = 152°; m(BED) = m(BDE) = (180° − 152°) / 2 = 14°.',
      },
      {
        title: 'Sonuç',
        detail:
          'DAE dik üçgeninde α = 90° − 14° = 76° bulunur.',
      },
    ],
  },
  // ---------------------------------------------------------------- 141
  {
    id: 'quadrilaterals-141',
    topic: 'Karede üçgenin alanı ve kenar oranı',
    figure: {
      viewBox: '0 0 400 296',
      caption: 'Şekil 141',
      label:
        'ABCD karesinde E noktası [DC] üzerinde, F noktası [AB] üzerinde; AEF üçgeni çizilmiş.',
      svg: `
          <path class="ln" d="M80.0,268.0 L320.0,268.0 L320.0,28.0 L80.0,28.0 Z"/>
          <path class="ln" d="M80.0,268.0 L152.0,28.0 L260.0,268.0"/>
          <circle class="pt" cx="80.0" cy="268.0" r="3.2"/>
          <circle class="pt" cx="320.0" cy="268.0" r="3.2"/>
          <circle class="pt" cx="320.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="80.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="152.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="260.0" cy="268.0" r="3.2"/>
          <text x="70.0" y="283.0" text-anchor="end">A</text>
          <text x="330.0" y="283.0">B</text>
          <text x="330.0" y="23.0">C</text>
          <text x="70.0" y="23.0" text-anchor="end">D</text>
          <text x="152.0" y="19.0" text-anchor="middle">E</text>
          <text x="260.0" y="287.0" text-anchor="middle">F</text>
        `,
    },
    given: [
      'ABCD bir kare',
    ...
    stem: [],
    ask: 'Yukarıdaki şekilde A(AEF) = 24 cm² olduğuna göre, ABCD karesinin alanı kaç cm² dir?',
    choices: [
      { key: 'A', text: '56' },
      { key: 'B', text: '64' },
      { key: 'C', text: '72' },
    ...
    answer: 'B',
    hint: 'AEF üçgeninin [AF] tabanına ait yüksekliği karenin kenarına eşittir.',
    solution: [
      {
        title: 'Kenar',
        detail:
          'Karenin kenarı a olsun; |AF| = 3a/4.',
      },
      {
        title: 'Yükseklik',
        detail:
          'E, [DC] üzerinde olduğundan E den [AB] ye olan uzaklık a dır.',
      },
      {
        title: 'Alan',
        detail:
          'A(AEF) = (3a/4) · a / 2 = 3a²/8 = 24.',
      },
      {
        title: 'Sonuç',
        detail:
          'a² = 64, yani A(ABCD) = 64 cm² bulunur.',
      },
    ],
  },
  // ---------------------------------------------------------------- 142
  {
    id: 'quadrilaterals-142',
    topic: 'Dikdörtgende köşegene dikme ve alan',
    figure: {
      viewBox: '0 0 400 180.6',
      caption: 'Şekil 142',
      label:
        'ABCD dikdörtgeninde [BD] köşegen; E noktası [BD] üzerinde ve [AE] ⊥ [BD]; |DE| = 5; DEC üçgeni taralı.',
      svg: `
          <path class="shade" d="M101.9,28.0 L157.0,62.4 L298.1,28.0 Z"/>
          <path class="ln" d="M101.9,150.6 L298.1,150.6 L298.1,28.0 L101.9,28.0 Z"/>
          <path class="ln" d="M101.9,28.0 L298.1,150.6"/>
          <path class="ln" d="M101.9,150.6 L157.0,62.4"/>
          <path class="ln" d="M157.0,62.4 L298.1,28.0"/>
          <path class="arc" d="M152.2,70.1 L144.6,65.3 L149.4,57.7"/>
          <text class="val" x="125.4" y="63.2" text-anchor="middle">5</text>
          <circle class="pt" cx="101.9" cy="150.6" r="3.2"/>
          <circle class="pt" cx="298.1" cy="150.6" r="3.2"/>
          <circle class="pt" cx="298.1" cy="28.0" r="3.2"/>
          <circle class="pt" cx="101.9" cy="28.0" r="3.2"/>
          <circle class="pt" cx="157.0" cy="62.4" r="3.2"/>
          <text x="91.9" y="165.6" text-anchor="end">A</text>
          <text x="308.1" y="165.6">B</text>
          <text x="308.1" y="23.0">C</text>
          <text x="91.9" y="23.0" text-anchor="end">D</text>
          <text x="168.0" y="84.4">E</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 180.6',
      caption: 'Şekil 142',
      label:
        'ABCD dikdörtgeninde [BD] köşegen; E noktası [BD] üzerinde ve [AE] ⊥ [BD]; |DE| = 5; DEC üçgeni taralı; C den [BD] ye inen dikmenin ayağı H.',
      svg: `
          <path class="shade" d="M101.9,28.0 L157.0,62.4 L298.1,28.0 Z"/>
          <path class="ln" d="M101.9,150.6 L298.1,150.6 L298.1,28.0 L101.9,28.0 Z"/>
          <path class="ln" d="M101.9,28.0 L298.1,150.6"/>
          ...
          <path class="arc" d="M152.2,70.1 L144.6,65.3 L149.4,57.7"/>
          <text class="val" x="125.4" y="63.2" text-anchor="middle">5</text>
          <path class="aux" d="M298.1,28.0 L243.0,116.2"/>
          <path class="arc" d="M247.8,108.6 L255.4,113.3 L250.6,121.0"/>
          <circle class="pt" cx="101.9" cy="150.6" r="3.2"/>
          <circle class="pt" cx="298.1" cy="150.6" r="3.2"/>
          <circle class="pt" cx="298.1" cy="28.0" r="3.2"/>
          <circle class="pt" cx="101.9" cy="28.0" r="3.2"/>
          <circle class="pt" cx="157.0" cy="62.4" r="3.2"/>
          <circle class="pt" cx="243.0" cy="116.2" r="3.2"/>
          <text x="91.9" y="165.6" text-anchor="end">A</text>
          <text x="308.1" y="165.6">B</text>
          <text x="308.1" y="23.0">C</text>
          <text x="91.9" y="23.0" text-anchor="end">D</text>
          <text x="168.0" y="84.4">E</text>
          <text x="239.0" y="134.2" text-anchor="middle">H</text>
        `,
    },
    given: [
      'ABCD dikdörtgen',
    ...
    answer: 'C',
    hint: 'C den [BD] ye inen dikme, A dan inen dikmeye eşittir.',
    solution: [
      {
        title: 'Dikme',
        detail:
          'C den [BD] ye inen dikmenin ayağı H olsun. ABD ≅ CDB olduğundan |CH| = |AE|.',
      },
      {
        title: 'Alan',
        detail:
          'DEC üçgeninin [DE] tabanına ait yüksekliği |CH| dir: A(DEC) = |DE| · |CH| / 2.',
      },
      {
        title: 'Denklem',
        detail:
          '20 = 5 · |CH| / 2 ise |CH| = 8 cm.',
      },
      {
        title: 'Sonuç',
        detail:
  ...
  // ---------------------------------------------------------------- 143
  {
    id: 'quadrilaterals-143',
    topic: 'Karede yamukların alan oranı',
    figure: {
      viewBox: '0 0 400 314.0',
      caption: 'Şekil 143',
      label:
        'ABCD karesinde F noktası [DC] üzerinde, E noktası [AB] üzerinde; [EF] çizilmiş; |DF| = x, |FC| = 5, |AE| = 1, |EB| = y.',
      svg: `
          <path class="ln" d="M80.0,280.0 L320.0,280.0 L320.0,40.0 L80.0,40.0 Z"/>
          <path class="ln" d="M100.0,280.0 L220.0,40.0"/>
          ...
          <circle class="pt" cx="100.0" cy="280.0" r="3.2"/>
          <circle class="pt" cx="220.0" cy="40.0" r="3.2"/>
          <text x="70.0" y="295.0" text-anchor="end">A</text>
          <text x="330.0" y="295.0">B</text>
          <text x="330.0" y="35.0">C</text>
          <text x="70.0" y="35.0" text-anchor="end">D</text>
          <text x="220.0" y="30.0" text-anchor="middle">F</text>
          <text x="104.0" y="300.0">E</text>
          <text class="val" x="150.0" y="30.0" text-anchor="middle">x</text>
          <text class="val" x="270.0" y="30.0" text-anchor="middle">5</text>
          <text class="val" x="90.0" y="300.0" text-anchor="middle">1</text>
          <text class="val" x="210.0" y="300.0" text-anchor="middle">y</text>
        `,
    },
    given: [
      'ABCD kare',
    ...
    answer: 'D',
    hint: 'İki parça da yüksekliği karenin kenarı olan birer yamuktur.',
    solution: [
      {
        title: 'Yamuklar',
        detail:
          'Kenar a olsun. EBCF ve AEFD, yüksekliği a olan yamuklardır; alanlar paralel kenarların toplamıyla orantılıdır.',
      },
      {
        title: 'Kenarlar',
        detail:
      ...
      },
      {
        title: 'Denklem',
        detail:
          '(a − 1) + 5 = 2 · [1 + (a − 5)] ise a + 4 = 2a − 8, a = 12.',
      },
      {
        title: 'x ve y',
        detail:
      ...
      },
      {
        title: 'Sonuç',
        detail:
          'x + y = 7 + 11 = 18 cm bulunur.',
      },
    ],
  },
  // ---------------------------------------------------------------- 144
  {
    id: 'quadrilaterals-144',
    topic: 'Deltoidde 15° ve 30° ile alan',
    figure: {
      viewBox: '0 0 400 170.5',
      caption: 'Şekil 144',
      label:
        'ABCD deltoidinde |DC| = |BC|; köşegenler E noktasında kesişiyor; m(DAC) = 15°, |AB| = 12.',
      svg: `
          <path class="ln" d="M60.0,84.3 L270.0,28.0 L340.0,84.3 L270.0,140.5 Z"/>
          <path class="ln" d="M60.0,84.3 L340.0,84.3"/>
          <path class="ln" d="M270.0,28.0 L270.0,140.5"/>
          <path class="arc" d="M108.0,84.3 A48,48 0 0 0 106.4,71.8"/>
          <text class="val" x="122.0" y="81.3">15°</text>
          <text class="val" x="165.0" y="132.4" text-anchor="middle">12</text>
          <path class="tick" d="M307.0,50.0 L299.5,59.4"/>
          <path class="tick" d="M310.5,52.9 L303.0,62.2"/>
          <path class="tick" d="M299.5,109.1 L307.0,118.5"/>
          <path class="tick" d="M303.0,106.3 L310.5,115.7"/>
          <circle class="pt" cx="60.0" cy="84.3" r="3.2"/>
          <circle class="pt" cx="270.0" cy="140.5" r="3.2"/>
          <circle class="pt" cx="340.0" cy="84.3" r="3.2"/>
          <circle class="pt" cx="270.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="270.0" cy="84.3" r="3.2"/>
          <text x="50.0" y="89.3" text-anchor="end">A</text>
          <text x="270.0" y="159.5" text-anchor="middle">B</text>
          <text x="350.0" y="89.3">C</text>
          <text x="270.0" y="19.0" text-anchor="middle">D</text>
          <text x="276.0" y="102.3">E</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 170.5',
      caption: 'Şekil 144',
      label:
        'ABCD deltoidinde |DC| = |BC|; köşegenler E noktasında kesişiyor; m(DAC) = 15°, |AB| = 12; D den [AB] ye inen dikmenin ayağı H.',
      svg: `
          <path class="ln" d="M60.0,84.3 L270.0,28.0 L340.0,84.3 L270.0,140.5 Z"/>
          <path class="ln" d="M60.0,84.3 L340.0,84.3"/>
          <path class="ln" d="M270.0,28.0 L270.0,140.5"/>
          ...
          <path class="tick" d="M299.5,109.1 L307.0,118.5"/>
          <path class="tick" d="M303.0,106.3 L310.5,115.7"/>
          <path class="aux" d="M270.0,28.0 L241.9,133.0"/>
          <path class="arc" d="M244.2,124.3 L235.5,122.0 L233.2,130.7"/>
          <circle class="pt" cx="60.0" cy="84.3" r="3.2"/>
          <circle class="pt" cx="270.0" cy="140.5" r="3.2"/>
          <circle class="pt" cx="340.0" cy="84.3" r="3.2"/>
          <circle class="pt" cx="270.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="270.0" cy="84.3" r="3.2"/>
          <circle class="pt" cx="241.9" cy="133.0" r="3.2"/>
          <text x="50.0" y="89.3" text-anchor="end">A</text>
          <text x="270.0" y="159.5" text-anchor="middle">B</text>
          <text x="350.0" y="89.3">C</text>
          <text x="270.0" y="19.0" text-anchor="middle">D</text>
          <text x="276.0" y="102.3">E</text>
          <text x="239.9" y="151.0" text-anchor="middle">H</text>
        `,
    },
    given: [
      'ABCD deltoid',
    ...
    answer: 'E',
    hint: '[AC] simetri ekseni olduğundan m(DAB) = 30° dir; D den [AB] ye dikme in.',
    solution: [
      {
        title: 'Açı',
        detail:
          '[AC] simetri ekseni olduğundan |AD| = |AB| = 12 cm ve m(DAB) = 2 · 15° = 30°.',
      },
      {
        title: 'Dikme',
        detail:
          'D den [AB] ye inen dikmenin ayağı H olsun. 30° karşısındaki kenar hipotenüsün yarısıdır: |DH| = 6 cm.',
      },
      {
        title: 'A(ABD)',
        detail:
      ...
      },
      {
        title: 'A(BCD)',
        detail:
          'ABD ve CBD üçgenlerinin tabanı [BD] ortaktır; yükseklikleri |AE| ve |EC| dir. |EC| = |AE| / 3 olduğundan A(BCD) = 36 / 3 = 12 cm².',
      },
      {
        title: 'Sonuç',
        detail:
          'A(ABCD) = 36 + 12 = 48 cm² bulunur.',
      },
    ],
  },
  // ---------------------------------------------------------------- 145
  {
    id: 'quadrilaterals-145',
    topic: 'Dikdörtgende dikmeyle benzerlik ve alan',
    figure: {
      viewBox: '0 0 400 250.0',
      caption: 'Şekil 145',
      label:
        'ABCD dikdörtgeninde E noktası [BC] üzerinde; F noktası [DE] üzerinde ve [AF] ⊥ [DE].',
      svg: `
          <path class="ln" d="M75.3,220.0 L324.7,220.0 L324.7,28.0 L75.3,28.0 Z"/>
          <path class="ln" d="M75.3,28.0 L324.7,172.0"/>
          <path class="ln" d="M75.3,220.0 L158.4,76.0"/>
          <path class="arc" d="M150.6,71.5 L146.1,79.3 L153.9,83.8"/>
          <circle class="pt" cx="75.3" cy="220.0" r="3.2"/>
          <circle class="pt" cx="324.7" cy="220.0" r="3.2"/>
          <circle class="pt" cx="324.7" cy="28.0" r="3.2"/>
          <circle class="pt" cx="75.3" cy="28.0" r="3.2"/>
          <circle class="pt" cx="324.7" cy="172.0" r="3.2"/>
          <circle class="pt" cx="158.4" cy="76.0" r="3.2"/>
          <text x="65.3" y="235.0" text-anchor="end">A</text>
          <text x="334.7" y="235.0">B</text>
          <text x="334.7" y="23.0">C</text>
          <text x="65.3" y="23.0" text-anchor="end">D</text>
          <text x="334.7" y="177.0">E</text>
          <text x="162.4" y="66.0" text-anchor="middle">F</text>
        `,
    },
    given: [
      'ABCD dikdörtgen',
    ...
    stem: [],
    ask: 'Yukarıdaki verilere göre, ABCD dikdörtgeninin alanı kaç cm² dir?',
    choices: [
      { key: 'A', text: '36√3' },
      { key: 'B', text: '48√3' },
      { key: 'C', text: '54√3' },
    ...
    answer: 'B',
    hint: '[AD] ∥ [BC] olduğundan m(ADF) = m(DEC); AFD ve DCE dik üçgenleri benzerdir.',
    solution: [
      {
        title: 'Benzerlik',
        detail:
          'm(ADF) = m(DEC) (iç ters açılar) olduğundan AFD ∼ DCE: |AD| / |DE| = |DF| / |EC|.',
      },
      {
        title: 'Kenarlar',
        detail:
          '|EB| = k olsun; |EC| = 3k, |AD| = |BC| = 4k. |DE| = 4 + 8 = 12 cm.',
      },
      {
        title: 'Denklem',
        detail:
          '4k / 12 = 4 / 3k ise 12k² = 48, k = 2. |BC| = 8 cm, |EC| = 6 cm.',
      },
      {
        title: 'DC',
        detail:
          'DCE dik üçgeninde |DC|² = 12² − 6² = 108, |DC| = 6√3 cm.',
      },
      {
        title: 'Sonuç',
        detail:
          'A(ABCD) = 8 · 6√3 = 48√3 cm² bulunur.',
      },
    ],
  },
  {
  ...
  {
    id: 'quadrilaterals-152',
    topic: 'Karede köşegenin orta dikme olması',
    figure: {
      viewBox: '0 0 400 296',
      caption: 'Şekil 152',
      label:
      ...
      svg: `
          ...
          <circle class="pt" cx="320.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="80.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="182.9" cy="165.1" r="3.2"/>
          <text x="70.0" y="286.0" text-anchor="end">A</text>
          <text x="330.0" y="286.0">B</text>
          <text x="330.0" y="22.0">C</text>
          <text x="70.0" y="22.0" text-anchor="end">D</text>
          <text x="182.9" y="191.1" text-anchor="middle">E</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 296',
      caption: 'Şekil 152',
      label:
        'ABCD karesinde [AC] köşegeni çizilmiş; |DE| = |BE| olduğundan E noktası köşegen üzerinde.',
      svg: `
          <path class="ln" d="M80.0,268.0 L320.0,268.0 L320.0,28.0 L80.0,28.0 Z"/>
          <path class="aux" d="M80.0,268.0 L320.0,28.0"/>
          <path class="ln" d="M80.0,268.0 L182.9,165.1"/>
    ...
    answer: 'C',
    hint: 'B ve D noktalarına eşit uzaklıktaki noktalar karenin hangi köşegeni üzerindedir?',
    solution: [
      {
        title: 'Köşegen',
        detail:
          '[AC] köşegeni [BD] nin orta dikmesidir; |DE| = |BE| olduğundan E, [AC] üzerindedir.',
      },
      {
        title: 'E noktasının yeri',
        detail:
          '|AE| = 3√2 cm olduğundan E, [AB] ve [AD] kenarlarına 3 cm uzaklıktadır.',
      },
      {
        title: 'Dik üçgen',
        detail:
          'E den [AD] ye inen dikmenin ayağı ile D arasındaki uzaklık 7 − 3 = 4 cm dir.',
      },
      {
        title: 'Sonuç',
        detail:
          '|DE|² = 3² + 4² = 25, |DE| = 5 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-153',
    topic: 'Kare ve dikdörtgenden oluşan şeklin çevresi',
    figure: {
      viewBox: '0 0 400 296',
      caption: 'Şekil 153',
      label:
        'ABCD karesi ile EFKC dikdörtgeni C köşesinde birleşiyor, B noktası [CE] üzerinde; D, B, F doğrusal; |DB| = 7√2 cm, |CF| = 13 cm; iki şeklin birleşimi taralı.',
      svg: `
          <path class="shade" d="M80.0,28.0 L320.0,28.0 L320.0,268.0 L220.0,268.0 L220.0,168.0 L80.0,168.0 Z"/>
          <path class="ln" d="M80.0,168.0 L220.0,168.0 L220.0,28.0 L80.0,28.0 Z"/>
          <path class="ln" d="M220.0,268.0 L320.0,268.0 L320.0,28.0 L220.0,28.0 Z"/>
          <path class="ln" d="M220.0,168.0 L220.0,268.0"/>
          <path class="ln" d="M80.0,28.0 L320.0,268.0"/>
          <path class="ln" d="M220.0,28.0 L320.0,268.0"/>
          <text class="val" x="286.0" y="144.0" text-anchor="middle">13</text>
          <circle class="pt" cx="80.0" cy="168.0" r="3.2"/>
          <circle class="pt" cx="220.0" cy="168.0" r="3.2"/>
          <circle class="pt" cx="220.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="80.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="320.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="320.0" cy="268.0" r="3.2"/>
          <circle class="pt" cx="220.0" cy="268.0" r="3.2"/>
          <text x="70.0" y="186.0" text-anchor="end">A</text>
          <text x="212.0" y="186.0" text-anchor="end">B</text>
          <text x="220.0" y="19.0" text-anchor="middle">C</text>
          <text x="70.0" y="22.0" text-anchor="end">D</text>
          <text x="330.0" y="22.0">K</text>
          <text x="330.0" y="286.0">F</text>
          <text x="210.0" y="286.0" text-anchor="end">E</text>
        `,
    },
    given: [
      'ABCD kare',
    ...
    stem: [],
    ask: 'Yukarıdaki verilere göre, taralı şeklin tüm çevresi kaç cm dir?',
    choices: [
      { key: 'A', text: '42' },
      { key: 'B', text: '44' },
      { key: 'C', text: '46' },
    ...
    answer: 'D',
    hint: 'Karenin köşegeni kenarla 45° yapar; [DF] doğrusu [EF] kenarıyla da 45° yapar.',
    solution: [
      {
        title: 'Karenin kenarı',
        detail:
          '|DB| = 7√2 cm olduğundan karenin kenarı 7 cm dir.',
      },
      {
        title: 'İkizkenar dik üçgen',
        detail:
          'm(EBF) = m(DBA) = 45° olduğundan BEF ikizkenar dik üçgendir: |EF| = |BE| = k.',
      },
      {
        title: 'Pisagor',
        detail:
          '|CE| = 7 + k olduğundan (7 + k)² + k² = 13² = 169, k² + 7k − 60 = 0, k = 5.',
      },
      {
        title: 'Kenarlar',
        detail:
          '|DK| = 7 + 5 = 12, |KF| = 12, |FE| = 5, |EB| = 5, |BA| = 7, |AD| = 7.',
      },
      {
        title: 'Sonuç',
        detail:
          'Çevre = 12 + 12 + 5 + 5 + 7 + 7 = 48 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-154',
    topic: 'Dikdörtgende açıortay ve ikizkenar üçgen',
    figure: {
      viewBox: '0 0 400 200',
      caption: 'Şekil 154',
      label:
        'ABCD dikdörtgeninde [AB] kenarının uzantısı üzerinde E noktası; [ED], AEC açısının açıortayı ve [BC] kenarını F noktasında kesiyor; |CE| = 15 cm, |BE| = 9 cm; ADF üçgeni taralı.',
      svg: `
          <path class="shade" d="M56.0,172.0 L56.0,28.0 L236.0,118.0 Z"/>
          <path class="ln" d="M56.0,172.0 L236.0,172.0 L236.0,28.0 L56.0,28.0 Z"/>
          <path class="ln" d="M236.0,172.0 L344.0,172.0"/>
          <path class="ln" d="M236.0,28.0 L344.0,172.0"/>
          <path class="ln" d="M56.0,28.0 L344.0,172.0"/>
          <path class="ln" d="M56.0,172.0 L236.0,118.0"/>
          <path class="arc" d="M316.4,135.2 A46,46 0 0 0 302.9,151.4"/>
          <path class="tick" d="M312.5,145.7 L304.8,139.3"/>
          <path class="arc" d="M302.9,151.4 A46,46 0 0 0 298.0,172.0"/>
          <path class="tick" d="M304.1,162.6 L294.4,160.3"/>
          <text class="val" x="302.0" y="96.0" text-anchor="middle">15</text>
          <text class="val" x="290.0" y="192.0" text-anchor="middle">9</text>
          <circle class="pt" cx="56.0" cy="172.0" r="3.2"/>
          <circle class="pt" cx="236.0" cy="172.0" r="3.2"/>
          <circle class="pt" cx="236.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="56.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="344.0" cy="172.0" r="3.2"/>
          <circle class="pt" cx="236.0" cy="118.0" r="3.2"/>
          <text x="46.0" y="190.0" text-anchor="end">A</text>
          <text x="236.0" y="192.0" text-anchor="middle">B</text>
          <text x="236.0" y="19.0" text-anchor="middle">C</text>
          <text x="46.0" y="22.0" text-anchor="end">D</text>
          <text x="354.0" y="190.0">E</text>
          <text x="244.0" y="110.0">F</text>
        `,
    },
    given: [
      'ABCD dikdörtgen',
    ...
    stem: [],
    ask: 'Yukarıdaki verilere göre, A(ADF) kaç cm² dir?',
    choices: [
      { key: 'A', text: '72' },
      { key: 'B', text: '80' },
      { key: 'C', text: '90' },
    ...
    answer: 'C',
    hint: '[DC] ∥ [AE] olduğundan m(CDE) = m(DEA) dır; DCE üçgenine bakın.',
    solution: [
      {
        title: 'BC kenarı',
        detail:
          'CBE dik üçgeninde |BC|² = 15² − 9² = 144, |BC| = 12 cm.',
      },
      {
        title: 'İkizkenar üçgen',
        detail:
          '[DC] ∥ [AE] ise m(CDE) = m(DEA) = m(CED); DCE ikizkenar, |DC| = |CE| = 15 cm.',
      },
      {
        title: 'Yükseklik',
        detail:
          'F noktası [BC] üzerinde olduğundan F nin [AD] ye uzaklığı |AB| = 15 cm dir.',
      },
      {
        title: 'Sonuç',
        detail:
          'A(ADF) = |AD| · |AB| / 2 = 12 · 15 / 2 = 90 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-155',
    topic: 'Eşkenar dörtgen ve karenin köşegeni',
    figure: {
      viewBox: '0 0 400 180',
      caption: 'Şekil 155',
      label:
        'ABCD eşkenar dörtgeni ile BFCE karesi; [BC] eşkenar dörtgenin kenarı ve karenin köşegeni, E noktası [DC] üzerinde; A(BFCE) = 18 cm²; eşkenar dörtgen taralı.',
      svg: `
          <path class="shade" d="M57.0,150.0 L225.0,150.0 L343.8,31.2 L175.8,31.2 Z"/>
          <path class="ln" d="M57.0,150.0 L225.0,150.0 L343.8,31.2 L175.8,31.2 Z"/>
          <path class="ln" d="M225.0,150.0 L343.8,150.0 L343.8,31.2 L225.0,31.2 Z"/>
          <circle class="pt" cx="57.0" cy="150.0" r="3.2"/>
          <circle class="pt" cx="225.0" cy="150.0" r="3.2"/>
          <circle class="pt" cx="343.8" cy="150.0" r="3.2"/>
          <circle class="pt" cx="343.8" cy="31.2" r="3.2"/>
          <circle class="pt" cx="225.0" cy="31.2" r="3.2"/>
          <circle class="pt" cx="175.8" cy="31.2" r="3.2"/>
          <text x="47.0" y="168.0" text-anchor="end">A</text>
          <text x="225.0" y="170.0" text-anchor="middle">B</text>
          <text x="353.8" y="168.0">F</text>
          <text x="353.8" y="25.2">C</text>
          <text x="225.0" y="22.2" text-anchor="middle">E</text>
          <text x="175.8" y="22.2" text-anchor="middle">D</text>
        `,
    },
    given: [
      'ABCD eşkenar dörtgen',
    ...
    answer: 'B',
    hint: '[BC] karenin köşegenidir; karenin kenarı ise eşkenar dörtgenin yüksekliğidir.',
    solution: [
      {
        title: 'Karenin kenarı',
        detail:
          'A(BFCE) = 18 ise karenin kenarı √18 = 3√2 cm dir.',
      },
      {
        title: 'Eşkenar dörtgenin kenarı',
        detail:
          '|BC| karenin köşegenidir: |BC| = 3√2 · √2 = 6 cm.',
      },
      {
        title: 'Yükseklik',
        detail:
          '[BE] ⊥ [DC] olduğundan eşkenar dörtgenin yüksekliği |BE| = 3√2 cm dir.',
      },
      {
        title: 'Sonuç',
        detail:
          'A(ABCD) = |DC| · |BE| = 6 · 3√2 = 18√2 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-156',
    topic: 'Karede dikme ve alan yoluyla uzunluk',
    figure: {
      viewBox: '0 0 400 296',
      caption: 'Şekil 156',
      label:
        'ABCD karesinde E, [DC] kenarının orta noktası; B köşesinden [AE] doğru parçasına inen dikmenin ayağı F; |BC| = 4√5 cm.',
      svg: `
          <path class="ln" d="M80.0,268.0 L320.0,268.0 L320.0,28.0 L80.0,28.0 Z"/>
          <path class="ln" d="M80.0,268.0 L200.0,28.0"/>
          <path class="ln" d="M320.0,268.0 L128.0,172.0"/>
          <path class="arc" d="M132.5,163.1 L141.4,167.5 L136.9,176.5"/>
          <path class="tick" d="M137.5,22.0 L137.5,34.0"/>
          <path class="tick" d="M142.5,22.0 L142.5,34.0"/>
          <path class="tick" d="M257.5,22.0 L257.5,34.0"/>
          <path class="tick" d="M262.5,22.0 L262.5,34.0"/>
          <text class="val" x="178.0" y="104.0" text-anchor="middle">x</text>
          <text class="val" x="328.0" y="153.0" text-anchor="start">4√5</text>
          <circle class="pt" cx="80.0" cy="268.0" r="3.2"/>
          <circle class="pt" cx="320.0" cy="268.0" r="3.2"/>
          <circle class="pt" cx="320.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="80.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="200.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="128.0" cy="172.0" r="3.2"/>
          <text x="70.0" y="286.0" text-anchor="end">A</text>
          <text x="330.0" y="286.0">B</text>
          <text x="330.0" y="22.0">C</text>
          <text x="70.0" y="22.0" text-anchor="end">D</text>
          <text x="200.0" y="19.0" text-anchor="middle">E</text>
          <text x="118.0" y="176.0" text-anchor="end">F</text>
        `,
    },
    given: [
      'ABCD kare',
    ...
    answer: 'C',
    hint: 'ABE üçgeninin alanını iki yoldan yazarak |BF| yi bulun.',
    solution: [
      {
        title: 'AE',
        detail:
          'ADE dik üçgeninde |AE|² = (4√5)² + (2√5)² = 80 + 20 = 100, |AE| = 10 cm.',
      },
      {
        title: 'Alan',
        detail:
          'A(ABE) = |AB| · |BC| / 2 = 80 / 2 = 40 cm²; ayrıca A(ABE) = |AE| · |BF| / 2 = 5 · |BF|.',
      },
      {
        title: 'BF',
        detail:
      ...
      },
      {
        title: 'AF',
        detail:
          'ABF dik üçgeninde |AF|² = 80 − 64 = 16, |AF| = 4 cm.',
      },
      {
        title: 'Sonuç',
        detail:
          'x = |AE| − |AF| = 10 − 4 = 6 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-157',
    topic: 'Karede dik açı ve Pisagor',
    figure: {
      viewBox: '0 0 400 296',
      caption: 'Şekil 157',
      label:
        'ABCD karesinin içinde bir L noktası; L den [AB] ye inen dikmenin ayağı K; ADL ve DCL açıları eşit; |AK| = 16 cm, |KB| = 4 cm.',
      svg: `
          <path class="ln" d="M80.0,268.0 L320.0,268.0 L320.0,28.0 L80.0,28.0 Z"/>
          <path class="ln" d="M80.0,28.0 L272.0,124.0"/>
          <path class="ln" d="M320.0,28.0 L272.0,124.0"/>
          <path class="ln" d="M272.0,124.0 L272.0,268.0"/>
          <path class="arc" d="M272.0,258.0 L282.0,258.0 L282.0,268.0"/>
          <path class="arc" d="M80.0,54.0 A26,26 0 0 0 103.3,39.6"/>
          <path class="arc" d="M294.0,28.0 A26,26 0 0 0 308.4,51.3"/>
          <text class="val" x="176.0" y="288.0" text-anchor="middle">16</text>
          <text class="val" x="296.0" y="288.0" text-anchor="middle">4</text>
          <text class="val" x="262.0" y="201.0" text-anchor="end">x</text>
          <circle class="pt" cx="80.0" cy="268.0" r="3.2"/>
          <circle class="pt" cx="320.0" cy="268.0" r="3.2"/>
          <circle class="pt" cx="320.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="80.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="272.0" cy="268.0" r="3.2"/>
          <circle class="pt" cx="272.0" cy="124.0" r="3.2"/>
          <text x="70.0" y="286.0" text-anchor="end">A</text>
          <text x="330.0" y="286.0">B</text>
          <text x="330.0" y="22.0">C</text>
          <text x="70.0" y="22.0" text-anchor="end">D</text>
          <text x="272.0" y="288.0" text-anchor="middle">K</text>
          <text x="264.0" y="144.0" text-anchor="end">L</text>
        `,
    },
    given: [
      'ABCD kare',
    ...
    stem: [],
    ask: 'Yukarıdaki verilere göre, |KL| = x kaç cm dir?',
    choices: [
      { key: 'A', text: '8' },
      { key: 'B', text: '10' },
      { key: 'C', text: '12' },
    ...
    answer: 'C',
    hint: 'm(ADL) + m(LDC) = 90° dir; DLC üçgeninin L açısı kaç derecedir?',
    solution: [
      {
        title: 'Dik açı',
        detail:
          'm(ADL) = m(DCL) ve m(ADL) + m(LDC) = 90° olduğundan m(DCL) + m(LDC) = 90°, m(DLC) = 90°.',
      },
      {
        title: 'Çember',
        detail:
          'L, [DC] çaplı çember üzerindedir; merkez [DC] nin orta noktası, yarıçap 20 / 2 = 10 cm.',
      },
      {
        title: 'Yatay uzaklık',
        detail:
          'Merkez ile L nin yatay uzaklığı 16 − 10 = 6 cm dir.',
      },
      {
        title: 'Dikey uzaklık',
        detail:
          '6² + h² = 10² ise h = 8 cm; L, [DC] kenarının 8 cm altındadır.',
      },
      {
        title: 'Sonuç',
        detail:
          'x = 20 − 8 = 12 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-158',
    topic: 'Dikdörtgende açıortay teoremi ve alan',
    figure: {
      viewBox: '0 0 400 214',
      caption: 'Şekil 158',
      label:
        'ABCD dikdörtgeninde [BD] köşegeni çizilmiş; E, [AB] kenarı üzerinde ve [DE], ADB açısının açıortayı; |AE| = 4 cm, |EB| = 8 cm; BCDE dörtgeni taralı.',
      svg: `
          <path class="shade" d="M156.0,180.4 L332.0,180.4 L332.0,28.0 L68.0,28.0 Z"/>
          <path class="ln" d="M68.0,180.4 L332.0,180.4 L332.0,28.0 L68.0,28.0 Z"/>
          <path class="ln" d="M68.0,28.0 L332.0,180.4"/>
          <path class="ln" d="M68.0,28.0 L156.0,180.4"/>
          <path class="arc" d="M68.0,58.0 A30,30 0 0 0 83.0,54.0"/>
          <path class="arc" d="M83.0,54.0 A30,30 0 0 0 94.0,43.0"/>
          <path class="tick" d="M74.5,52.1 L77.1,61.8"/>
          <path class="tick" d="M85.7,45.7 L92.7,52.7"/>
          <text class="val" x="112.0" y="200.0" text-anchor="middle">4</text>
          <text class="val" x="244.0" y="200.0" text-anchor="middle">8</text>
          <circle class="pt" cx="68.0" cy="180.4" r="3.2"/>
          <circle class="pt" cx="332.0" cy="180.4" r="3.2"/>
          <circle class="pt" cx="332.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="68.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="156.0" cy="180.4" r="3.2"/>
          <text x="58.0" y="198.0" text-anchor="end">A</text>
          <text x="342.0" y="198.0">B</text>
          <text x="342.0" y="22.0">C</text>
          <text x="58.0" y="22.0" text-anchor="end">D</text>
          <text x="156.0" y="200.0" text-anchor="middle">E</text>
        `,
    },
    given: [
      'ABCD dikdörtgen',
    ...
    stem: [],
    ask: 'Yukarıdaki verilere göre, A(BCDE) kaç cm² dir?',
    choices: [
      { key: 'A', text: '32√3' },
      { key: 'B', text: '36√3' },
      { key: 'C', text: '40√3' },
    ...
    answer: 'C',
    hint: 'ADB üçgeninde açıortay teoremini yazın: |AE| / |EB| = |DA| / |DB|.',
    solution: [
      {
        title: 'Açıortay teoremi',
        detail:
          'ADB üçgeninde |DA| / |DB| = |AE| / |EB| = 4 / 8 = 1 / 2, yani |DB| = 2 · |DA|.',
      },
      {
        title: 'Açılar',
        detail:
          'ADB dik üçgeninde hipotenüs kısa dik kenarın iki katı olduğundan m(ABD) = 30°, m(ADB) = 60°.',
      },
      {
        title: 'AD',
        detail:
          '|AB| = 4 + 8 = 12 cm, 30° karşısındaki kenar |AD| = 12 / √3 = 4√3 cm.',
      },
      {
        title: 'Alanlar',
        detail:
          'A(ABCD) = 12 · 4√3 = 48√3 cm², A(ADE) = 4 · 4√3 / 2 = 8√3 cm².',
      },
      {
        title: 'Sonuç',
        detail:
          'A(BCDE) = 48√3 − 8√3 = 40√3 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-159',
    topic: 'Dikdörtgende dikme ve benzer dik üçgenler',
    figure: {
      viewBox: '0 0 400 276',
      caption: 'Şekil 159',
      label:
        'ABCD dikdörtgeninde E, [BC] kenarı üzerinde; A köşesinden [DE] doğru parçasına inen dikmenin ayağı F; |AF| = 12 cm, |DF| = 9 cm, |EF| = 6 cm.',
      svg: `
          <path class="ln" d="M65.0,28.0 L335.0,28.0 L335.0,244.0 L65.0,244.0 Z"/>
          <path class="ln" d="M335.0,28.0 L173.0,244.0"/>
          <path class="ln" d="M65.0,28.0 L237.8,157.6"/>
          <path class="arc" d="M243.8,149.6 L235.8,143.6 L229.8,151.6"/>
          <text class="val" x="159.8" y="81.6" text-anchor="middle">12</text>
          <text class="val" x="297.6" y="106.2" text-anchor="middle">9</text>
          <text class="val" x="216.6" y="209.2" text-anchor="middle">6</text>
          <text class="val" x="119.0" y="264.0" text-anchor="middle">x</text>
          <circle class="pt" cx="65.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="335.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="335.0" cy="244.0" r="3.2"/>
          <circle class="pt" cx="65.0" cy="244.0" r="3.2"/>
          <circle class="pt" cx="173.0" cy="244.0" r="3.2"/>
          <circle class="pt" cx="237.8" cy="157.6" r="3.2"/>
          <text x="55.0" y="22.0" text-anchor="end">A</text>
          <text x="345.0" y="22.0">D</text>
          <text x="345.0" y="262.0">C</text>
          <text x="55.0" y="262.0" text-anchor="end">B</text>
          <text x="173.0" y="264.0" text-anchor="middle">E</text>
          <text x="248.0" y="172.0">F</text>
        `,
    },
    given: [
      'ABCD dikdörtgen',
    ...
    answer: 'C',
    hint: '[AD] ∥ [BC] olduğundan m(ADF) = m(DEC) dir; AFD ile DCE üçgenlerini karşılaştırın.',
    solution: [
      {
        title: 'AD',
        detail:
          'AFD dik üçgeninde |AD|² = 12² + 9² = 225, |AD| = 15 cm; ayrıca |DE| = 9 + 6 = 15 cm.',
      },
      {
        title: 'Benzerlik',
        detail:
          '[AD] ∥ [BC] olduğundan m(ADF) = m(DEC); AFD ve DCE dik üçgenleri benzerdir, hipotenüsler eşit olduğundan eştir.',
      },
      {
        title: 'CE',
        detail:
          'D açısının komşu kenarı |DF| ile E açısının komşu kenarı |CE| eşleşir: |CE| = |DF| = 9 cm.',
      },
      {
        title: 'Sonuç',
        detail:
          '|BC| = |AD| = 15 cm olduğundan x = 15 − 9 = 6 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-160',
    topic: 'Dikdörtgende kelebek benzerliği ve alan',
    figure: {
      viewBox: '0 0 400 272',
      caption: 'Şekil 160',
      label:
        'ABCD dikdörtgeninde K, [AD] kenarının orta noktası; E, [BC] kenarı üzerinde ve |CE| = |BE| / 3; [DE] ile [KC] F noktasında kesişiyor; CEF üçgeni taralı.',
      svg: `
          <path class="shade" d="M332.0,28.0 L332.0,82.0 L244.0,64.0 Z"/>
          <path class="ln" d="M68.0,244.0 L332.0,244.0 L332.0,28.0 L68.0,28.0 Z"/>
          <path class="ln" d="M68.0,28.0 L332.0,82.0"/>
          <path class="ln" d="M68.0,136.0 L332.0,28.0"/>
          <path class="tick" d="M62.0,82.0 L74.0,82.0"/>
          <path class="tick" d="M62.0,190.0 L74.0,190.0"/>
          <circle class="pt" cx="68.0" cy="244.0" r="3.2"/>
          <circle class="pt" cx="332.0" cy="244.0" r="3.2"/>
          <circle class="pt" cx="332.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="68.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="68.0" cy="136.0" r="3.2"/>
          <circle class="pt" cx="332.0" cy="82.0" r="3.2"/>
          <circle class="pt" cx="244.0" cy="64.0" r="3.2"/>
          <text x="58.0" y="262.0" text-anchor="end">A</text>
          <text x="342.0" y="262.0">B</text>
          <text x="342.0" y="22.0">C</text>
          <text x="58.0" y="22.0" text-anchor="end">D</text>
          <text x="58.0" y="141.0" text-anchor="end">K</text>
          <text x="342.0" y="87.0">E</text>
          <text x="244.0" y="90.0" text-anchor="middle">F</text>
        `,
    },
    given: [
      'ABCD dikdörtgen',
    ...
    answer: 'C',
    hint: '[DK] ∥ [CE] olduğundan FDK ve FEC üçgenleri benzerdir; benzerlik oranını kenarlardan bulun.',
    solution: [
      {
        title: 'Kenarları adlandırma',
        detail:
          '|AB| = a, |BC| = b olsun. |DK| = b / 2 ve |CE| = b / 4 olur.',
      },
      {
        title: 'Benzerlik',
        detail:
          '[DK] ∥ [CE] olduğundan FDK ∼ FEC ve oran |DK| / |CE| = 2. F nin [AD] ye ve [BC] ye uzaklıkları 2 : 1 oranındadır.',
      },
      {
        title: 'Yükseklik',
        detail:
          'Bu uzaklıkların toplamı a olduğundan F nin [BC] ye uzaklığı a / 3 tür.',
      },
      {
        title: 'Alan',
        detail:
          'A(CEF) = (b / 4) · (a / 3) / 2 = a · b / 24 = 3 ise a · b = 72.',
      },
      {
        title: 'Sonuç',
        detail:
          'A(ABCD) = a · b = 72 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-161',
    topic: 'Üçgen içine çizilen kare ve benzerlik',
    figure: {
      viewBox: '0 0 400 256',
      caption: 'Şekil 161',
      label:
        'ABC üçgeninde KLMN karesinin [LM] kenarı [BC] üzerinde, K köşesi [AB] üzerinde, N köşesi [AC] üzerinde; [AH], [BC] ye dik; |AH| = 10 cm, |BC| = 15 cm.',
      svg: `
          <path class="ln" d="M170.0,28.0 L50.0,228.0 L350.0,228.0 Z"/>
          <path class="ln" d="M122.0,228.0 L122.0,108.0 L242.0,108.0 L242.0,228.0"/>
          <path class="ln" d="M170.0,28.0 L170.0,228.0"/>
          <path class="arc" d="M180.0,228.0 L180.0,218.0 L170.0,218.0"/>
          <circle class="pt" cx="170.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="50.0" cy="228.0" r="3.2"/>
          <circle class="pt" cx="350.0" cy="228.0" r="3.2"/>
          <circle class="pt" cx="170.0" cy="228.0" r="3.2"/>
          <circle class="pt" cx="122.0" cy="108.0" r="3.2"/>
          <circle class="pt" cx="242.0" cy="108.0" r="3.2"/>
          <circle class="pt" cx="122.0" cy="228.0" r="3.2"/>
          <circle class="pt" cx="242.0" cy="228.0" r="3.2"/>
          <text x="170.0" y="19.0" text-anchor="middle">A</text>
          <text x="40.0" y="246.0" text-anchor="end">B</text>
          <text x="360.0" y="246.0">C</text>
          <text x="170.0" y="248.0" text-anchor="middle">H</text>
          <text x="122.0" y="248.0" text-anchor="middle">L</text>
          <text x="242.0" y="248.0" text-anchor="middle">M</text>
          <text x="112.0" y="104.0" text-anchor="end">K</text>
          <text x="252.0" y="104.0">N</text>
        `,
    },
    given: [
      'ABC bir üçgen',
    ...
    stem: [],
    ask: 'Yukarıdaki verilere göre, Çevre(KLMN) kaç cm dir?',
    choices: [
      { key: 'A', text: '20' },
      { key: 'B', text: '22' },
      { key: 'C', text: '24' },
    ...
    answer: 'C',
    hint: '[KN] ∥ [BC] olduğundan AKN üçgeni ABC üçgenine benzerdir; yükseklikleri de aynı oranda.',
    solution: [
      {
        title: 'Benzerlik',
        detail:
          'Karenin kenarı a olsun. [KN] ∥ [BC] olduğundan AKN ∼ ABC.',
      },
      {
        title: 'Oran',
        detail:
          'AKN üçgeninin yüksekliği 10 − a dır; a / 15 = (10 − a) / 10.',
      },
      {
        title: 'Kenar',
        detail:
          '10a = 150 − 15a, 25a = 150, a = 6 cm.',
      },
      {
        title: 'Sonuç',
        detail:
          'Çevre(KLMN) = 4 · 6 = 24 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-162',
    topic: 'Paralelkenar ile dikdörtgende yamuk alanı',
    figure: {
      viewBox: '0 0 400 216',
      caption: 'Şekil 162',
      label:
        'ABCD paralelkenarında D den [AB] ye inen dikmenin ayağı E; [DE] aşağı uzatılarak K bulunmuş ve |DE| = |EK|; BEKL dikdörtgen; [DB] çizilmiş; |AE| = 3 cm, |DC| = 12 cm.',
      svg: `
          <path class="ln" d="M50.0,108.0 L290.0,108.0 L350.0,28.0 L110.0,28.0 Z"/>
          <path class="ln" d="M110.0,28.0 L110.0,188.0 L290.0,188.0 L290.0,108.0"/>
          <path class="ln" d="M110.0,28.0 L290.0,108.0"/>
          <path class="tick" d="M104.0,68.0 L116.0,68.0"/>
          <path class="tick" d="M104.0,148.0 L116.0,148.0"/>
          <text class="val" x="80.0" y="100.0" text-anchor="middle">3</text>
          <text class="val" x="230.0" y="19.0" text-anchor="middle">12</text>
          <circle class="pt" cx="50.0" cy="108.0" r="3.2"/>
          <circle class="pt" cx="110.0" cy="108.0" r="3.2"/>
          <circle class="pt" cx="290.0" cy="108.0" r="3.2"/>
          <circle class="pt" cx="350.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="110.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="110.0" cy="188.0" r="3.2"/>
          <circle class="pt" cx="290.0" cy="188.0" r="3.2"/>
          <text x="40.0" y="113.0" text-anchor="end">A</text>
          <text x="102.0" y="126.0" text-anchor="end">E</text>
          <text x="300.0" y="112.0">B</text>
          <text x="360.0" y="24.0">C</text>
          <text x="110.0" y="19.0" text-anchor="middle">D</text>
          <text x="110.0" y="208.0" text-anchor="middle">K</text>
          <text x="290.0" y="208.0" text-anchor="middle">L</text>
        `,
    },
    given: [
      'ABCD paralelkenar',
    ...
    stem: [],
    ask: 'Yukarıdaki şekilde; A(BDKL) = 54 cm² olduğuna göre, A(ABCD) kaç cm² dir?',
    choices: [
      { key: 'A', text: '36' },
      { key: 'B', text: '40' },
      { key: 'C', text: '44' },
    ...
    answer: 'D',
    hint: 'BDKL bir yamuktur: paralel kenarları [DK] ve [BL], yüksekliği |EB|.',
    solution: [
      {
        title: 'EB',
        detail:
          '|AB| = |DC| = 12 cm olduğundan |EB| = 12 − 3 = 9 cm.',
      },
      {
        title: 'Yamuk',
        detail:
          '|DE| = |EK| = h olsun. [DK] ∥ [BL] olduğundan BDKL yamuktur: |DK| = 2h, |BL| = |EK| = h, yükseklik |EB| = 9.',
      },
      {
        title: 'h',
        detail:
          'A(BDKL) = (2h + h) · 9 / 2 = 27h / 2 = 54 ise h = 4 cm.',
      },
      {
        title: 'Sonuç',
        detail:
          '|DE| paralelkenarın yüksekliğidir: A(ABCD) = 12 · 4 = 48 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-163',
    topic: 'Dikdörtgende kesişen doğrular ve oran',
    figure: {
      viewBox: '0 0 400 236',
      caption: 'Şekil 163',
      label:
        'ABCD dikdörtgeninde F, [AB] kenarı üzerinde ve |AF| = 3|FB|; E, [BC] kenarı üzerinde; [DF] ile [AE] T noktasında kesişiyor ve |DT| = 3|TF|; |CE| = 10 cm.',
      svg: `
          <path class="ln" d="M60.0,208.0 L340.0,208.0 L340.0,28.0 L60.0,28.0 Z"/>
          <path class="ln" d="M60.0,28.0 L270.0,208.0"/>
          <path class="ln" d="M60.0,208.0 L340.0,128.0"/>
          <text class="val" x="350.0" y="83.0">10</text>
          <text class="val" x="350.0" y="173.0">x</text>
          <circle class="pt" cx="60.0" cy="208.0" r="3.2"/>
          <circle class="pt" cx="340.0" cy="208.0" r="3.2"/>
          <circle class="pt" cx="340.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="60.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="270.0" cy="208.0" r="3.2"/>
          <circle class="pt" cx="340.0" cy="128.0" r="3.2"/>
          <circle class="pt" cx="217.5" cy="163.0" r="3.2"/>
          <text x="50.0" y="226.0" text-anchor="end">A</text>
          <text x="350.0" y="226.0">B</text>
          <text x="350.0" y="22.0">C</text>
          <text x="50.0" y="22.0" text-anchor="end">D</text>
          <text x="270.0" y="228.0" text-anchor="middle">F</text>
          <text x="350.0" y="148.0">E</text>
          <text x="217.5" y="186.0" text-anchor="middle">T</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 236',
      caption: 'Şekil 163',
      label:
        'Aynı şekil; [AE] ve [DC] sağa doğru uzatılmış, şeklin dışında P noktasında kesişiyor.',
      svg: `
          <path class="ln" d="M60.0,208.0 L340.0,208.0 L340.0,28.0 L60.0,28.0 Z"/>
          <path class="ln" d="M60.0,28.0 L270.0,208.0"/>
          <path class="ln" d="M60.0,208.0 L340.0,128.0"/>
          <path class="aux" d="M340.0,128.0 L385.0,115.1"/>
          <path class="aux" d="M340.0,28.0 L385.0,28.0"/>
          <path class="aux-head" d="M376.9,112.2 L385.0,115.1 L379.7,121.8"/>
          <path class="aux-head" d="M378.0,23.0 L385.0,28.0 L378.0,33.0"/>
          <text class="val" x="350.0" y="83.0">10</text>
          <text class="val" x="350.0" y="173.0">x</text>
          <circle class="pt" cx="60.0" cy="208.0" r="3.2"/>
          <circle class="pt" cx="340.0" cy="208.0" r="3.2"/>
    ...
    answer: 'B',
    hint: '[AE] yi, [DC] nin uzantısını kestiği P noktasına kadar uzatın.',
    solution: [
      {
        title: 'Kenarlar',
        detail:
          '|FB| = k olsun; |AF| = 3k ve |AB| = |DC| = 4k.',
      },
      {
        title: 'Uzatma',
        detail:
          '[AE] uzatılsın ve DC doğrusunu P de kessin. [AF] ∥ [DP] olduğundan TAF ∼ TPD.',
      },
      {
        title: 'DP',
        detail:
          '|DP| / |AF| = |DT| / |TF| = 3 ise |DP| = 9k, |CP| = 9k − 4k = 5k.',
      },
      {
        title: 'Oran',
        detail:
          '[AB] ∥ [CP] olduğundan EAB ∼ EPC: |CE| / |EB| = |CP| / |AB| = 5k / 4k = 5 / 4.',
      },
      {
        title: 'Sonuç',
        detail:
          '10 / x = 5 / 4 ise x = 8 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-164',
    topic: 'Deltoidde dikme ve Pisagor',
    figure: {
      viewBox: '0 0 400 262',
      caption: 'Şekil 164',
      label:
        'ABCD deltoidinde |AB| = |AD|; D den [AB] ye inen dikmenin ayağı H; [BC], [HD] ye paralel; |AH| = 12 cm, |HB| = 8 cm.',
      svg: `
          <path class="ln" d="M70.0,236.0 L330.0,236.0 L330.0,106.0 L226.0,28.0 Z"/>
          <path class="ln" d="M226.0,28.0 L226.0,236.0"/>
          <path class="arc" d="M236.0,236.0 L236.0,226.0 L226.0,226.0"/>
          <text class="val" x="148.0" y="256.0" text-anchor="middle">12</text>
          <text class="val" x="278.0" y="256.0" text-anchor="middle">8</text>
          <circle class="pt" cx="70.0" cy="236.0" r="3.2"/>
          <circle class="pt" cx="330.0" cy="236.0" r="3.2"/>
          <circle class="pt" cx="330.0" cy="106.0" r="3.2"/>
          <circle class="pt" cx="226.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="226.0" cy="236.0" r="3.2"/>
          <text x="60.0" y="254.0" text-anchor="end">A</text>
          <text x="340.0" y="254.0">B</text>
          <text x="340.0" y="111.0">C</text>
          <text x="226.0" y="19.0" text-anchor="middle">D</text>
          <text x="226.0" y="256.0" text-anchor="middle">H</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 262',
      caption: 'Şekil 164',
      label:
        'Aynı şekil; C den [DH] ye inen dikmenin ayağı P.',
      svg: `
          <path class="ln" d="M70.0,236.0 L330.0,236.0 L330.0,106.0 L226.0,28.0 Z"/>
          <path class="ln" d="M226.0,28.0 L226.0,236.0"/>
          <path class="arc" d="M236.0,236.0 L236.0,226.0 L226.0,226.0"/>
          <path class="aux" d="M330.0,106.0 L226.0,106.0"/>
          <text class="val" x="148.0" y="256.0" text-anchor="middle">12</text>
          <text class="val" x="278.0" y="256.0" text-anchor="middle">8</text>
          <circle class="pt" cx="70.0" cy="236.0" r="3.2"/>
          <circle class="pt" cx="330.0" cy="236.0" r="3.2"/>
          ...
          <text x="226.0" y="19.0" text-anchor="middle">D</text>
          <text x="226.0" y="256.0" text-anchor="middle">H</text>
          <circle class="pt" cx="226.0" cy="106.0" r="3.2"/>
          <text x="218.0" y="100.0" text-anchor="end">P</text>
        `,
    },
    given: [
      'ABCD bir deltoid',
    ...
    answer: 'C',
    hint: 'C den [DH] ye bir dikme indirin; oluşan dik üçgende |CD| = |CB| olduğunu kullanın.',
    solution: [
      {
        title: 'AD ve DH',
        detail:
          '|AD| = |AB| = 12 + 8 = 20 cm; ADH dik üçgeninde |DH|² = 20² − 12² = 256, |DH| = 16 cm.',
      },
      {
        title: 'Deltoid',
        detail:
          '|AB| = |AD| olduğundan diğer iki kenar da eşittir: |CB| = |CD| = x.',
      },
      {
        title: 'Dikme',
        detail:
          'C den [DH] ye inen dikmenin ayağı P olsun. HBCP dikdörtgendir: |CP| = |HB| = 8 cm, |PH| = x, |DP| = 16 − x.',
      },
      {
        title: 'Pisagor',
        detail:
          'DPC dik üçgeninde x² = 8² + (16 − x)², 0 = 64 + 256 − 32x.',
      },
      {
        title: 'Sonuç',
        detail:
          '32x = 320 ise |DC| = x = 10 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-165',
    topic: 'Karede kelebek benzerliği ve Pisagor',
    figure: {
      viewBox: '0 0 400 296',
      caption: 'Şekil 165',
      label:
        'ABCD karesinde E, [AB] kenarı üzerinde ve |AE| = 2|EB|; [DB] köşegeni ile [EC] doğru parçası K noktasında kesişiyor; |EK| = √10 cm.',
      svg: `
          <path class="ln" d="M80.0,268.0 L320.0,268.0 L320.0,28.0 L80.0,28.0 Z"/>
          <path class="ln" d="M80.0,28.0 L320.0,268.0"/>
          <path class="ln" d="M240.0,268.0 L320.0,28.0"/>
          <circle class="pt" cx="80.0" cy="268.0" r="3.2"/>
          <circle class="pt" cx="320.0" cy="268.0" r="3.2"/>
          <circle class="pt" cx="320.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="80.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="240.0" cy="268.0" r="3.2"/>
          <circle class="pt" cx="260.0" cy="208.0" r="3.2"/>
          <text x="70.0" y="286.0" text-anchor="end">A</text>
          <text x="330.0" y="286.0">B</text>
          <text x="330.0" y="22.0">C</text>
          <text x="70.0" y="22.0" text-anchor="end">D</text>
          <text x="240.0" y="288.0" text-anchor="middle">E</text>
          <text x="250.0" y="212.0" text-anchor="end">K</text>
        `,
    },
    given: [
      'ABCD kare',
    ...
    stem: [],
    ask: 'Yukarıdaki verilere göre, karenin alanı kaç cm² dir?',
    choices: [
      { key: 'A', text: '100' },
      { key: 'B', text: '121' },
      { key: 'C', text: '144' },
    ...
    answer: 'C',
    hint: '[EB] ∥ [DC] olduğundan KEB ve KCD üçgenleri benzerdir.',
    solution: [
      {
        title: 'Kenarlar',
        detail:
          'Karenin kenarı a olsun; |EB| = a / 3, |DC| = a.',
      },
      {
        title: 'Benzerlik',
        detail:
          '[EB] ∥ [DC] olduğundan KEB ∼ KCD: |EK| / |KC| = |EB| / |DC| = 1 / 3.',
      },
      {
        title: 'EC',
        detail:
          '|KC| = 3√10 cm, |EC| = √10 + 3√10 = 4√10 cm.',
      },
      {
        title: 'Pisagor',
        detail:
          'EBC dik üçgeninde |EC|² = a² + a² / 9 = 10a² / 9 = 160.',
      },
      {
        title: 'Sonuç',
        detail:
          'a² = 144 olduğundan karenin alanı 144 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-166',
    topic: 'Düzgün altıgen ve kare ile üçgen alanı',
    figure: {
      viewBox: '0 0 400 270',
      caption: 'Şekil 166',
      label:
        'ABCDEF düzgün altıgeninin [DC] kenarı üzerine dışa doğru DCKL karesi çizilmiş; [EC] ve [EK] çizilmiş, ECK üçgeni taralı.',
      svg: `
          <path class="shade" d="M110.5,76.0 L254.5,159.1 L337.6,111.1 Z"/>
          <path class="ln" d="M110.5,242.3 L206.5,242.3 L254.5,159.1 L206.5,76.0 L110.5,76.0 L62.5,159.1 Z"/>
          <path class="ln" d="M254.5,159.1 L337.6,111.1 L289.6,28.0 L206.5,76.0"/>
          <path class="ln" d="M110.5,76.0 L254.5,159.1"/>
          <path class="ln" d="M110.5,76.0 L337.6,111.1"/>
          <path class="arc" d="M249.5,150.5 L258.2,145.5 L263.2,154.1"/>
          <circle class="pt" cx="110.5" cy="242.3" r="3.2"/>
          <circle class="pt" cx="206.5" cy="242.3" r="3.2"/>
          <circle class="pt" cx="254.5" cy="159.1" r="3.2"/>
          <circle class="pt" cx="206.5" cy="76.0" r="3.2"/>
          <circle class="pt" cx="110.5" cy="76.0" r="3.2"/>
          <circle class="pt" cx="62.5" cy="159.1" r="3.2"/>
          <circle class="pt" cx="337.6" cy="111.1" r="3.2"/>
          <circle class="pt" cx="289.6" cy="28.0" r="3.2"/>
          <text x="104.5" y="260.3" text-anchor="end">A</text>
          <text x="212.5" y="260.3">B</text>
          <text x="258.5" y="179.1">C</text>
          <text x="204.5" y="67.0" text-anchor="middle">D</text>
          <text x="102.5" y="70.0" text-anchor="end">E</text>
          <text x="52.5" y="164.1" text-anchor="end">F</text>
          <text x="347.6" y="116.1">K</text>
          <text x="289.6" y="19.0" text-anchor="middle">L</text>
        `,
    },
    given: [
    ...
    stem: [],
    ask: 'Yukarıdaki şeklin çevresi 64 cm olduğuna göre, A(ECK) kaç cm² dir?',
    choices: [
      { key: 'A', text: '36' },
      { key: 'B', text: '40' },
      { key: 'C', text: '44' },
    ...
    answer: 'D',
    hint: 'Şeklin çevresinde kaç eş kenar olduğunu sayın, sonra m(ECK) açısını bulun.',
    solution: [
      {
        title: 'Kenar',
        detail:
          'Şeklin çevresi altıgenin 5 kenarı ile karenin 3 kenarından oluşur: 8a = 64, a = 8 cm.',
      },
      {
        title: 'EC',
        detail:
          'EDC ikizkenar üçgeninde m(EDC) = 120° olduğundan m(DCE) = 30° ve |EC| = a√3 = 8√3 cm.',
      },
      {
        title: 'Açı',
        detail:
          'm(ECK) = m(ECD) + m(DCK) = 30° + 90° = 120°.',
      },
      {
        title: 'Alan',
        detail:
          'A(ECK) = ½ · 8√3 · 8 · sin 120° = ½ · 8√3 · 8 · √3 / 2.',
      },
      {
        title: 'Sonuç',
        detail:
  ...
  {
    id: 'quadrilaterals-167',
    topic: 'Karede ikizkenar üçgen ve eş dik üçgenler',
    figure: {
      viewBox: '0 0 400 288',
      caption: 'Şekil 167',
      label:
        'ABCD karesinin içinde E noktası; [BE], [EA] ya dik; |EC| = |BC| eşit işaretli; |AE| = 4 cm.',
      svg: `
          <path class="ln" d="M83.7,28.0 L83.7,260.6 L316.3,260.6 L316.3,28.0 Z"/>
          <path class="ln" d="M83.7,260.6 L176.7,74.5 L83.7,28.0"/>
          <path class="ln" d="M176.7,74.5 L316.3,260.6"/>
          <path class="arc" d="M167.8,70.0 L163.3,79.0 L172.3,83.5"/>
          <path class="tick" d="M249.8,161.9 L240.2,169.1"/>
          <path class="tick" d="M252.8,165.9 L243.2,173.1"/>
          <path class="tick" d="M197.5,254.6 L197.5,266.6"/>
          <path class="tick" d="M202.5,254.6 L202.5,266.6"/>
          <text class="val" x="136.2" y="43.3" text-anchor="middle">4</text>
          <circle class="pt" cx="83.7" cy="28.0" r="3.2"/>
          <circle class="pt" cx="83.7" cy="260.6" r="3.2"/>
          <circle class="pt" cx="316.3" cy="260.6" r="3.2"/>
          <circle class="pt" cx="316.3" cy="28.0" r="3.2"/>
          <circle class="pt" cx="176.7" cy="74.5" r="3.2"/>
          <text x="73.7" y="22.0" text-anchor="end">A</text>
          <text x="73.7" y="278.6" text-anchor="end">B</text>
          <text x="326.3" y="278.6">C</text>
          <text x="326.3" y="22.0">D</text>
          <text x="184.7" y="66.5">E</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 288',
      caption: 'Şekil 167',
      label:
        'Aynı şekil; C den [BE] ye inen dikmenin ayağı M, [BE] nin orta noktası.',
      svg: `
          <path class="ln" d="M83.7,28.0 L83.7,260.6 L316.3,260.6 L316.3,28.0 Z"/>
          <path class="ln" d="M83.7,260.6 L176.7,74.5 L83.7,28.0"/>
          <path class="ln" d="M176.7,74.5 L316.3,260.6"/>
          ...
          <path class="tick" d="M197.5,254.6 L197.5,266.6"/>
          <path class="tick" d="M202.5,254.6 L202.5,266.6"/>
          <path class="aux" d="M316.3,260.6 L130.2,167.5"/>
          <path class="arc" d="M139.2,172.0 L134.7,180.9 L125.8,176.5"/>
          <text class="val" x="136.2" y="43.3" text-anchor="middle">4</text>
          <circle class="pt" cx="83.7" cy="28.0" r="3.2"/>
          <circle class="pt" cx="83.7" cy="260.6" r="3.2"/>
          <circle class="pt" cx="316.3" cy="260.6" r="3.2"/>
          <circle class="pt" cx="316.3" cy="28.0" r="3.2"/>
          <circle class="pt" cx="176.7" cy="74.5" r="3.2"/>
          <circle class="pt" cx="130.2" cy="167.5" r="3.2"/>
          <text x="122.2" y="171.5" text-anchor="end">M</text>
          <text x="73.7" y="22.0" text-anchor="end">A</text>
          <text x="73.7" y="278.6" text-anchor="end">B</text>
          <text x="326.3" y="278.6">C</text>
          <text x="326.3" y="22.0">D</text>
    ...
    stem: [],
    ask: 'Yukarıdaki verilere göre, bu karenin alanı kaç cm² dir?',
    choices: [
      { key: 'A', text: '64' },
      { key: 'B', text: '72' },
      { key: 'C', text: '80' },
    ...
    answer: 'C',
    hint: 'BCE ikizkenar üçgeninde C den [BE] ye dikme indirin; bu dikme [BE] yi iki eş parçaya ayırır.',
    solution: [
      {
        title: 'Dikme',
        detail:
          'C den [BE] ye inen dikmenin ayağı M olsun. |CB| = |CE| olduğundan M, [BE] nin orta noktasıdır.',
      },
      {
        title: 'Açılar',
        detail:
          'm(ABE) + m(EBC) = 90° ve m(MCB) + m(MBC) = 90° olduğundan m(ABE) = m(MCB).',
      },
      {
        title: 'Eşlik',
        detail:
          'AEB ve BMC dik üçgenlerinin hipotenüsleri |AB| = |BC| olduğundan eştirler: |BM| = |AE| = 4 cm.',
      },
      {
        title: 'BE',
        detail:
      ...
      },
      {
        title: 'Sonuç',
        detail:
          'AEB dik üçgeninde |AB|² = 4² + 8² = 80; karenin alanı 80 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-168',
    topic: 'Dikdörtgende orta taban ve Öklit bağıntısı',
    figure: {
      viewBox: '0 0 400 180',
      caption: 'Şekil 168',
      label:
        'ABCD dikdörtgeninde E, [AB] kenarı üzerinde ve [DE], [EC] ye dik; T, [AD] nin orta noktası; [TL], [AB] ye paralel, [DE] yi K de, [EC] yi L de kesiyor; |TK| = 4 cm, |KL| = 6 cm.',
      svg: `
          <path class="ln" d="M68.0,152.5 L332.0,152.5 L332.0,28.0 L68.0,28.0 Z"/>
          <path class="ln" d="M68.0,28.0 L244.0,152.5 L332.0,28.0"/>
          <path class="ln" d="M68.0,90.2 L288.0,90.2"/>
          <path class="arc" d="M235.8,146.7 L241.6,138.5 L249.8,144.3"/>
          <path class="tick" d="M62.0,121.3 L74.0,121.3"/>
          <path class="tick" d="M62.0,59.1 L74.0,59.1"/>
          <text class="val" x="112.0" y="83.2" text-anchor="middle">4</text>
          <text class="val" x="222.0" y="83.2" text-anchor="middle">6</text>
          <circle class="pt" cx="68.0" cy="152.5" r="3.2"/>
          <circle class="pt" cx="332.0" cy="152.5" r="3.2"/>
          <circle class="pt" cx="332.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="68.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="244.0" cy="152.5" r="3.2"/>
          <circle class="pt" cx="68.0" cy="90.2" r="3.2"/>
          <circle class="pt" cx="156.0" cy="90.2" r="3.2"/>
          <circle class="pt" cx="288.0" cy="90.2" r="3.2"/>
          <text x="58.0" y="170.5" text-anchor="end">A</text>
          <text x="342.0" y="170.5">B</text>
          <text x="342.0" y="22.0">C</text>
          <text x="58.0" y="22.0" text-anchor="end">D</text>
          <text x="244.0" y="172.5" text-anchor="middle">E</text>
          <text x="58.0" y="95.2" text-anchor="end">T</text>
          <text x="152.0" y="108.2" text-anchor="end">K</text>
          <text x="298.0" y="86.2">L</text>
        `,
    },
    given: [
      'ABCD bir dikdörtgen',
    ...
    answer: 'C',
    hint: 'T, [AD] nin orta noktası ve [TL] ∥ [AB] olduğundan [TK] ve [KL] orta tabanlardır.',
    solution: [
      {
        title: 'AE',
        detail:
          'ADE üçgeninde [TK] orta taban: |AE| = 2 · 4 = 8 cm.',
      },
      {
        title: 'DC',
        detail:
          'K ve L, [DE] ile [EC] nin orta noktalarıdır; DEC üçgeninde |DC| = 2 · 6 = 12 cm.',
      },
      {
        title: 'EB',
        detail:
      ...
      },
      {
        title: 'Öklit',
        detail:
          'DEC dik üçgeninde E ye ait yükseklik |AD| dir: |AD|² = |AE| · |EB| = 8 · 4 = 32, |AD| = 4√2 cm.',
      },
      {
        title: 'Sonuç',
        detail:
          'A(ABCD) = 12 · 4√2 = 48√2 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-169',
    topic: 'Dikdörtgende benzer üçgenlerle alan oranı',
    figure: {
      viewBox: '0 0 400 256',
      caption: 'Şekil 169',
      label:
        'ABCD dikdörtgeninde G, [DC] üzerinde; F, [AB] üzerinde; [GF] uzatılarak [CB] nin uzantısında E noktası bulunmuş; |AG| = |FG| eşit işaretli.',
      svg: `
          <path class="ln" d="M67.0,180.0 L333.0,180.0 L333.0,28.0 L67.0,28.0 Z"/>
          <path class="ln" d="M67.0,180.0 L181.0,28.0"/>
          <path class="ln" d="M181.0,28.0 L333.0,230.7"/>
          <path class="ln" d="M333.0,180.0 L333.0,230.7"/>
          <path class="tick" d="M119.2,100.4 L128.8,107.6"/>
          <path class="tick" d="M233.2,107.6 L242.8,100.4"/>
          <circle class="pt" cx="67.0" cy="180.0" r="3.2"/>
          <circle class="pt" cx="333.0" cy="180.0" r="3.2"/>
          <circle class="pt" cx="333.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="67.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="333.0" cy="230.7" r="3.2"/>
          <circle class="pt" cx="295.0" cy="180.0" r="3.2"/>
          <circle class="pt" cx="181.0" cy="28.0" r="3.2"/>
          <text x="57.0" y="198.0" text-anchor="end">A</text>
          <text x="343.0" y="184.0">B</text>
          <text x="343.0" y="22.0">C</text>
          <text x="57.0" y="22.0" text-anchor="end">D</text>
          <text x="181.0" y="19.0" text-anchor="middle">G</text>
          <text x="289.0" y="198.0" text-anchor="end">F</text>
          <text x="343.0" y="240.7">E</text>
        `,
    },
    given: [
      'ABCD bir dikdörtgen',
    ...
    stem: [],
    ask: 'Yukarıdaki şekilde; A(AGF) / A(BEF) = 18 olduğuna göre, A(ABCD) / A(FGCB) oranı kaçtır?',
    choices: [
      { key: 'A', text: '7/3' },
      { key: 'B', text: '14/5' },
      { key: 'C', text: '3' },
    ...
    answer: 'B',
    hint: 'G den [AB] ye dikme indirin; AGF ikizkenar olduğundan dikme [AF] yi ikiye böler.',
    solution: [
      {
        title: 'Dikme',
        detail:
          'G den [AB] ye inen dikmenin ayağı H, yükseklik h olsun. |AH| = |HF| = p, |FB| = q.',
      },
      {
        title: 'Benzerlik',
        detail:
          'GHF ∼ EBF olduğundan |BE| / h = q / p, |BE| = hq / p.',
      },
      {
        title: 'Oran',
        detail:
          'A(AGF) = ph, A(BEF) = hq² / 2p; oran 2p² / q² = 18 ise p = 3q.',
      },
      {
        title: 'Kenarlar',
        detail:
          'q = 1 alınırsa |AB| = 7, |GC| = 7 − 3 = 4, |FB| = 1.',
      },
      {
        title: 'Sonuç',
        detail:
          'A(ABCD) / A(FGCB) = 7h / [(4 + 1)h / 2] = 14 / 5 bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-170',
    topic: 'Benzer dikdörtgenlerle alan',
    figure: {
      viewBox: '0 0 400 230',
      caption: 'Şekil 170',
      label:
        'ABCD dikdörtgeninde E, [AB] üzerinde; F, [DC] üzerinde; AEFD bir dikdörtgen; |AD| = 6 cm, |DF| = 4 cm.',
      svg: `
          <path class="ln" d="M74.0,196.0 L326.0,196.0 L326.0,28.0 L74.0,28.0 Z"/>
          <path class="ln" d="M186.0,196.0 L186.0,28.0"/>
          <circle class="pt" cx="74.0" cy="196.0" r="3.2"/>
          <circle class="pt" cx="326.0" cy="196.0" r="3.2"/>
          <circle class="pt" cx="326.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="74.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="186.0" cy="196.0" r="3.2"/>
          <circle class="pt" cx="186.0" cy="28.0" r="3.2"/>
          <text x="64.0" y="214.0" text-anchor="end">A</text>
          <text x="336.0" y="214.0">B</text>
          <text x="336.0" y="22.0">C</text>
          <text x="64.0" y="22.0" text-anchor="end">D</text>
          <text x="186.0" y="216.0" text-anchor="middle">E</text>
          <text x="186.0" y="18.0" text-anchor="middle">F</text>
          <text class="val" x="130.0" y="17.6" text-anchor="middle">4</text>
          <text class="val" x="60.0" y="117.0" text-anchor="middle">6</text>
        `,
    },
    given: [
      'ABCD ve AEFD birer dikdörtgen',
      '|AD| = 6 cm',
      '|DF| = 4 cm',
    ],
    stem: [],
    ask: 'Yukarıdaki şekilde; ABCD ve FEAD benzer dikdörtgenler olduğuna göre, A(ABCD) kaç cm² dir?',
    choices: [
      { key: 'A', text: '45' },
      { key: 'B', text: '48' },
      { key: 'C', text: '54' },
    ...
    answer: 'C',
    hint: 'Benzerlikte köşeleri sırasıyla eşleyin: F ↔ A, E ↔ B, A ↔ C, D ↔ D.',
    solution: [
      {
        title: 'Eşleme',
        detail:
          'FEAD ~ ABCD olduğundan |FE| / |AB| = |EA| / |BC|.',
      },
      {
        title: 'Kenarlar',
        detail:
          '|FE| = |AD| = 6 cm, |EA| = |DF| = 4 cm ve |BC| = |AD| = 6 cm.',
      },
      {
        title: 'Oran',
        detail:
          '6 / |AB| = 4 / 6 ⇒ |AB| = 36 / 4 = 9 cm.',
      },
      {
        title: 'Sonuç',
        detail:
          'A(ABCD) = 9 · 6 = 54 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-171',
    topic: 'Karede köşegenler ve dik açıyla alan',
    figure: {
      viewBox: '0 0 400 290',
      caption: 'Şekil 171',
      label:
        'ABCD karesinin [AC] ve [BD] köşegenleri E noktasında kesişiyor; K, [AD] üzerinde; L, [AB] üzerinde; [EK] ile [EL] dik; ALEK dörtgeni taralı.',
      svg: `
          <path class="shade" d="M80.0,260.0 L160.0,260.0 L200.0,140.0 L80.0,100.0 Z"/>
          <path class="ln" d="M80.0,260.0 L320.0,260.0 L320.0,20.0 L80.0,20.0 Z"/>
          <path class="ln" d="M80.0,260.0 L320.0,20.0"/>
          <path class="ln" d="M320.0,260.0 L80.0,20.0"/>
          <path class="ln" d="M80.0,100.0 L200.0,140.0 L160.0,260.0"/>
          <path class="arc" d="M190.5,136.8 L187.4,146.3 L196.8,149.5"/>
          <circle class="pt" cx="80.0" cy="260.0" r="3.2"/>
          <circle class="pt" cx="320.0" cy="260.0" r="3.2"/>
          <circle class="pt" cx="320.0" cy="20.0" r="3.2"/>
          <circle class="pt" cx="80.0" cy="20.0" r="3.2"/>
          <circle class="pt" cx="200.0" cy="140.0" r="3.2"/>
          <circle class="pt" cx="80.0" cy="100.0" r="3.2"/>
          <circle class="pt" cx="160.0" cy="260.0" r="3.2"/>
          <text x="70.0" y="278.0" text-anchor="end">A</text>
          <text x="330.0" y="278.0">B</text>
          <text x="330.0" y="14.0">C</text>
          <text x="70.0" y="14.0" text-anchor="end">D</text>
          <text x="70.0" y="105.0" text-anchor="end">K</text>
          <text x="160.0" y="280.0" text-anchor="middle">L</text>
          <text x="200.0" y="128.0" text-anchor="middle">E</text>
        `,
    },
    given: [
      'ABCD bir kare',
      'm(KEL) = 90°',
      '[AC] ve [BD] köşegenleri E noktasında kesişiyorlar',
    ],
    stem: [],
    ask: 'Yukarıdaki şekilde; Alan (ALEK) = 9 cm² olduğuna göre, karenin bir kenarının uzunluğu kaç cm dir?',
    choices: [
      { key: 'A', text: '3' },
      { key: 'B', text: '6' },
      { key: 'C', text: '8' },
    ...
    answer: 'B',
    hint: 'AEK ve BEL üçgenlerini karşılaştırın; E, köşegenlerin orta noktasıdır.',
    solution: [
      {
        title: 'Açılar',
        detail:
          'm(AEB) = 90° ve m(KEL) = 90° olduğundan m(AEK) = 90° − m(AEL) = m(BEL).',
      },
      {
        title: 'Eşlik',
        detail:
          '|EA| = |EB| ve m(EAK) = m(EBL) = 45° olduğundan AEK ve BEL üçgenleri eştir (A.K.A.).',
      },
      {
        title: 'Alan',
        detail:
          'A(ALEK) = A(AEL) + A(AEK) = A(AEL) + A(BEL) = A(AEB); bu da karenin alanının dörtte biridir.',
      },
      {
        title: 'Kenar',
        detail:
      ...
      },
      {
        title: 'Sonuç',
        detail:
          'Karenin bir kenarı 6 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-172',
    topic: 'Paralelkenar içinde dikdörtgenle alan',
    figure: {
      viewBox: '0 0 400 200',
      caption: 'Şekil 172',
      label:
        'ABCD paralelkenarında K, [DC] üzerinde; F, [BC] nin orta noktası; E paralelkenarın içinde; DEFK bir dikdörtgen; |BF| = |FC| eşit işaretli.',
      svg: `
          <path class="ln" d="M48.0,180.0 L276.0,180.0 L352.0,28.0 L124.0,28.0 Z"/>
          <path class="ln" d="M124.0,28.0 L124.0,104.0 L314.0,104.0 L314.0,28.0"/>
          <path class="arc" d="M304.0,28.0 L304.0,38.0 L314.0,38.0"/>
          <path class="arc" d="M124.0,94.0 L134.0,94.0 L134.0,104.0"/>
          <path class="tick" d="M289.6,139.3 L300.4,144.7"/>
          <path class="tick" d="M327.6,63.3 L338.4,68.7"/>
          <circle class="pt" cx="48.0" cy="180.0" r="3.2"/>
          <circle class="pt" cx="276.0" cy="180.0" r="3.2"/>
          <circle class="pt" cx="352.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="124.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="124.0" cy="104.0" r="3.2"/>
          <circle class="pt" cx="314.0" cy="104.0" r="3.2"/>
          <circle class="pt" cx="314.0" cy="28.0" r="3.2"/>
          <text x="38.0" y="198.0" text-anchor="end">A</text>
          <text x="276.0" y="200.0" text-anchor="middle">B</text>
          <text x="362.0" y="22.0">C</text>
          <text x="116.0" y="20.0" text-anchor="end">D</text>
          <text x="314.0" y="18.0" text-anchor="middle">K</text>
          <text x="324.0" y="112.0">F</text>
          <text x="116.0" y="122.0" text-anchor="end">E</text>
        `,
    },
    given: [
      'ABCD paralelkenar',
    ...
    stem: [],
    ask: 'Yukarıdaki verilere göre, DEFK dikdörtgeninin alanı kaç cm² dir?',
    choices: [
      { key: 'A', text: '30' },
      { key: 'B', text: '36' },
      { key: 'C', text: '40' },
    ...
    answer: 'C',
    hint: 'F, [BC] nin orta noktası olduğundan A(DFC), paralelkenarın alanının dörtte biridir.',
    solution: [
      {
        title: 'Adlar',
        detail:
          'Paralelkenarın alanı S, dikdörtgenin alanı R olsun.',
      },
      {
        title: 'DFC',
        detail:
          'A(DBC) = S / 2 ve F, [BC] nin orta noktası olduğundan A(DFC) = S / 4.',
      },
      {
        title: 'Parçalar',
        detail:
          'A(DFC) = A(DKF) + A(KFC) = R / 2 + 4 ⇒ S = 2R + 16.',
      },
      {
        title: 'Beşgen',
        detail:
          'A(ABFED) = S − R − 4 = 52 ⇒ 2R + 16 − R − 4 = 52.',
      },
      {
        title: 'Sonuç',
        detail:
          'R = 40; DEFK dikdörtgeninin alanı 40 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-173',
    topic: 'İki karede eş dik üçgenlerle açı',
    figure: {
      viewBox: '0 0 400 298',
      caption: 'Şekil 173',
      label:
        'ABCD karesinde E, [BC] üzerinde; AEFT bir kare; F noktası ABCD karesinin dışında; m(BAE) = 28°, m(EFC) = x.',
      svg: `
          <path class="ln" d="M80.5,114.9 L80.5,270.9 L236.5,270.9 L236.5,114.9 Z"/>
          <path class="ln" d="M80.5,114.9 L163.5,270.9 L319.5,188.0 L236.5,32.0 Z"/>
          <path class="ln" d="M236.5,270.9 L319.5,188.0"/>
          <path class="arc" d="M80.5,144.9 A30,30 0 0 0 94.6,141.4"/>
          <text class="val" x="95.5" y="180.1" text-anchor="middle">28°</text>
          <path class="arc" d="M284.2,206.8 A40,40 0 0 0 291.2,216.3"/>
          <text class="val" x="272.1" y="227.1" text-anchor="middle">x</text>
          <circle class="pt" cx="80.5" cy="114.9" r="3.2"/>
          <circle class="pt" cx="80.5" cy="270.9" r="3.2"/>
          <circle class="pt" cx="236.5" cy="270.9" r="3.2"/>
          <circle class="pt" cx="236.5" cy="114.9" r="3.2"/>
          <circle class="pt" cx="163.5" cy="270.9" r="3.2"/>
          <circle class="pt" cx="319.5" cy="188.0" r="3.2"/>
          <circle class="pt" cx="236.5" cy="32.0" r="3.2"/>
          <text x="70.5" y="110.9" text-anchor="end">A</text>
          <text x="70.5" y="288.9" text-anchor="end">B</text>
          <text x="236.5" y="290.9" text-anchor="middle">C</text>
          <text x="228.5" y="130.9" text-anchor="end">D</text>
          <text x="163.5" y="290.9" text-anchor="middle">E</text>
          <text x="329.5" y="193.0">F</text>
          <text x="236.5" y="22.0" text-anchor="middle">T</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 298',
      caption: 'Şekil 173',
      label:
        'ABCD karesinde E, [BC] üzerinde; AEFT bir kare; F noktası ABCD karesinin dışında; m(BAE) = 28°, m(EFC) = x; f den [BC] nin uzantısına inen dikmenin ayağı H; ABE ve EHF üçgenleri eş.',
      svg: `
          <path class="ln" d="M80.5,114.9 L80.5,270.9 L236.5,270.9 L236.5,114.9 Z"/>
          <path class="ln" d="M80.5,114.9 L163.5,270.9 L319.5,188.0 L236.5,32.0 Z"/>
          <path class="ln" d="M236.5,270.9 L319.5,188.0"/>
          <path class="aux" d="M236.5,270.9 L319.5,270.9"/>
          <path class="aux" d="M319.5,188.0 L319.5,270.9"/>
          <path class="arc" d="M319.5,261.9 L310.5,261.9 L310.5,270.9"/>
          <path class="arc" d="M80.5,144.9 A30,30 0 0 0 94.6,141.4"/>
          <text class="val" x="95.5" y="180.1" text-anchor="middle">28°</text>
          <path class="arc" d="M284.2,206.8 A40,40 0 0 0 291.2,216.3"/>
          <text class="val" x="272.1" y="227.1" text-anchor="middle">x</text>
          ...
          <circle class="pt" cx="319.5" cy="188.0" r="3.2"/>
          <circle class="pt" cx="236.5" cy="32.0" r="3.2"/>
          <circle class="pt" cx="319.5" cy="270.9" r="3.2"/>
          <text x="70.5" y="110.9" text-anchor="end">A</text>
          <text x="70.5" y="288.9" text-anchor="end">B</text>
          <text x="236.5" y="290.9" text-anchor="middle">C</text>
          <text x="228.5" y="130.9" text-anchor="end">D</text>
          ...
          <text x="329.5" y="193.0">F</text>
          <text x="236.5" y="22.0" text-anchor="middle">T</text>
          <text x="329.5" y="288.9">H</text>
        `,
    },
    given: [
      'ABCD ve AEFT birer kare',
      'm(BAE) = 28°',
      'm(EFC) = x',
    ],
    stem: [],
    ...
    answer: 'D',
    hint: 'F den BC doğrusuna bir dikme indirin ve oluşan üçgeni ABE üçgeniyle karşılaştırın.',
    solution: [
      {
        title: 'Dikme',
        detail:
          'F den BC doğrusuna inen dikmenin ayağı H olsun.',
      },
      {
        title: 'Eşlik',
        detail:
          '|AE| = |EF|, m(AEF) = 90° olduğundan ABE ve EHF dik üçgenleri eştir: |EH| = |AB| = |BC|, |HF| = |BE|.',
      },
      {
        title: 'CHF',
        detail:
          '|CH| = |EH| − |EC| = |BC| − |EC| = |BE| = |HF|; CHF ikizkenar dik üçgen, m(FCH) = 45°, m(ECF) = 135°.',
      },
      {
        title: 'FEC',
        detail:
          'm(AEB) = 90° − 28° = 62° ve m(AEF) = 90° olduğundan m(FEC) = 180° − 62° − 90° = 28°.',
      },
      {
        title: 'Sonuç',
        detail:
          'EFC üçgeninde x = 180° − 135° − 28° = 17° bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-174',
    topic: 'Üçgen içinde dikdörtgen ve benzerlik',
    figure: {
      viewBox: '0 0 400 270',
      caption: 'Şekil 174',
      label:
        'ABC üçgeninde DEFK dikdörtgeni; D, [AB] üzerinde; K, [AC] üzerinde; E ve F, [BC] üzerinde; |BE| = x.',
      svg: `
          <path class="ln" d="M200.0,30.0 L47.0,234.0 L353.0,234.0 Z"/>
          <path class="ln" d="M98.0,234.0 L98.0,166.0 L302.0,166.0 L302.0,234.0"/>
          <path class="arc" d="M98.0,224.0 L108.0,224.0 L108.0,234.0"/>
          <path class="arc" d="M302.0,224.0 L292.0,224.0 L292.0,234.0"/>
          <circle class="pt" cx="200.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="47.0" cy="234.0" r="3.2"/>
          <circle class="pt" cx="353.0" cy="234.0" r="3.2"/>
          <circle class="pt" cx="98.0" cy="166.0" r="3.2"/>
          <circle class="pt" cx="302.0" cy="166.0" r="3.2"/>
          <circle class="pt" cx="98.0" cy="234.0" r="3.2"/>
          <circle class="pt" cx="302.0" cy="234.0" r="3.2"/>
          <text x="200.0" y="20.0" text-anchor="middle">A</text>
          <text x="37.0" y="252.0" text-anchor="end">B</text>
          <text x="363.0" y="252.0">C</text>
          <text x="88.0" y="166.0" text-anchor="end">D</text>
          <text x="312.0" y="166.0">K</text>
          <text x="98.0" y="254.0" text-anchor="middle">E</text>
          <text x="302.0" y="254.0" text-anchor="middle">F</text>
          <text class="val" x="72.5" y="254.3" text-anchor="middle">x</text>
        `,
    },
    given: [
      'ABC bir üçgen',
    ...
    stem: [],
    ask: 'Yukarıdaki şekilde; A(DEFK) = 48 cm² olduğuna göre, |BE| = x kaç cm dir?',
    choices: [
      { key: 'A', text: '2' },
      { key: 'B', text: '3' },
      { key: 'C', text: '4' },
    ...
    answer: 'B',
    hint: '[DK] ∥ [BC] olduğundan ADK ve ABC üçgenleri benzerdir.',
    solution: [
      {
        title: 'DK',
        detail:
          'A(DEFK) = |DK| · |DE| ⇒ 48 = |DK| · 4 ⇒ |DK| = 12 cm.',
      },
      {
        title: 'Benzerlik',
        detail:
          'ADK ~ ABC ⇒ |AD| / |AB| = |DK| / |BC| = 12 / 18 = 2 / 3.',
      },
      {
        title: 'AB',
        detail:
          '10 / |AB| = 2 / 3 ⇒ |AB| = 15 cm, |DB| = 15 − 10 = 5 cm.',
      },
      {
        title: 'Pisagor',
        detail:
          'DEB dik üçgeninde x² + 4² = 5² ⇒ x² = 9.',
      },
      {
        title: 'Sonuç',
        detail:
  ...
  {
    id: 'quadrilaterals-175',
    topic: 'Karede döndürme ile uzunluk',
    figure: {
      viewBox: '0 0 400 347',
      caption: 'Şekil 175',
      label:
        'ABCD karesinin içinde F noktası; [FA], [FB] ve [FC] çizilmiş; m(CFB) = 135°, |FC| = 2 cm, |FB| = 4 cm.',
      svg: `
          <path class="ln" d="M71.3,277.4 L328.7,277.4 L328.7,20.0 L71.3,20.0 Z"/>
          <path class="ln" d="M71.3,277.4 L282.2,99.4"/>
          <path class="ln" d="M328.7,20.0 L282.2,99.4 L328.7,277.4"/>
          <path class="arc" d="M289.3,87.3 A14,14 0 0 1 285.7,112.9"/>
          <text class="val" x="292.2" y="135.4">135°</text>
          <text class="val" x="293.5" y="55.7" text-anchor="end">2</text>
          <text class="val" x="293.5" y="196.4" text-anchor="end">4</text>
          <circle class="pt" cx="71.3" cy="277.4" r="3.2"/>
          <circle class="pt" cx="328.7" cy="277.4" r="3.2"/>
          <circle class="pt" cx="328.7" cy="20.0" r="3.2"/>
          <circle class="pt" cx="71.3" cy="20.0" r="3.2"/>
          <circle class="pt" cx="282.2" cy="99.4" r="3.2"/>
          <text x="61.3" y="295.4" text-anchor="end">A</text>
          <text x="338.7" y="295.4">B</text>
          <text x="338.7" y="14.0">C</text>
          <text x="61.3" y="14.0" text-anchor="end">D</text>
          <text x="272.2" y="93.4" text-anchor="end">F</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 347',
      caption: 'Şekil 175',
      label:
        'ABCD karesinin içinde F noktası; [FA], [FB] ve [FC] çizilmiş; m(CFB) = 135°, |FC| = 2 cm, |FB| = 4 cm; bFC üçgeni B etrafında 90° döndürülerek BGA üçgeni elde edilmiş; [FG] çizilmiş.',
      svg: `
          <path class="ln" d="M71.3,277.4 L328.7,277.4 L328.7,20.0 L71.3,20.0 Z"/>
          <path class="ln" d="M71.3,277.4 L282.2,99.4"/>
          <path class="ln" d="M328.7,20.0 L282.2,99.4 L328.7,277.4"/>
          <path class="aux" d="M328.7,277.4 L150.7,323.9 L71.3,277.4"/>
          <path class="aux" d="M282.2,99.4 L150.7,323.9"/>
          <path class="arc" d="M326.4,268.7 L317.7,271.0 L320.0,279.7"/>
          <path class="arc" d="M155.2,316.1 L147.5,311.6 L142.9,319.4"/>
          <path class="arc" d="M289.3,87.3 A14,14 0 0 1 285.7,112.9"/>
          <text class="val" x="292.2" y="135.4">135°</text>
          <text class="val" x="293.5" y="55.7" text-anchor="end">2</text>
          <text class="val" x="293.5" y="196.4" text-anchor="end">4</text>
          ...
          <circle class="pt" cx="71.3" cy="20.0" r="3.2"/>
          <circle class="pt" cx="282.2" cy="99.4" r="3.2"/>
          <circle class="pt" cx="150.7" cy="323.9" r="3.2"/>
          <text x="61.3" y="295.4" text-anchor="end">A</text>
          <text x="338.7" y="295.4">B</text>
          <text x="338.7" y="14.0">C</text>
          <text x="61.3" y="14.0" text-anchor="end">D</text>
          <text x="272.2" y="93.4" text-anchor="end">F</text>
          <text x="150.7" y="343.9" text-anchor="middle">G</text>
        `,
    },
    given: [
      'ABCD kare',
    ...
    stem: [],
    ask: 'Yukarıdaki verilere göre, |AF| kaç cm dir?',
    choices: [
      { key: 'A', text: '2√6' },
      { key: 'B', text: '2√7' },
      { key: 'C', text: '4√2' },
    ...
    answer: 'D',
    hint: 'BFC üçgenini B etrafında 90° döndürerek C yi A nın üzerine getirin.',
    solution: [
      {
        title: 'Döndürme',
        detail:
          'BFC üçgeni B etrafında 90° döndürülsün; C, A ya ve F, G ye gitsin: |BG| = 4 cm, |GA| = 2 cm, m(BGA) = 135°.',
      },
      {
        title: 'FBG',
        detail:
          'm(FBG) = 90° ve |BF| = |BG| = 4 cm olduğundan |FG| = 4√2 cm ve m(BGF) = 45°.',
      },
      {
        title: 'Dik açı',
        detail:
  ...
  {
    id: 'quadrilaterals-176',
    topic: 'Yamukta paralel çizerek taban uzunluğu',
    figure: {
      viewBox: '0 0 400 154',
      caption: 'Şekil 176',
      label:
        'ABCD yamuğunda [AB] ∥ [DC]; |DC| = 6 cm, |BC| = 10 cm, m(DAB) = 75°, m(ABC) = 30°, |AB| = x.',
      svg: `
          <path class="ln" d="M50.0,123.8 L350.0,123.8 L187.6,30.0 L75.1,30.0 Z"/>
          <path class="arc" d="M76.0,123.8 A26,26 0 0 0 56.7,98.6"/>
          <text class="val" x="88.1" y="99.5" text-anchor="middle">75°</text>
          <path class="arc" d="M327.5,110.8 A26,26 0 0 0 324.0,123.8"/>
          <text class="val" x="295.9" y="114.3" text-anchor="middle">30°</text>
          <text class="val" x="131.4" y="21.0" text-anchor="middle">6</text>
          <text class="val" x="261.8" y="94.0" text-anchor="middle">10</text>
          <text class="val" x="260.0" y="138.8" text-anchor="middle">x</text>
          <circle class="pt" cx="50.0" cy="123.8" r="3.2"/>
          <circle class="pt" cx="350.0" cy="123.8" r="3.2"/>
          <circle class="pt" cx="187.6" cy="30.0" r="3.2"/>
          <circle class="pt" cx="75.1" cy="30.0" r="3.2"/>
          <text x="40.0" y="141.8" text-anchor="end">A</text>
          <text x="360.0" y="141.8">B</text>
          <text x="197.6" y="24.0">C</text>
          <text x="65.1" y="24.0" text-anchor="end">D</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 154',
      caption: 'Şekil 176',
      label:
        'ABCD yamuğunda [AB] ∥ [DC]; |DC| = 6 cm, |BC| = 10 cm, m(DAB) = 75°, m(ABC) = 30°; C den [AD] ye paralel çizilen doğru [AB] yi E de kesiyor.',
      svg: `
          <path class="ln" d="M50.0,123.8 L350.0,123.8 L187.6,30.0 L75.1,30.0 Z"/>
          <path class="arc" d="M76.0,123.8 A26,26 0 0 0 56.7,98.6"/>
          <text class="val" x="88.1" y="99.5" text-anchor="middle">75°</text>
          ...
          <text class="val" x="261.8" y="94.0" text-anchor="middle">10</text>
          <text class="val" x="260.0" y="138.8" text-anchor="middle">x</text>
          <path class="aux" d="M187.6,30.0 L162.5,123.8"/>
          <circle class="pt" cx="162.5" cy="123.8" r="3.2"/>
          <path class="arc" d="M182.5,123.8 A20,20 0 0 0 167.7,104.4"/>
          <circle class="pt" cx="50.0" cy="123.8" r="3.2"/>
          <circle class="pt" cx="350.0" cy="123.8" r="3.2"/>
          <circle class="pt" cx="187.6" cy="30.0" r="3.2"/>
          <circle class="pt" cx="75.1" cy="30.0" r="3.2"/>
          ...
          <text x="197.6" y="24.0">C</text>
          <text x="65.1" y="24.0" text-anchor="end">D</text>
          <text x="162.5" y="143.8" text-anchor="middle">E</text>
        `,
    },
    given: [
      'ABCD yamuk',
    ...
    answer: 'D',
    hint: 'C den [AD] ye paralel bir doğru çizerek yamuğu bir paralelkenar ve bir üçgene ayırın.',
    solution: [
      {
        title: 'Paralel',
        detail:
          'C den [AD] ye çizilen paralel [AB] yi E de kessin; AECD paralelkenar olduğundan |AE| = |DC| = 6 cm.',
      },
      {
        title: 'Açılar',
        detail:
          '[CE] ∥ [DA] olduğundan m(CEB) = m(DAB) = 75°; EBC üçgeninde m(ECB) = 180° − 75° − 30° = 75°.',
      },
      {
        title: 'İkizkenar',
        detail:
          'm(CEB) = m(ECB) olduğundan |EB| = |BC| = 10 cm.',
      },
      {
        title: 'Sonuç',
        detail:
          '|AB| = |AE| + |EB| = 6 + 10 = 16 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-177',
    topic: 'Yamukta alan eşitliğiyle taban',
    figure: {
      viewBox: '0 0 400 240',
      caption: 'Şekil 177',
      label:
        'ABCD yamuğunda [AB] ∥ [DC]; E noktası [BC] üzerinde, |BE| = 3|EC|; [AE] çizilmiş; |AB| = 10 cm, |DC| = x.',
      svg: `
          <path class="ln" d="M50.0,210.0 L350.0,210.0 L260.0,30.0 L110.0,30.0 Z"/>
          <path class="ln" d="M50.0,210.0 L282.5,75.0"/>
          <text class="val" x="200.0" y="201.0" text-anchor="middle">10</text>
          <text class="val" x="185.0" y="49.0" text-anchor="middle">x</text>
          <circle class="pt" cx="50.0" cy="210.0" r="3.2"/>
          <circle class="pt" cx="350.0" cy="210.0" r="3.2"/>
          <circle class="pt" cx="260.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="110.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="282.5" cy="75.0" r="3.2"/>
          <text x="40.0" y="228.0" text-anchor="end">A</text>
          <text x="360.0" y="228.0">B</text>
          <text x="270.0" y="24.0">C</text>
          <text x="100.0" y="24.0" text-anchor="end">D</text>
          <text x="292.5" y="80.0">E</text>
        `,
    },
    given: [
      'ABCD bir yamuk',
    ...
    answer: 'C',
    hint: 'E noktasının [AB] ye uzaklığı, yamuğun yüksekliğinin kaçta kaçıdır?',
    solution: [
      {
        title: 'Yükseklik',
        detail:
          'Yamuğun yüksekliği h olsun. |BE| = (3/4)|BC| olduğundan E nin [AB] ye uzaklığı 3h/4 tür.',
      },
      {
        title: 'A(ABE)',
        detail:
          'A(ABE) = 10 · (3h/4) / 2 = 15h/4.',
      },
      {
        title: 'Yarı alan',
        detail:
          'A(ABE) = A(AECD) olduğundan A(ABE) yamuk alanının yarısıdır: 15h/4 = (10 + x) · h / 4.',
      },
      {
        title: 'Sonuç',
        detail:
          '15 = 10 + x ⇒ x = 5 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-178',
    topic: 'Yamukta kenarortay uzatmasıyla dik üçgen',
    figure: {
      viewBox: '0 0 400 204',
      caption: 'Şekil 178',
      label:
        'ABCD yamuğunda [AB] ∥ [DC]; E, [AD] nin orta noktası; [EC] ⊥ [BC]; |AB| = 18 cm, |BC| = 15 cm, |DC| = 7 cm.',
      svg: `
          <path class="ln" d="M134.0,174.0 L350.0,174.0 L242.0,30.0 L158.0,30.0 Z"/>
          <path class="ln" d="M146.0,102.0 L242.0,30.0"/>
          <path class="arc" d="M247.4,37.2 L240.2,42.6 L234.8,35.4"/>
          <path class="tick" d="M133.7,139.5 L145.5,141.5"/>
          <path class="tick" d="M134.5,134.5 L146.3,136.5"/>
          <path class="tick" d="M145.7,67.5 L157.5,69.5"/>
          <path class="tick" d="M146.5,62.5 L158.3,64.5"/>
          <text class="val" x="242.0" y="165.0" text-anchor="middle">18</text>
          <text class="val" x="284.8" y="115.4" text-anchor="middle">15</text>
          <text class="val" x="200.0" y="21.0" text-anchor="middle">7</text>
          <circle class="pt" cx="134.0" cy="174.0" r="3.2"/>
          <circle class="pt" cx="350.0" cy="174.0" r="3.2"/>
          <circle class="pt" cx="242.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="158.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="146.0" cy="102.0" r="3.2"/>
          <text x="134.0" y="194.0" text-anchor="middle">A</text>
          <text x="360.0" y="192.0">B</text>
          <text x="252.0" y="24.0">C</text>
          <text x="148.0" y="24.0" text-anchor="end">D</text>
          <text x="136.0" y="107.0" text-anchor="end">E</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 204',
      caption: 'Şekil 178',
      label:
        'ABCD yamuğunda [AB] ∥ [DC]; E, [AD] nin orta noktası; [EC] ⊥ [BC]; [CE] uzatılarak BA doğrusu F de kesilmiş; |AB| = 18 cm, |BC| = 15 cm, |DC| = 7 cm.',
      svg: `
          <path class="ln" d="M134.0,174.0 L350.0,174.0 L242.0,30.0 L158.0,30.0 Z"/>
          <path class="ln" d="M146.0,102.0 L242.0,30.0"/>
          <path class="arc" d="M247.4,37.2 L240.2,42.6 L234.8,35.4"/>
          ...
          <text class="val" x="284.8" y="115.4" text-anchor="middle">15</text>
          <text class="val" x="200.0" y="21.0" text-anchor="middle">7</text>
          <path class="aux" d="M50.0,174.0 L134.0,174.0"/>
          <path class="aux" d="M50.0,174.0 L146.0,102.0"/>
          <circle class="pt" cx="50.0" cy="174.0" r="3.2"/>
          <circle class="pt" cx="134.0" cy="174.0" r="3.2"/>
          <circle class="pt" cx="350.0" cy="174.0" r="3.2"/>
          <circle class="pt" cx="242.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="158.0" cy="30.0" r="3.2"/>
          ...
          <text x="148.0" y="24.0" text-anchor="end">D</text>
          <text x="136.0" y="107.0" text-anchor="end">E</text>
          <text x="40.0" y="192.0" text-anchor="end">F</text>
        `,
    },
    given: [
      'ABCD yamuk',
    ...
    stem: [],
    ask: 'Yukarıdaki verilere göre, |EC| kaç cm dir?',
    choices: [
      { key: 'A', text: '8' },
      { key: 'B', text: '9' },
      { key: 'C', text: '10' },
    ...
    answer: 'C',
    hint: '[CE] yi, BA doğrusunu kesene kadar uzatın.',
    solution: [
      {
        title: 'Uzatma',
        detail:
          '[CE] uzatılarak BA doğrusu F de kesilsin.',
      },
      {
        title: 'Eşlik',
        detail:
          '|AE| = |ED|, ters açılar ve iç ters açılar eşit olduğundan EDC ≅ EAF: |AF| = |DC| = 7 cm, |FE| = |EC|.',
      },
      {
        title: 'FBC',
        detail:
          '|FB| = 7 + 18 = 25 cm; FCB dik üçgeninde |FC|² = 25² − 15² = 400, |FC| = 20 cm.',
      },
      {
        title: 'Sonuç',
        detail:
          '|EC| = |FC| / 2 = 10 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-179',
    topic: 'Yamukta köşegenlerle oluşan üçgenlerin alanı',
    figure: {
      viewBox: '0 0 400 198',
      caption: 'Şekil 179',
      label:
        'ABCD yamuğunda [AB] ∥ [DC]; [AC] ve [BD] köşegenleri E de kesişiyor; EBC üçgeni taralı.',
      svg: `
          <path class="shade" d="M171.9,64.4 L350.0,167.5 L212.5,30.0 Z"/>
          <path class="ln" d="M50.0,167.5 L350.0,167.5 L212.5,30.0 L112.5,30.0 Z"/>
          <path class="ln" d="M50.0,167.5 L212.5,30.0"/>
          <path class="ln" d="M350.0,167.5 L112.5,30.0"/>
          <circle class="pt" cx="50.0" cy="167.5" r="3.2"/>
          <circle class="pt" cx="350.0" cy="167.5" r="3.2"/>
          <circle class="pt" cx="212.5" cy="30.0" r="3.2"/>
          <circle class="pt" cx="112.5" cy="30.0" r="3.2"/>
          <circle class="pt" cx="171.9" cy="64.4" r="3.2"/>
          <text x="40.0" y="185.5" text-anchor="end">A</text>
          <text x="360.0" y="185.5">B</text>
          <text x="222.5" y="24.0">C</text>
          <text x="102.5" y="24.0" text-anchor="end">D</text>
          <text x="161.9" y="69.4" text-anchor="end">E</text>
        `,
    },
    given: [
      'ABCD bir yamuk',
    ...
    stem: [],
    ask: 'Yukarıdaki verilere göre, A(EBC) kaç cm² dir?',
    choices: [
      { key: 'A', text: '6' },
      { key: 'B', text: '8' },
      { key: 'C', text: '9' },
    ...
    answer: 'C',
    hint: 'A(DEC) = S ve |AB| = k|DC| alınırsa diğer üç üçgenin alanı S ve k cinsinden yazılabilir.',
    solution: [
      {
        title: 'Benzerlik',
        detail:
          '|AB| = k|DC| ve A(DEC) = S olsun. DEC ~ BEA olduğundan A(ABE) = k²S.',
      },
      {
        title: 'Yan üçgenler',
        detail:
          'A(EBC) = A(AED) = kS; toplam alan S + 2kS + k²S = S(k + 1)² = 48.',
      },
      {
        title: 'Fark',
        detail:
          'A(ABE) − A(DEC) = S(k² − 1) = S(k − 1)(k + 1) = 24.',
      },
      {
        title: 'Oran',
        detail:
          'Taraf tarafa bölünürse (k − 1)/(k + 1) = 1/2 ⇒ k = 3; S · 16 = 48 ⇒ S = 3.',
      },
      {
        title: 'Sonuç',
        detail:
          'A(EBC) = kS = 3 · 3 = 9 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-180',
    topic: 'İkizkenar yamukta dik köşegenler ve alan',
    figure: {
      viewBox: '0 0 400 253',
      caption: 'Şekil 180',
      label:
        'ABCD ikizkenar yamuğunda [AB] ∥ [DC], |AD| = |BC|; [AC] ve [BD] köşegenleri E de dik kesişiyor; |AB| = 14 cm, |DC| = 4 cm.',
      svg: `
          <path class="ln" d="M50.0,222.9 L350.0,222.9 L242.9,30.0 L157.1,30.0 Z"/>
          <path class="ln" d="M50.0,222.9 L242.9,30.0"/>
          <path class="ln" d="M350.0,222.9 L157.1,30.0"/>
          <path class="arc" d="M205.7,67.2 L200.0,61.5 L194.3,67.2"/>
          <path class="tick" d="M98.3,123.5 L108.8,129.3"/>
          <path class="tick" d="M291.2,129.3 L301.7,123.5"/>
          <text class="val" x="140.0" y="237.9" text-anchor="middle">14</text>
          <text class="val" x="178.6" y="21.0" text-anchor="middle">4</text>
          <circle class="pt" cx="50.0" cy="222.9" r="3.2"/>
          <circle class="pt" cx="350.0" cy="222.9" r="3.2"/>
          <circle class="pt" cx="242.9" cy="30.0" r="3.2"/>
          <circle class="pt" cx="157.1" cy="30.0" r="3.2"/>
          <circle class="pt" cx="200.0" cy="72.9" r="3.2"/>
          <text x="40.0" y="240.9" text-anchor="end">A</text>
          <text x="360.0" y="240.9">B</text>
          <text x="252.9" y="24.0">C</text>
          <text x="147.1" y="24.0" text-anchor="end">D</text>
          <text x="210.0" y="77.9">E</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 253',
      caption: 'Şekil 180',
      label:
        'ABCD ikizkenar yamuğunda [AB] ∥ [DC], |AD| = |BC|; [AC] ve [BD] köşegenleri E de dik kesişiyor; E den geçen yükseklik [DC] yi K de, [AB] yi H de kesiyor; |AB| = 14 cm, |DC| = 4 cm.',
      svg: `
          <path class="ln" d="M50.0,222.9 L350.0,222.9 L242.9,30.0 L157.1,30.0 Z"/>
          <path class="ln" d="M50.0,222.9 L242.9,30.0"/>
          <path class="ln" d="M350.0,222.9 L157.1,30.0"/>
          ...
          <text class="val" x="140.0" y="237.9" text-anchor="middle">14</text>
          <text class="val" x="178.6" y="21.0" text-anchor="middle">4</text>
          <path class="aux" d="M200.0,30.0 L200.0,222.9"/>
          <circle class="pt" cx="200.0" cy="222.9" r="3.2"/>
          <circle class="pt" cx="200.0" cy="30.0" r="3.2"/>
          <path class="arc" d="M208.0,222.9 L208.0,214.9 L200.0,214.9"/>
          <circle class="pt" cx="50.0" cy="222.9" r="3.2"/>
          <circle class="pt" cx="350.0" cy="222.9" r="3.2"/>
          <circle class="pt" cx="242.9" cy="30.0" r="3.2"/>
          <circle class="pt" cx="157.1" cy="30.0" r="3.2"/>
          ...
          <text x="147.1" y="24.0" text-anchor="end">D</text>
          <text x="210.0" y="77.9">E</text>
          <text x="200.0" y="242.9" text-anchor="middle">H</text>
          <text x="200.0" y="20.0" text-anchor="middle">K</text>
        `,
    },
    given: [
    ...
    answer: 'C',
    hint: 'E den geçen yüksekliği çizin; EAB ve EDC üçgenleri ikizkenar dik üçgendir.',
    solution: [
      {
        title: 'İkizkenar dik üçgenler',
        detail:
          'Yamuk ikizkenar olduğundan |EA| = |EB| ve |ED| = |EC|; köşegenler dik olduğundan EAB ve EDC ikizkenar dik üçgendir.',
      },
      {
        title: 'Yükseklik',
        detail:
          'E den geçen yükseklik [AB] yi H de, [DC] yi K de kessin. Hipotenüse ait kenarortay hipotenüsün yarısıdır: |EH| = 14/2 = 7 cm, |EK| = 4/2 = 2 cm.',
      },
      {
        title: 'h',
        detail:
      ...
      },
      {
        title: 'Sonuç',
        detail:
          'A(ABCD) = (14 + 4) · 9 / 2 = 81 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-181',
    topic: 'Dik yamukta açı',
    figure: {
      viewBox: '0 0 400 340',
      caption: 'Şekil 181',
      label:
        'ABCD dik yamuğunda A ve D açıları dik; [AB] ∥ [DC]; m(ABC) = α.',
      svg: `
          <path class="ln" d="M78.8,310.0 L321.2,310.0 L159.6,30.0 L78.8,30.0 Z"/>
          <path class="arc" d="M87.8,310.0 L87.8,301.0 L78.8,301.0"/>
          <path class="arc" d="M78.8,39.0 L87.8,39.0 L87.8,30.0"/>
          <path class="arc" d="M306.2,284.0 A30,30 0 0 0 291.2,310.0"/>
          <text class="val" x="279.7" y="291.0" text-anchor="middle">α</text>
          <circle class="pt" cx="78.8" cy="310.0" r="3.2"/>
          <circle class="pt" cx="321.2" cy="310.0" r="3.2"/>
          <circle class="pt" cx="159.6" cy="30.0" r="3.2"/>
          <circle class="pt" cx="78.8" cy="30.0" r="3.2"/>
          <text x="68.8" y="328.0" text-anchor="end">A</text>
          <text x="331.2" y="328.0">B</text>
          <text x="169.6" y="24.0">C</text>
          <text x="68.8" y="24.0" text-anchor="end">D</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 340',
      caption: 'Şekil 181',
      label:
        'ABCD dik yamuğunda A ve D açıları dik; [AB] ∥ [DC]; m(ABC) = α; C den [AB] ye inen dikmenin ayağı H.',
      svg: `
          <path class="ln" d="M78.8,310.0 L321.2,310.0 L159.6,30.0 L78.8,30.0 Z"/>
          <path class="arc" d="M87.8,310.0 L87.8,301.0 L78.8,301.0"/>
          <path class="arc" d="M78.8,39.0 L87.8,39.0 L87.8,30.0"/>
          <path class="arc" d="M306.2,284.0 A30,30 0 0 0 291.2,310.0"/>
          <text class="val" x="279.7" y="291.0" text-anchor="middle">α</text>
          <path class="aux" d="M159.6,30.0 L159.6,310.0"/>
          <circle class="pt" cx="159.6" cy="310.0" r="3.2"/>
          <path class="arc" d="M168.6,310.0 L168.6,301.0 L159.6,301.0"/>
          <circle class="pt" cx="78.8" cy="310.0" r="3.2"/>
          <circle class="pt" cx="321.2" cy="310.0" r="3.2"/>
          <circle class="pt" cx="159.6" cy="30.0" r="3.2"/>
          <circle class="pt" cx="78.8" cy="30.0" r="3.2"/>
          ...
          <text x="169.6" y="24.0">C</text>
          <text x="68.8" y="24.0" text-anchor="end">D</text>
          <text x="159.6" y="330.0" text-anchor="middle">H</text>
        `,
    },
    given: [
      'ABCD bir dik yamuk',
    ...
    answer: 'D',
    hint: 'C den [AB] ye dikme indirin ve oluşan dik üçgende kenarları |DC| cinsinden yazın.',
    solution: [
      {
        title: 'Dikme',
        detail:
          '|DC| = a olsun. C den [AB] ye inen dikmenin ayağı H olsun; AHCD dikdörtgen olduğundan |AH| = a.',
      },
      {
        title: 'HB',
        detail:
          '|HB| = |AB| − |AH| = 3a − a = 2a; |BC| = 4a.',
      },
      {
        title: 'Kosinüs',
        detail:
          'CHB dik üçgeninde cos α = |HB| / |BC| = 2a / 4a = 1/2.',
      },
      {
        title: 'Sonuç',
        detail:
  ...
  {
    id: 'quadrilaterals-182',
    topic: 'Yamukta orta tabanla alan oranı',
    figure: {
      viewBox: '0 0 400 234',
      caption: 'Şekil 182',
      label:
        'ABCD yamuğunda [AB] ∥ [DC]; [EF] orta taban; |DC| = 6 cm, |AB| = 12 cm; EFCD bölgesi taralı.',
      svg: `
          <path class="shade" d="M81.2,117.5 L306.2,117.5 L262.5,30.0 L112.5,30.0 Z"/>
          <path class="ln" d="M50.0,205.0 L350.0,205.0 L262.5,30.0 L112.5,30.0 Z"/>
          <path class="ln" d="M81.2,117.5 L306.2,117.5"/>
          <text class="val" x="187.5" y="21.0" text-anchor="middle">6</text>
          <text class="val" x="200.0" y="196.0" text-anchor="middle">12</text>
          <circle class="pt" cx="50.0" cy="205.0" r="3.2"/>
          <circle class="pt" cx="350.0" cy="205.0" r="3.2"/>
          <circle class="pt" cx="262.5" cy="30.0" r="3.2"/>
          <circle class="pt" cx="112.5" cy="30.0" r="3.2"/>
          <circle class="pt" cx="81.2" cy="117.5" r="3.2"/>
          <circle class="pt" cx="306.2" cy="117.5" r="3.2"/>
          <text x="40.0" y="223.0" text-anchor="end">A</text>
          <text x="360.0" y="223.0">B</text>
          <text x="272.5" y="24.0">C</text>
          <text x="102.5" y="24.0" text-anchor="end">D</text>
          <text x="71.2" y="122.5" text-anchor="end">E</text>
          <text x="316.2" y="122.5">F</text>
        `,
    },
    given: [
      'ABCD bir yamuk',
    ...
    stem: [],
    ask: 'Yukarıdaki verilere göre, A(EFCD) / A(ABFE) oranı kaçtır?',
    choices: [
      { key: 'A', text: '1/2' },
      { key: 'B', text: '2/3' },
      { key: 'C', text: '5/7' },
    ...
    answer: 'C',
    hint: 'Önce orta tabanın uzunluğunu bulun; iki küçük yamuğun yükseklikleri eşittir.',
    solution: [
      {
        title: 'Orta taban',
        detail:
          '|EF| = (|DC| + |AB|) / 2 = (6 + 12) / 2 = 9 cm.',
      },
      {
        title: 'Yükseklik',
        detail:
          'E ve F kenarların orta noktaları olduğundan EFCD ile ABFE yamuklarının yükseklikleri eşittir; ikisine de h diyelim.',
      },
      {
        title: 'Alanlar',
        detail:
          'A(EFCD) = (6 + 9) · h / 2 = 15h/2, A(ABFE) = (9 + 12) · h / 2 = 21h/2.',
      },
      {
        title: 'Sonuç',
        detail:
          'A(EFCD) / A(ABFE) = 15 / 21 = 5/7 bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-183',
    topic: 'Yamukta üçgen alanıyla yükseklik ve taban',
    figure: {
      viewBox: '0 0 400 220',
      caption: 'Şekil 183',
      label:
        'ABCD yamuğunda [AB] ∥ [DC]; E noktası [AB] üzerinde, [DE] çizilmiş; |AE| = 8 cm, |EB| = 4 cm, |DC| = x.',
      svg: `
          <path class="ln" d="M50.0,180.0 L350.0,180.0 L250.0,30.0 L100.0,30.0 Z"/>
          <path class="ln" d="M100.0,30.0 L250.0,180.0"/>
          <text class="val" x="150.0" y="172.0" text-anchor="middle">8</text>
          <text class="val" x="300.0" y="172.0" text-anchor="middle">4</text>
          <text class="val" x="175.0" y="21.0" text-anchor="middle">x</text>
          <circle class="pt" cx="50.0" cy="180.0" r="3.2"/>
          <circle class="pt" cx="350.0" cy="180.0" r="3.2"/>
          <circle class="pt" cx="250.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="100.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="250.0" cy="180.0" r="3.2"/>
          <text x="40.0" y="198.0" text-anchor="end">A</text>
          <text x="360.0" y="198.0">B</text>
          <text x="260.0" y="24.0">C</text>
          <text x="90.0" y="24.0" text-anchor="end">D</text>
          <text x="250.0" y="200.0" text-anchor="middle">E</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 220',
      caption: 'Şekil 183',
      label:
        'ABCD yamuğunda [AB] ∥ [DC]; E noktası [AB] üzerinde, [DE] çizilmiş; D den [AB] ye inilen dikme H noktasında.',
      svg: `
          <path class="ln" d="M50.0,180.0 L350.0,180.0 L250.0,30.0 L100.0,30.0 Z"/>
          <path class="ln" d="M100.0,30.0 L250.0,180.0"/>
          <text class="val" x="150.0" y="172.0" text-anchor="middle">8</text>
          <text class="val" x="300.0" y="172.0" text-anchor="middle">4</text>
          <text class="val" x="175.0" y="21.0" text-anchor="middle">x</text>
          <path class="aux" d="M100.0,30.0 L100.0,180.0"/>
          <path class="arc" d="M100.0,171.0 L109.0,171.0 L109.0,180.0"/>
          <circle class="pt" cx="100.0" cy="180.0" r="3.2"/>
          <text x="100.0" y="200.0" text-anchor="middle">H</text>
          <circle class="pt" cx="50.0" cy="180.0" r="3.2"/>
          <circle class="pt" cx="350.0" cy="180.0" r="3.2"/>
          <circle class="pt" cx="250.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="100.0" cy="30.0" r="3.2"/>
    ...
    answer: 'C',
    hint: 'AED üçgeninin alanından yamuğun yüksekliğini bulun.',
    solution: [
      {
        title: 'Yükseklik',
        detail:
          'D den [AB] ye dikme [DH] olsun; bu dikme hem AED üçgeninin hem yamuğun yüksekliğidir.',
      },
      {
        title: 'A(AED)',
        detail:
      ...
      },
      {
        title: 'EBCD yamuğu',
        detail:
          'EBCD, tabanları |EB| = 4 ve |DC| = x olan bir yamuktur: (4 + x) · 6 / 2 = 30.',
      },
      {
        title: 'Sonuç',
        detail:
  ...
  {
    id: 'quadrilaterals-184',
    topic: 'Yamukta orta taban ve köşegenlerle paralel doğru',
    figure: {
      viewBox: '0 0 400 234',
      caption: 'Şekil 184',
      label:
        'ABCD yamuğunda [AB] ∥ [DC]; [EF] orta taban; köşegenler L de kesişiyor; [EF], [AC] yi M de, [BD] yi N de kesiyor; L den geçen [KL] ∥ [AB], K noktası [AD] üzerinde; |AB| = 18 cm, |KL| = x.',
      svg: `
          <path class="ln" d="M38.0,210.0 L362.0,210.0 L218.0,30.0 L110.0,30.0 Z"/>
          <path class="ln" d="M38.0,210.0 L218.0,30.0"/>
          <path class="ln" d="M362.0,210.0 L110.0,30.0"/>
          <path class="ln" d="M74.0,120.0 L290.0,120.0"/>
          <path class="ln" d="M92.0,75.0 L173.0,75.0"/>
          <text class="val" x="200.0" y="230.0" text-anchor="middle">18</text>
          <text class="val" x="132.5" y="68.0" text-anchor="middle">x</text>
          <circle class="pt" cx="38.0" cy="210.0" r="3.2"/>
          <circle class="pt" cx="362.0" cy="210.0" r="3.2"/>
          <circle class="pt" cx="218.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="110.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="74.0" cy="120.0" r="3.2"/>
          <circle class="pt" cx="290.0" cy="120.0" r="3.2"/>
          <circle class="pt" cx="173.0" cy="75.0" r="3.2"/>
          <circle class="pt" cx="128.0" cy="120.0" r="3.2"/>
          <circle class="pt" cx="236.0" cy="120.0" r="3.2"/>
          <circle class="pt" cx="92.0" cy="75.0" r="3.2"/>
          <text x="28.0" y="228.0" text-anchor="end">A</text>
          <text x="372.0" y="228.0">B</text>
          <text x="228.0" y="24.0">C</text>
          <text x="100.0" y="24.0" text-anchor="end">D</text>
          <text x="64.0" y="125.0" text-anchor="end">E</text>
          <text x="300.0" y="125.0">F</text>
          <text x="82.0" y="80.0" text-anchor="end">K</text>
          <text x="170.0" y="63.0" text-anchor="middle">L</text>
          <text x="126.0" y="140.0" text-anchor="middle">M</text>
          <text x="238.0" y="140.0" text-anchor="middle">N</text>
        `,
    },
    given: [
      'ABCD bir yamuk, [EF] orta taban',
      '[AC] ∩ [BD] = {L}',
      '[KL] ∥ [AB]',
      '|MN| = 2|EM|',
      '|AB| = 18 cm',
    ...
    answer: 'C',
    hint: 'ADC ve ADB üçgenlerinde [EF] nin parçaları birer orta taban gibi davranır.',
    solution: [
      {
        title: 'ABD üçgeni',
        detail:
          'E, [AD] nin orta noktası ve [EN] ∥ [AB] olduğundan |EN| = |AB| / 2 = 9 cm.',
      },
      {
        title: 'Kısa taban',
        detail:
          '|MN| = 2|EM| ⇒ |EN| = 3|EM| = 9 ⇒ |EM| = 3 cm. ADC üçgeninde |EM| = |DC| / 2 olduğundan |DC| = 6 cm.',
      },
      {
        title: 'Benzerlik',
        detail:
          'DLC ∼ BLA olduğundan |DL| / |DB| = 6 / (6 + 18) = 1/4.',
      },
      {
        title: 'Sonuç',
        detail:
          'DKL ∼ DAB ⇒ x = 18 · 1/4 = 9/2 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-185',
    topic: 'İkizkenar yamukta köşegen uzunluğu',
    figure: {
      viewBox: '0 0 400 234',
      caption: 'Şekil 185',
      label:
        'ABCD ikizkenar yamuğunda [AB] ∥ [DC]; |AD| = |BC| = 13 cm, |DC| = 11 cm, |AB| = 21 cm; [DB] köşegeni x ile gösterilmiş.',
      svg: `
          <path class="ln" d="M53.0,198.0 L347.0,198.0 L277.0,30.0 L123.0,30.0 Z"/>
          <path class="ln" d="M123.0,30.0 L347.0,198.0"/>
          <text class="val" x="200.0" y="218.0" text-anchor="middle">21</text>
          <text class="val" x="200.0" y="21.0" text-anchor="middle">11</text>
          <text class="val" x="74.0" y="114.0" text-anchor="middle">13</text>
          <text class="val" x="328.0" y="114.0" text-anchor="middle">13</text>
          <text class="val" x="241.0" y="106.0" text-anchor="middle">x</text>
          <circle class="pt" cx="53.0" cy="198.0" r="3.2"/>
          <circle class="pt" cx="347.0" cy="198.0" r="3.2"/>
          <circle class="pt" cx="277.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="123.0" cy="30.0" r="3.2"/>
          <text x="43.0" y="216.0" text-anchor="end">A</text>
          <text x="357.0" y="216.0">B</text>
          <text x="287.0" y="24.0">C</text>
          <text x="113.0" y="24.0" text-anchor="end">D</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 234',
      caption: 'Şekil 185',
      label:
        'ABCD ikizkenar yamuğunda D den [AB] ye inilen dikme H noktasında; [DB] köşegeni çizilmiş.',
      svg: `
          <path class="ln" d="M53.0,198.0 L347.0,198.0 L277.0,30.0 L123.0,30.0 Z"/>
          <path class="ln" d="M123.0,30.0 L347.0,198.0"/>
          <text class="val" x="200.0" y="218.0" text-anchor="middle">21</text>
          ...
          <text class="val" x="328.0" y="114.0" text-anchor="middle">13</text>
          <text class="val" x="241.0" y="106.0" text-anchor="middle">x</text>
          <path class="aux" d="M123.0,30.0 L123.0,198.0"/>
          <path class="arc" d="M123.0,189.0 L132.0,189.0 L132.0,198.0"/>
          <circle class="pt" cx="123.0" cy="198.0" r="3.2"/>
          <text x="123.0" y="218.0" text-anchor="middle">H</text>
          <circle class="pt" cx="53.0" cy="198.0" r="3.2"/>
          <circle class="pt" cx="347.0" cy="198.0" r="3.2"/>
          <circle class="pt" cx="277.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="123.0" cy="30.0" r="3.2"/>
    ...
    answer: 'D',
    hint: 'D den [AB] ye bir dikme inin; ikizkenar yamukta |AH| tabanların farkının yarısıdır.',
    solution: [
      {
        title: 'Dikme',
        detail:
          'D den [AB] ye dikme [DH] olsun. İkizkenar yamukta |AH| = (21 − 11) / 2 = 5 cm.',
      },
      {
        title: 'Yükseklik',
        detail:
          'ADH dik üçgeninde |DH|² = 13² − 5² = 169 − 25 = 144 ⇒ |DH| = 12 cm.',
      },
      {
        title: 'HB',
        detail:
      ...
      },
      {
        title: 'Sonuç',
        detail:
          'DHB dik üçgeninde x² = 12² + 16² = 400 ⇒ x = 20 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-186',
    topic: 'Yamukta eş tabanlı üçgenlerle alan',
    figure: {
      viewBox: '0 0 400 220',
      caption: 'Şekil 186',
      label:
        'ABCD yamuğunda [AB] ∥ [DC]; K noktası [DC], L noktası [AB] üzerinde; [AK] ile [DL] E de, [KB] ile [LC] F de kesişiyor; ADE ve CFB üçgenleri taralı.',
      svg: `
          <path class="shade" d="M40.0,190.0 L100.0,30.0 L128.7,71.7 Z"/>
          <path class="shade" d="M280.0,30.0 L248.9,101.1 L360.0,190.0 Z"/>
          <path class="ln" d="M40.0,190.0 L360.0,190.0 L280.0,30.0 L100.0,30.0 Z"/>
          <path class="ln" d="M40.0,190.0 L160.0,30.0"/>
          <path class="ln" d="M100.0,30.0 L210.0,190.0"/>
          <path class="ln" d="M160.0,30.0 L360.0,190.0"/>
          <path class="ln" d="M210.0,190.0 L280.0,30.0"/>
          <circle class="pt" cx="40.0" cy="190.0" r="3.2"/>
          <circle class="pt" cx="360.0" cy="190.0" r="3.2"/>
          <circle class="pt" cx="280.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="100.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="160.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="210.0" cy="190.0" r="3.2"/>
          <circle class="pt" cx="128.7" cy="71.7" r="3.2"/>
          <circle class="pt" cx="248.9" cy="101.1" r="3.2"/>
          <text x="30.0" y="208.0" text-anchor="end">A</text>
          <text x="370.0" y="208.0">B</text>
          <text x="290.0" y="24.0">C</text>
          <text x="90.0" y="24.0" text-anchor="end">D</text>
          <text x="160.0" y="20.0" text-anchor="middle">K</text>
          <text x="210.0" y="212.0" text-anchor="middle">L</text>
          <text x="138.7" y="76.7">E</text>
          <text x="238.9" y="106.1" text-anchor="end">F</text>
        `,
    },
    given: [
      'ABCD bir yamuk',
    ...
    stem: [],
    ask: 'Yukarıdaki verilere göre, A(CFB) kaç cm² dir?',
    choices: [
      { key: 'A', text: '8' },
      { key: 'B', text: '10' },
      { key: 'C', text: '12' },
    ...
    answer: 'C',
    hint: 'ADL ile AKL üçgenlerinin tabanı ortak, yükseklikleri de yamuğun yüksekliğidir.',
    solution: [
      {
        title: 'Eş alanlar',
        detail:
          'ADL ve AKL üçgenlerinin tabanı [AL] ortak ve yükseklikleri eşit olduğundan alanları eşittir; ikisinden de A(AEL) çıkarılırsa A(ADE) = A(KEL) = 8 cm².',
      },
      {
        title: 'Aynı fikir',
        detail:
          'CLB ve KLB üçgenlerinin tabanı [LB] ortak ve yükseklikleri eşittir; A(FLB) çıkarılırsa A(CFB) = A(KFL).',
      },
      {
        title: 'Dörtgen',
        detail:
          'A(KELF) = A(KEL) + A(KFL) ⇒ 20 = 8 + A(KFL) ⇒ A(KFL) = 12 cm².',
      },
      {
        title: 'Sonuç',
        detail:
          'A(CFB) = A(KFL) = 12 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-187',
    topic: 'Dik yamukta paralel doğruyla alan',
    figure: {
      viewBox: '0 0 400 234',
      caption: 'Şekil 187',
      label:
        'ABCD dik yamuğunda A ve B açıları dik; [AD] ∥ [EF] ∥ [BC]; E noktası [AB], F noktası [DC] üzerinde; |AD| = 6 cm, |AE| = 4 cm, |EF| = 10 cm.',
      svg: `
          <path class="ln" d="M50.0,30.0 L200.0,30.0 L350.0,180.0 L50.0,180.0 Z"/>
          <path class="ln" d="M50.0,130.0 L300.0,130.0"/>
          <path class="arc" d="M60.0,30.0 L60.0,40.0 L50.0,40.0"/>
          <path class="arc" d="M50.0,170.0 L60.0,170.0 L60.0,180.0"/>
          <text class="val" x="125.0" y="21.0" text-anchor="middle">6</text>
          <text class="val" x="36.0" y="85.0" text-anchor="middle">4</text>
          <text class="val" x="175.0" y="122.0" text-anchor="middle">10</text>
          <circle class="pt" cx="50.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="50.0" cy="180.0" r="3.2"/>
          <circle class="pt" cx="350.0" cy="180.0" r="3.2"/>
          <circle class="pt" cx="200.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="50.0" cy="130.0" r="3.2"/>
          <circle class="pt" cx="300.0" cy="130.0" r="3.2"/>
          <text x="40.0" y="24.0" text-anchor="end">A</text>
          <text x="208.0" y="24.0">D</text>
          <text x="40.0" y="198.0" text-anchor="end">B</text>
          <text x="360.0" y="198.0">C</text>
          <text x="40.0" y="135.0" text-anchor="end">E</text>
          <text x="310.0" y="135.0">F</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 234',
      caption: 'Şekil 187',
      label:
        'ABCD dik yamuğunda D den [BC] ye inilen dikme [EF] yi G de, [BC] yi H de kesiyor.',
      svg: `
          <path class="ln" d="M50.0,30.0 L200.0,30.0 L350.0,180.0 L50.0,180.0 Z"/>
          <path class="ln" d="M50.0,130.0 L300.0,130.0"/>
          <path class="arc" d="M60.0,30.0 L60.0,40.0 L50.0,40.0"/>
          ...
          <text class="val" x="36.0" y="85.0" text-anchor="middle">4</text>
          <text class="val" x="175.0" y="122.0" text-anchor="middle">10</text>
          <path class="aux" d="M200.0,30.0 L200.0,180.0"/>
          <circle class="pt" cx="200.0" cy="130.0" r="3.2"/>
          <circle class="pt" cx="200.0" cy="180.0" r="3.2"/>
          <text x="208.0" y="148.0">G</text>
          <text x="200.0" y="200.0" text-anchor="middle">H</text>
          <circle class="pt" cx="50.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="50.0" cy="180.0" r="3.2"/>
          <circle class="pt" cx="350.0" cy="180.0" r="3.2"/>
          <circle class="pt" cx="200.0" cy="30.0" r="3.2"/>
    ...
    answer: 'B',
    hint: 'D den [BC] ye bir dikme inin ve oluşan üçgende benzerliği kullanın.',
    solution: [
      {
        title: 'Dikme',
        detail:
          'D den [BC] ye dikme [DH] olsun; [EF] yi G de kessin. |EG| = |BH| = |AD| = 6 cm, dolayısıyla |GF| = 10 − 6 = 4 cm.',
      },
      {
        title: 'Yükseklik',
        detail:
          '[EF] ∥ [BC] olduğundan |AE| / |AB| = |DF| / |DC| = 2/3 ⇒ |AB| = 4 · 3/2 = 6 cm.',
      },
      {
        title: 'Benzerlik',
        detail:
          'DGF ∼ DHC ⇒ |HC| = |GF| · 3/2 = 6 cm, yani |BC| = 6 + 6 = 12 cm.',
      },
      {
        title: 'Sonuç',
        detail:
          'Alan(ABCD) = (6 + 12) · 6 / 2 = 54 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-188',
    topic: 'Yamukta kenar ortasıyla benzerlik ve alan',
    figure: {
      viewBox: '0 0 400 180',
      caption: 'Şekil 188',
      label:
        'ABCD yamuğunda [AB] ∥ [DC]; F noktası [BC] nin orta noktası; [AF] ile [BD] E de kesişiyor; DEFC dörtgeni taralı.',
      svg: `
          <path class="shade" d="M76.0,42.0 L178.9,103.7 L202.0,96.0 L148.0,42.0 Z"/>
          <path class="ln" d="M40.0,150.0 L256.0,150.0 L148.0,42.0 L76.0,42.0 Z"/>
          <path class="ln" d="M40.0,150.0 L202.0,96.0"/>
          <path class="ln" d="M256.0,150.0 L76.0,42.0"/>
          <path class="tick" d="M179.2,64.8 L170.8,73.2"/>
          <path class="tick" d="M233.2,118.8 L224.8,127.2"/>
          <circle class="pt" cx="40.0" cy="150.0" r="3.2"/>
          <circle class="pt" cx="256.0" cy="150.0" r="3.2"/>
          <circle class="pt" cx="148.0" cy="42.0" r="3.2"/>
          <circle class="pt" cx="76.0" cy="42.0" r="3.2"/>
          <circle class="pt" cx="178.9" cy="103.7" r="3.2"/>
          <circle class="pt" cx="202.0" cy="96.0" r="3.2"/>
          <text x="32.0" y="166.0" text-anchor="end">A</text>
          <text x="264.0" y="166.0">B</text>
          <text x="148.0" y="34.0" text-anchor="middle">C</text>
          <text x="76.0" y="34.0" text-anchor="middle">D</text>
          <text x="178.9" y="123.7" text-anchor="middle">E</text>
          <text x="212.0" y="100.0">F</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 180',
      caption: 'Şekil 188',
      label:
        'ABCD yamuğunda [AF] uzatılıp [DC] nin uzantısını G de kesiyor.',
      svg: `
          <path class="shade" d="M76.0,42.0 L178.9,103.7 L202.0,96.0 L148.0,42.0 Z"/>
          <path class="ln" d="M40.0,150.0 L256.0,150.0 L148.0,42.0 L76.0,42.0 Z"/>
          <path class="ln" d="M40.0,150.0 L202.0,96.0"/>
          ...
          <path class="tick" d="M179.2,64.8 L170.8,73.2"/>
          <path class="tick" d="M233.2,118.8 L224.8,127.2"/>
          <path class="aux" d="M148.0,42.0 L364.0,42.0"/>
          <path class="aux" d="M202.0,96.0 L364.0,42.0"/>
          <circle class="pt" cx="364.0" cy="42.0" r="3.2"/>
          <text x="364.0" y="34.0" text-anchor="middle">G</text>
          <circle class="pt" cx="40.0" cy="150.0" r="3.2"/>
          <circle class="pt" cx="256.0" cy="150.0" r="3.2"/>
          <circle class="pt" cx="148.0" cy="42.0" r="3.2"/>
          <circle class="pt" cx="76.0" cy="42.0" r="3.2"/>
    ...
    stem: [],
    ask: 'Yukarıdaki şekilde [AF] ∩ [BD] = {E} olduğuna göre, Alan(DEFC) kaç cm² dir?',
    choices: [
      { key: 'A', text: '9' },
      { key: 'B', text: '10' },
      { key: 'C', text: '11' },
    ...
    answer: 'C',
    hint: '[AF] yi, [DC] nin uzantısını kesene kadar uzatın ve F nin orta nokta olmasını kullanın.',
    solution: [
      {
        title: 'Alanı paylaştırma',
        detail:
          '|DC| = a, |AB| = 3a olsun. BCD ve ABD üçgenlerinin yükseklikleri eşit olduğundan A(BCD) = 56 · a/(a + 3a) = 14 cm².',
      },
      {
        title: 'Uzatma',
        detail:
          '[AF], [DC] nin uzantısını G de kessin. |CF| = |FB| ve [CG] ∥ [AB] olduğundan FCG ≅ FBA, yani |CG| = |AB| = 3a ve |DG| = 4a.',
      },
      {
        title: 'Benzerlik',
        detail:
          'ABE ∼ GDE ⇒ |BE| / |ED| = |AB| / |DG| = 3/4, yani |BE| = (3/7)|BD|.',
      },
      {
        title: 'Küçük üçgen',
        detail:
          'A(BEF) = (3/7) · (1/2) · A(BDC) = (3/14) · 14 = 3 cm².',
      },
      {
        title: 'Sonuç',
        detail:
          'Alan(DEFC) = A(BCD) − A(BEF) = 14 − 3 = 11 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-189',
    topic: 'Yamukta kenar ortası ve paralelle uzunluk',
    figure: {
      viewBox: '0 0 400 210',
      caption: 'Şekil 189',
      label:
        'ABCD yamuğunda [AB] ∥ [DC]; E noktası [BC] nin orta noktası; [ED] ⊥ [DA]; F noktası [AB] üzerinde ve [EF] ∥ [DA]; |AD| = 6 cm, |ED| = 4 cm.',
      svg: `
          <path class="ln" d="M50.0,180.0 L290.0,180.0 L218.0,36.0 L158.0,36.0 Z"/>
          <path class="ln" d="M158.0,36.0 L254.0,108.0"/>
          <path class="ln" d="M254.0,108.0 L200.0,180.0"/>
          <path class="arc" d="M152.0,44.0 L160.0,50.0 L166.0,42.0"/>
          <path class="tick" d="M266.6,146.7 L277.4,141.3"/>
          <path class="tick" d="M230.6,74.7 L241.4,69.3"/>
          <text class="val" x="92.0" y="108.0" text-anchor="end">6</text>
          <text class="val" x="202.0" y="90.0" text-anchor="end">4</text>
          <circle class="pt" cx="50.0" cy="180.0" r="3.2"/>
          <circle class="pt" cx="290.0" cy="180.0" r="3.2"/>
          <circle class="pt" cx="218.0" cy="36.0" r="3.2"/>
          <circle class="pt" cx="158.0" cy="36.0" r="3.2"/>
          <circle class="pt" cx="254.0" cy="108.0" r="3.2"/>
          <circle class="pt" cx="200.0" cy="180.0" r="3.2"/>
          <text x="42.0" y="196.0" text-anchor="end">A</text>
          <text x="290.0" y="200.0" text-anchor="middle">B</text>
          <text x="226.0" y="30.0">C</text>
          <text x="150.0" y="30.0" text-anchor="end">D</text>
          <text x="264.0" y="112.0">E</text>
          <text x="200.0" y="200.0" text-anchor="middle">F</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 210',
      caption: 'Şekil 189',
      label:
        'ABCD yamuğunda [DE] uzatılıp [AB] nin uzantısını G de kesiyor.',
      svg: `
          <path class="ln" d="M50.0,180.0 L290.0,180.0 L218.0,36.0 L158.0,36.0 Z"/>
          <path class="ln" d="M158.0,36.0 L254.0,108.0"/>
          <path class="ln" d="M254.0,108.0 L200.0,180.0"/>
          ...
          <path class="tick" d="M266.6,146.7 L277.4,141.3"/>
          <path class="tick" d="M230.6,74.7 L241.4,69.3"/>
          <path class="aux" d="M290.0,180.0 L350.0,180.0"/>
          <path class="aux" d="M254.0,108.0 L350.0,180.0"/>
          <circle class="pt" cx="350.0" cy="180.0" r="3.2"/>
          <text x="358.0" y="196.0">G</text>
          <text class="val" x="92.0" y="108.0" text-anchor="end">6</text>
          <text class="val" x="202.0" y="90.0" text-anchor="end">4</text>
          <circle class="pt" cx="50.0" cy="180.0" r="3.2"/>
          <circle class="pt" cx="290.0" cy="180.0" r="3.2"/>
    ...
    stem: [],
    ask: 'Yukarıdaki verilere göre, |DC| + |FB| toplamı kaç cm dir?',
    choices: [
      { key: 'A', text: '3' },
      { key: 'B', text: '2√3' },
      { key: 'C', text: '4' },
    ...
    solution: [
      {
        title: 'Uzatma',
        detail:
          '[DE], [AB] nin uzantısını G de kessin. |BE| = |EC| ve [DC] ∥ [BG] olduğundan DEC ≅ GEB; buradan |EG| = |ED| = 4 cm ve |BG| = |DC|.',
      },
      {
        title: 'Dik üçgen',
        detail:
          'ADG üçgeninde D açısı dik, |AD| = 6 cm, |DG| = 8 cm ⇒ |AG|² = 36 + 64 = 100, |AG| = 10 cm.',
      },
      {
        title: 'Orta taban',
        detail:
          'E, [DG] nin orta noktası ve [EF] ∥ [DA] olduğundan F, [AG] nin orta noktasıdır: |FG| = 5 cm.',
      },
      {
        title: 'Sonuç',
        detail:
          '|FG| = |FB| + |BG| = |FB| + |DC| ⇒ |DC| + |FB| = 5 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-190',
    topic: 'Dik yamukta açıortaylarla alan',
    figure: {
      viewBox: '0 0 400 250',
      caption: 'Şekil 190',
      label:
        'ABCD dik yamuğunda B ve C açıları dik; [AE] ve [DE] açıortay; [EF] ⊥ [BC]; |AB| = 15 cm, |DC| = 6 cm, |EF| = 3 cm.',
      svg: `
          <path class="ln" d="M80.0,220.0 L320.0,220.0 L320.0,28.0 L224.0,28.0 Z"/>
          <path class="ln" d="M80.0,220.0 L272.0,124.0"/>
          <path class="ln" d="M224.0,28.0 L272.0,124.0"/>
          <path class="ln" d="M272.0,124.0 L320.0,124.0"/>
          <path class="arc" d="M310.0,220.0 L310.0,210.0 L320.0,210.0"/>
          <path class="arc" d="M320.0,38.0 L310.0,38.0 L310.0,28.0"/>
          <path class="arc" d="M312.0,124.0 L312.0,116.0 L320.0,116.0"/>
          <path class="arc" d="M106.0,220.0 A26,26 0 0,0 103.3,208.4"/>
          <path class="arc" d="M103.3,208.4 A26,26 0 0,0 95.6,199.2"/>
          <path class="arc" d="M213.2,42.4 A18,18 0 0,0 232.0,44.1"/>
          <path class="arc" d="M232.0,44.1 A18,18 0 0,0 242.0,28.0"/>
          <path class="arc" d="M210.8,45.6 A22,22 0 0,0 233.8,47.7"/>
          <path class="arc" d="M233.8,47.7 A22,22 0 0,0 246.0,28.0"/>
          <text class="val" x="200.0" y="240.0" text-anchor="middle">15</text>
          <text class="val" x="297.6" y="20.0" text-anchor="middle">6</text>
          <text class="val" x="296.0" y="118.0" text-anchor="middle">3</text>
          <circle class="pt" cx="80.0" cy="220.0" r="3.2"/>
          <circle class="pt" cx="320.0" cy="220.0" r="3.2"/>
          <circle class="pt" cx="320.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="224.0" cy="28.0" r="3.2"/>
          <circle class="pt" cx="272.0" cy="124.0" r="3.2"/>
          <circle class="pt" cx="320.0" cy="124.0" r="3.2"/>
          <text x="72.0" y="236.0" text-anchor="end">A</text>
          <text x="328.0" y="236.0">B</text>
          <text x="328.0" y="22.0">C</text>
          <text x="216.0" y="22.0" text-anchor="end">D</text>
          <text x="264.0" y="142.0" text-anchor="end">E</text>
          <text x="330.0" y="129.0">F</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 250',
      caption: 'Şekil 190',
      label:
        'E noktasından [AD], [AB] ve [DC] ye inilen dikmeler K, M ve N noktalarında.',
      svg: `
          <path class="ln" d="M80.0,220.0 L320.0,220.0 L320.0,28.0 L224.0,28.0 Z"/>
          <path class="ln" d="M80.0,220.0 L272.0,124.0"/>
          <path class="ln" d="M224.0,28.0 L272.0,124.0"/>
          ...
          <path class="arc" d="M210.8,45.6 A22,22 0 0,0 233.8,47.7"/>
          <path class="arc" d="M233.8,47.7 A22,22 0 0,0 246.0,28.0"/>
          <path class="aux" d="M272.0,124.0 L195.2,66.4"/>
          <path class="aux" d="M272.0,124.0 L272.0,220.0"/>
          <path class="aux" d="M272.0,124.0 L272.0,28.0"/>
          <circle class="pt" cx="195.2" cy="66.4" r="3.2"/>
          <circle class="pt" cx="272.0" cy="220.0" r="3.2"/>
          <circle class="pt" cx="272.0" cy="28.0" r="3.2"/>
          <text x="185.2" y="64.4" text-anchor="end">K</text>
          <text x="272.0" y="240.0" text-anchor="middle">M</text>
          <text x="268.0" y="20.0" text-anchor="end">N</text>
          <text class="val" x="200.0" y="240.0" text-anchor="middle">15</text>
          <text class="val" x="297.6" y="20.0" text-anchor="middle">6</text>
          <text class="val" x="296.0" y="118.0" text-anchor="middle">3</text>
          <circle class="pt" cx="80.0" cy="220.0" r="3.2"/>
    ...
    answer: 'D',
    hint: 'Açıortay üzerindeki bir nokta, açının kollarına eşit uzaklıktadır.',
    solution: [
      {
        title: 'Dikmeler',
        detail:
          'E den [AD], [AB] ve [DC] ye dikmeler [EK], [EM] ve [EN] olsun. E iki açıortayın üzerinde olduğundan |EK| = |EM| = |EN|.',
      },
      {
        title: 'Eş parçalar',
        detail:
          '|MB| = |NC| = |EF| = 3 cm ⇒ |AM| = 15 − 3 = 12 cm, |DN| = 6 − 3 = 3 cm. Eş dik üçgenlerden |AK| = |AM| = 12 cm, |DK| = |DN| = 3 cm; yani |AD| = 15 cm.',
      },
      {
        title: 'Yükseklik',
        detail:
          'D den [AB] ye inilen dikmenin ayağı ile A arasındaki uzaklık 15 − 6 = 9 cm ⇒ h² = 15² − 9² = 144, h = 12 cm.',
      },
      {
        title: 'Sonuç',
        detail:
          'A(ABCD) = (15 + 6) · 12 / 2 = 126 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-191',
    topic: 'Yamukta paralelkenar ve üçgen alanı',
    figure: {
      viewBox: '0 20 400 180',
      caption: 'Şekil 191',
      label:
        'ABCD yamuğunda E noktası [AB] üzerinde; AECD paralelkenar; paralelkenarın alanı S₁, ECB üçgeninin alanı S₂.',
      svg: `
          <path class="ln" d="M40.0,170.0 L360.0,170.0 L290.0,50.0 L90.0,50.0 Z"/>
          <path class="ln" d="M290.0,50.0 L240.0,170.0"/>
          <text x="170.0" y="116.0" text-anchor="middle">S₁</text>
          <text x="292.0" y="136.0" text-anchor="middle">S₂</text>
          <circle class="pt" cx="40.0" cy="170.0" r="3.2"/>
          <circle class="pt" cx="360.0" cy="170.0" r="3.2"/>
          <circle class="pt" cx="290.0" cy="50.0" r="3.2"/>
          <circle class="pt" cx="90.0" cy="50.0" r="3.2"/>
          <circle class="pt" cx="240.0" cy="170.0" r="3.2"/>
          <text x="32.0" y="186.0" text-anchor="end">A</text>
          <text x="368.0" y="186.0">B</text>
          <text x="298.0" y="44.0">C</text>
          <text x="82.0" y="44.0" text-anchor="end">D</text>
          <text x="240.0" y="190.0" text-anchor="middle">E</text>
        `,
    },
    given: [
      'ABCD bir yamuk ve AECD paralelkenar',
      '|DC| = 10 cm, |AB| = 16 cm',
      'A(AECD) = S₁, A(ECB) = S₂',
      'S₁ − S₂ = 28 cm²',
    ],
    ...
    answer: 'E',
    hint: 'Paralelkenar ile üçgenin yükseklikleri aynıdır; ikisini de h cinsinden yazın.',
    solution: [
      {
        title: 'Tabanlar',
        detail:
          'AECD paralelkenar olduğundan |AE| = |DC| = 10 cm, dolayısıyla |EB| = 16 − 10 = 6 cm.',
      },
      {
        title: 'Alanlar',
        detail:
          'Yükseklik h olsun: S₁ = 10h, S₂ = 6h/2 = 3h.',
      },
      {
        title: 'Denklem',
        detail:
      ...
      },
      {
        title: 'Sonuç',
        detail:
          'A(ABCD) = (10 + 16) · 4 / 2 = 52 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-192',
    topic: 'Dik yamukta dik köşegenlerle alan',
    figure: {
      viewBox: '0 0 400 225',
      caption: 'Şekil 192',
      label:
        'ABCD dik yamuğunda B ve C açıları dik; [AC] ile [BD] E de dik kesişiyor; |DC| = 10 cm, |BC| = 20 cm; ADE üçgeni taralı.',
      svg: `
          <path class="shade" d="M40.0,195.0 L280.0,35.0 L296.0,67.0 Z"/>
          <path class="ln" d="M40.0,195.0 L360.0,195.0 L360.0,35.0 L280.0,35.0 Z"/>
          <path class="ln" d="M40.0,195.0 L360.0,35.0"/>
          <path class="ln" d="M360.0,195.0 L280.0,35.0"/>
          <path class="arc" d="M350.0,195.0 L350.0,185.0 L360.0,185.0"/>
          <path class="arc" d="M360.0,45.0 L350.0,45.0 L350.0,35.0"/>
          <path class="arc" d="M303.2,63.4 L299.6,56.3 L292.4,59.8"/>
          <text class="val" x="320.0" y="27.0" text-anchor="middle">10</text>
          <text class="val" x="370.0" y="120.0">20</text>
          <circle class="pt" cx="40.0" cy="195.0" r="3.2"/>
          <circle class="pt" cx="360.0" cy="195.0" r="3.2"/>
          <circle class="pt" cx="360.0" cy="35.0" r="3.2"/>
          <circle class="pt" cx="280.0" cy="35.0" r="3.2"/>
          <circle class="pt" cx="296.0" cy="67.0" r="3.2"/>
          <text x="32.0" y="211.0" text-anchor="end">A</text>
          <text x="368.0" y="211.0">B</text>
          <text x="368.0" y="29.0">C</text>
          <text x="272.0" y="29.0" text-anchor="end">D</text>
          <text x="296.0" y="89.0" text-anchor="middle">E</text>
        `,
    },
    given: [
      'ABCD dik yamuk',
    ...
    stem: [],
    ask: 'Yukarıdaki verilere göre, ADE üçgeninin alanı kaç cm² dir?',
    choices: [
      { key: 'A', text: '72' },
      { key: 'B', text: '80' },
      { key: 'C', text: '90' },
    ...
    answer: 'B',
    hint: 'DCB ve CBA dik üçgenlerindeki açıları karşılaştırın.',
    solution: [
      {
        title: 'Benzerlik',
        detail:
          '[BD] ⊥ [AC] olduğundan m(CBD) = m(BAC); DCB ∼ CBA ⇒ |DC| / |BC| = |BC| / |AB| ⇒ |AB| = 400/10 = 40 cm.',
      },
      {
        title: 'Eş alanlar',
        detail:
          'ABD ve ABC üçgenlerinin tabanı ve yüksekliği ortaktır; ikisinden A(ABE) çıkarılırsa A(ADE) = A(BCE).',
      },
      {
        title: 'Oran',
        detail:
          'DEC ∼ BEA ⇒ |CE| / |EA| = 10/40 = 1/4, yani |CE| = |CA|/5.',
      },
      {
        title: 'Sonuç',
        detail:
          'A(ABC) = 40 · 20 / 2 = 400 cm² ⇒ A(BCE) = 400/5 = 80 cm², A(ADE) = 80 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-193',
    topic: 'Yamukta dikmeyle Öklit bağıntısı',
    figure: {
      viewBox: '0 0 400 215',
      caption: 'Şekil 193',
      label:
        'ABCD yamuğunda [DC] ∥ [AB]; E noktası [BC] üzerinde; [AD] ⊥ [DE]; [DH] ⊥ [AB]; |AD| = 15 cm, |DE| = 5 cm.',
      svg: `
          <path class="ln" d="M30.0,185.0 L246.0,185.0 L192.0,23.0 L151.5,23.0 Z"/>
          <path class="ln" d="M151.5,23.0 L205.5,63.5"/>
          <path class="ln" d="M151.5,23.0 L151.5,185.0"/>
          <path class="arc" d="M146.1,30.2 L153.3,35.6 L158.7,28.4"/>
          <path class="arc" d="M143.5,185.0 L143.5,177.0 L151.5,177.0"/>
          <text class="val" x="78.8" y="104.0" text-anchor="end">15</text>
          <text class="val" x="181.2" y="64.1" text-anchor="middle">5</text>
          <circle class="pt" cx="30.0" cy="185.0" r="3.2"/>
          <circle class="pt" cx="246.0" cy="185.0" r="3.2"/>
          <circle class="pt" cx="192.0" cy="23.0" r="3.2"/>
          <circle class="pt" cx="151.5" cy="23.0" r="3.2"/>
          <circle class="pt" cx="205.5" cy="63.5" r="3.2"/>
          <circle class="pt" cx="151.5" cy="185.0" r="3.2"/>
          <text x="22.0" y="201.0" text-anchor="end">A</text>
          <text x="250.0" y="205.0">B</text>
          <text x="200.0" y="17.0">C</text>
          <text x="143.5" y="17.0" text-anchor="end">D</text>
          <text x="215.5" y="67.5">E</text>
          <text x="151.5" y="205.0" text-anchor="middle">H</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 215',
      ...
      svg: `
          ...
          <path class="arc" d="M146.1,30.2 L153.3,35.6 L158.7,28.4"/>
          <path class="arc" d="M143.5,185.0 L143.5,177.0 L151.5,177.0"/>
          <path class="aux" d="M246.0,185.0 L367.5,185.0"/>
          <path class="aux" d="M205.5,63.5 L367.5,185.0"/>
          <circle class="pt" cx="367.5" cy="185.0" r="3.2"/>
          <text x="375.5" y="201.0">G</text>
          <text class="val" x="78.8" y="104.0" text-anchor="end">15</text>
          <text class="val" x="181.2" y="64.1" text-anchor="middle">5</text>
          <circle class="pt" cx="30.0" cy="185.0" r="3.2"/>
          <circle class="pt" cx="246.0" cy="185.0" r="3.2"/>
    ...
    stem: [],
    ask: 'Yukarıdaki verilere göre, |AH| kaç cm dir?',
    choices: [
      { key: 'A', text: '9' },
      { key: 'B', text: '10' },
      { key: 'C', text: '12' },
    ...
    answer: 'A',
    hint: '[DE] yi uzatıp [AB] nin uzantısıyla kesiştirin; [DC] ∥ [BG] benzerlik verir.',
    solution: [
      {
        title: 'Uzatma',
        detail:
          '[DE], [AB] nin uzantısını G de kessin. [DC] ∥ [BG] olduğundan DEC ∼ GEB ⇒ |EG| / |ED| = |EB| / |EC| = 3.',
      },
      {
        title: 'Uzunluk',
        detail:
          '|EG| = 3 · 5 = 15 cm ⇒ |DG| = 5 + 15 = 20 cm.',
      },
      {
        title: 'Dik üçgen',
        detail:
          'ADG üçgeninde D açısı dik: |AG|² = 15² + 20² = 625, |AG| = 25 cm.',
      },
      {
        title: 'Öklit',
        detail:
          '[DH] hipotenüse ait yükseklik olduğundan |AD|² = |AH| · |AG| ⇒ 225 = |AH| · 25.',
      },
      {
        title: 'Sonuç',
        detail:
  ...
  {
    id: 'quadrilaterals-194',
    topic: 'Dik yamukta 45° açıyla taban',
    figure: {
      viewBox: '0 0 400 200',
      caption: 'Şekil 194',
      label:
        'ABCD dik yamuğunda [AB] ∥ [DC]; A ve D açıları dik; B açısı 45°; |DC| = 5 cm, |BC| = 6√2 cm.',
      svg: `
          <path class="ln" d="M79.0,170.0 L321.0,170.0 L189.0,38.0 L79.0,38.0 Z"/>
          <path class="arc" d="M89.0,170.0 L89.0,160.0 L79.0,160.0"/>
          <path class="arc" d="M79.0,48.0 L89.0,48.0 L89.0,38.0"/>
          <path class="arc" d="M293.0,170.0 A28,28 0 0,1 301.2,150.2"/>
          <text class="val" x="280.3" y="158.2" text-anchor="middle">45°</text>
          <text class="val" x="134.0" y="29.0" text-anchor="middle">5</text>
          <text class="val" x="264.9" y="99.1">6√2</text>
          <text class="val" x="248.4" y="190.0" text-anchor="middle">x</text>
          <circle class="pt" cx="79.0" cy="170.0" r="3.2"/>
          <circle class="pt" cx="321.0" cy="170.0" r="3.2"/>
          <circle class="pt" cx="189.0" cy="38.0" r="3.2"/>
          <circle class="pt" cx="79.0" cy="38.0" r="3.2"/>
          <text x="71.0" y="186.0" text-anchor="end">A</text>
          <text x="329.0" y="186.0">B</text>
          <text x="197.0" y="32.0">C</text>
          <text x="71.0" y="32.0" text-anchor="end">D</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 200',
      caption: 'Şekil 194',
      label:
        'ABCD dik yamuğunda C den [AB] ye [CH] dikmesi inilmiş.',
      svg: `
          <path class="ln" d="M79.0,170.0 L321.0,170.0 L189.0,38.0 L79.0,38.0 Z"/>
          <path class="arc" d="M89.0,170.0 L89.0,160.0 L79.0,160.0"/>
          <path class="arc" d="M79.0,48.0 L89.0,48.0 L89.0,38.0"/>
          ...
          <text class="val" x="264.9" y="99.1">6√2</text>
          <text class="val" x="248.4" y="190.0" text-anchor="middle">x</text>
          <path class="aux" d="M189.0,38.0 L189.0,170.0"/>
          <path class="aux" d="M198.0,170.0 L198.0,161.0 L189.0,161.0"/>
          <circle class="pt" cx="189.0" cy="170.0" r="3.2"/>
          <text x="189.0" y="190.0" text-anchor="middle">H</text>
          <circle class="pt" cx="79.0" cy="170.0" r="3.2"/>
          <circle class="pt" cx="321.0" cy="170.0" r="3.2"/>
          <circle class="pt" cx="189.0" cy="38.0" r="3.2"/>
          <circle class="pt" cx="79.0" cy="38.0" r="3.2"/>
    ...
    answer: 'B',
    hint: 'C köşesinden [AB] ye dikme inerek bir ikizkenar dik üçgen elde edin.',
    solution: [
      {
        title: 'Dikme',
        detail:
          'C den [AB] ye [CH] dikmesini inelim. ADCH bir dikdörtgendir, yani |AH| = |DC| = 5 cm.',
      },
      {
        title: 'İkizkenar dik üçgen',
        detail:
          'CHB üçgeninde H açısı 90°, B açısı 45° olduğundan |CH| = |HB| ve |BC| = |HB|·√2.',
      },
      {
        title: 'Parça',
        detail:
      ...
      },
      {
        title: 'Sonuç',
        detail:
          'x = |AH| + |HB| = 5 + 6 = 11 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-195',
    topic: 'Yamukta orta taban ve köşegenler',
    figure: {
      viewBox: '0 0 400 215',
      caption: 'Şekil 195',
      label:
        'ABCD yamuğunda [AB] ∥ [DC]; [EF] orta taban; [AC] ve [BD] köşegenleri [EF] yi sırasıyla K ve L de kesiyor; |EK| = 3 cm, |KL| = 5 cm.',
      svg: `
          <path class="ln" d="M40.0,190.0 L360.0,190.0 L230.0,40.0 L110.0,40.0 Z"/>
          <path class="ln" d="M40.0,190.0 L230.0,40.0"/>
          <path class="ln" d="M360.0,190.0 L110.0,40.0"/>
          <path class="ln" d="M75.0,115.0 L295.0,115.0"/>
          <path class="tick" d="M62.9,155.0 L52.1,150.0"/>
          <path class="tick" d="M97.9,80.0 L87.1,75.0"/>
          <path class="tick" d="M333.7,150.5 L324.6,158.3"/>
          <path class="tick" d="M330.4,146.7 L321.3,154.5"/>
          <path class="tick" d="M268.7,75.5 L259.6,83.3"/>
          <path class="tick" d="M265.4,71.7 L256.3,79.5"/>
          <text class="val" x="105.0" y="107.0" text-anchor="middle">3</text>
          <text class="val" x="185.0" y="107.0" text-anchor="middle">5</text>
          <circle class="pt" cx="40.0" cy="190.0" r="3.2"/>
          <circle class="pt" cx="360.0" cy="190.0" r="3.2"/>
          <circle class="pt" cx="230.0" cy="40.0" r="3.2"/>
          <circle class="pt" cx="110.0" cy="40.0" r="3.2"/>
          <circle class="pt" cx="75.0" cy="115.0" r="3.2"/>
          <circle class="pt" cx="295.0" cy="115.0" r="3.2"/>
          <circle class="pt" cx="135.0" cy="115.0" r="3.2"/>
          <circle class="pt" cx="235.0" cy="115.0" r="3.2"/>
          <text x="32.0" y="206.0" text-anchor="end">A</text>
          <text x="368.0" y="206.0">B</text>
          <text x="238.0" y="34.0">C</text>
          <text x="102.0" y="34.0" text-anchor="end">D</text>
          <text x="65.0" y="120.0" text-anchor="end">E</text>
          <text x="305.0" y="120.0">F</text>
          <text x="135.0" y="135.0" text-anchor="middle">K</text>
          <text x="235.0" y="135.0" text-anchor="middle">L</text>
        `,
    },
    given: [
      'ABCD bir yamuk',
    ...
    answer: 'D',
    hint: 'ADC ve ABD üçgenlerinde [EK] ile [EL] birer orta tabandır.',
    solution: [
      {
        title: 'ADC üçgeni',
        detail:
          'E, [AD] nin orta noktası ve [EK] ∥ [DC] olduğundan [EK] bu üçgenin orta tabanıdır: |DC| = 2 · 3 = 6 cm.',
      },
      {
        title: 'ABD üçgeni',
        detail:
          'Aynı şekilde [EL], ABD üçgeninin orta tabanıdır: |EL| = |AB| / 2.',
      },
      {
        title: 'Uzunluk',
        detail:
      ...
      },
      {
        title: 'Sonuç',
        detail:
          '|AB| = 2 · 8 = 16 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-196',
    topic: 'Yamukta dikmelerle özel üçgenler',
    figure: {
      viewBox: '0 0 400 200',
      caption: 'Şekil 196',
      label:
        'ABCD yamuğunda [AB] ∥ [DC]; A açısı 60°, B açısı 45°; |BC| = 6√2 cm, |AD| = x.',
      svg: `
          <path class="ln" d="M41.0,170.0 L359.2,170.0 L227.2,38.0 L117.2,38.0 Z"/>
          <path class="arc" d="M69.0,170.0 A28,28 0 0,0 55.0,145.8"/>
          <text class="val" x="79.1" y="153.0" text-anchor="middle">60°</text>
          <path class="arc" d="M331.2,170.0 A28,28 0 0,1 339.4,150.2"/>
          <text class="val" x="318.6" y="158.2" text-anchor="middle">45°</text>
          <text class="val" x="303.1" y="99.1">6√2</text>
          <text class="val" x="67.0" y="102.0" text-anchor="end">x</text>
          <circle class="pt" cx="41.0" cy="170.0" r="3.2"/>
          <circle class="pt" cx="359.2" cy="170.0" r="3.2"/>
          <circle class="pt" cx="227.2" cy="38.0" r="3.2"/>
          <circle class="pt" cx="117.2" cy="38.0" r="3.2"/>
          <text x="33.0" y="186.0" text-anchor="end">A</text>
          <text x="367.2" y="186.0">B</text>
          <text x="235.2" y="32.0">C</text>
          <text x="109.2" y="32.0" text-anchor="end">D</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 200',
      caption: 'Şekil 196',
      label:
        'ABCD yamuğunda D ve C den [AB] ye [DH] ve [CK] dikmeleri inilmiş.',
      svg: `
          <path class="ln" d="M41.0,170.0 L359.2,170.0 L227.2,38.0 L117.2,38.0 Z"/>
          <path class="arc" d="M69.0,170.0 A28,28 0 0,0 55.0,145.8"/>
          <text class="val" x="79.1" y="153.0" text-anchor="middle">60°</text>
          ...
          <text class="val" x="303.1" y="99.1">6√2</text>
          <text class="val" x="67.0" y="102.0" text-anchor="end">x</text>
          <path class="aux" d="M117.2,38.0 L117.2,170.0"/>
          <path class="aux" d="M227.2,38.0 L227.2,170.0"/>
          <circle class="pt" cx="117.2" cy="170.0" r="3.2"/>
          <circle class="pt" cx="227.2" cy="170.0" r="3.2"/>
          <text x="117.2" y="190.0" text-anchor="middle">H</text>
          <text x="227.2" y="190.0" text-anchor="middle">K</text>
          <circle class="pt" cx="41.0" cy="170.0" r="3.2"/>
          <circle class="pt" cx="359.2" cy="170.0" r="3.2"/>
          <circle class="pt" cx="227.2" cy="38.0" r="3.2"/>
          <circle class="pt" cx="117.2" cy="38.0" r="3.2"/>
    ...
    answer: 'C',
    hint: 'D ve C den tabana dikme inin; iki dikme de yamuğun yüksekliğidir.',
    solution: [
      {
        title: 'Dikmeler',
        detail:
          'D ve C den [AB] ye [DH] ve [CK] dikmelerini inelim. [AB] ∥ [DC] olduğundan |DH| = |CK| = h.',
      },
      {
        title: '45° üçgeni',
        detail:
          'CKB üçgeninde B açısı 45° ⇒ |BC| = h√2 ⇒ 6√2 = h√2, h = 6 cm.',
      },
      {
        title: '60° üçgeni',
        detail:
          'AHD üçgeninde A açısı 60° ⇒ |DH| = x · √3/2.',
      },
      {
        title: 'Sonuç',
        detail:
          '6 = x√3/2 ⇒ x = 12/√3 = 4√3 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-197',
    topic: 'İkizkenar yamukta yükseklik ve alan',
    figure: {
      viewBox: '0 0 400 200',
      caption: 'Şekil 197',
      label:
        'ABCD ikizkenar yamuğunda [AB] ∥ [DC]; |AD| = |BC| = 10 cm; |DC| = 8 cm, |AB| = 20 cm.',
      svg: `
          <path class="ln" d="M40.0,170.0 L360.0,170.0 L264.0,42.0 L136.0,42.0 Z"/>
          <path class="tick" d="M92.8,109.6 L83.2,102.4"/>
          <path class="tick" d="M316.8,102.4 L307.2,109.6"/>
          <text class="val" x="200.0" y="33.0" text-anchor="middle">8</text>
          <text class="val" x="200.0" y="189.0" text-anchor="middle">20</text>
          <text class="val" x="76.8" y="102.6" text-anchor="end">10</text>
          <circle class="pt" cx="40.0" cy="170.0" r="3.2"/>
          <circle class="pt" cx="360.0" cy="170.0" r="3.2"/>
          <circle class="pt" cx="264.0" cy="42.0" r="3.2"/>
          <circle class="pt" cx="136.0" cy="42.0" r="3.2"/>
          <text x="32.0" y="186.0" text-anchor="end">A</text>
          <text x="368.0" y="186.0">B</text>
          <text x="272.0" y="36.0">C</text>
          <text x="128.0" y="36.0" text-anchor="end">D</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 200',
      caption: 'Şekil 197',
      label:
        'ABCD ikizkenar yamuğunda D ve C den [AB] ye [DH] ve [CK] dikmeleri inilmiş.',
      svg: `
          <path class="ln" d="M40.0,170.0 L360.0,170.0 L264.0,42.0 L136.0,42.0 Z"/>
          <path class="tick" d="M92.8,109.6 L83.2,102.4"/>
          <path class="tick" d="M316.8,102.4 L307.2,109.6"/>
          ...
          <text class="val" x="200.0" y="189.0" text-anchor="middle">20</text>
          <text class="val" x="76.8" y="102.6" text-anchor="end">10</text>
          <path class="aux" d="M136.0,42.0 L136.0,170.0"/>
          <path class="aux" d="M264.0,42.0 L264.0,170.0"/>
          <circle class="pt" cx="136.0" cy="170.0" r="3.2"/>
          <circle class="pt" cx="264.0" cy="170.0" r="3.2"/>
          <text x="136.0" y="190.0" text-anchor="middle">H</text>
          <text x="264.0" y="190.0" text-anchor="middle">K</text>
          <circle class="pt" cx="40.0" cy="170.0" r="3.2"/>
          <circle class="pt" cx="360.0" cy="170.0" r="3.2"/>
          <circle class="pt" cx="264.0" cy="42.0" r="3.2"/>
          <circle class="pt" cx="136.0" cy="42.0" r="3.2"/>
    ...
    answer: 'E',
    hint: 'D ve C den tabana dikme inin; ikizkenar yamukta iki yandaki parçalar eşittir.',
    solution: [
      {
        title: 'Dikmeler',
        detail:
          'D ve C den [AB] ye [DH] ve [CK] dikmelerini inelim. HKCD dikdörtgen olduğundan |HK| = |DC| = 8 cm.',
      },
      {
        title: 'Yan parçalar',
        detail:
          'Yamuk ikizkenar olduğundan |AH| = |KB| = (20 − 8) / 2 = 6 cm.',
      },
      {
        title: 'Yükseklik',
        detail:
          'AHD dik üçgeninde |DH|² = 10² − 6² = 64 ⇒ |DH| = 8 cm.',
      },
      {
        title: 'Sonuç',
        detail:
          'Alan(ABCD) = (8 + 20) · 8 / 2 = 112 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-198',
    topic: 'Dik yamukta dik kesişen köşegenler',
    figure: {
      viewBox: '0 0 400 225',
      caption: 'Şekil 198',
      label:
        'ABCD dik yamuğunda [AB] ∥ [DC]; A ve D açıları dik; [AC] ve [BD] köşegenleri E de dik kesişiyor; |DC| = 4 cm, |AB| = 9 cm, |AD| = x.',
      svg: `
          <path class="ln" d="M65.0,200.0 L335.0,200.0 L185.0,20.0 L65.0,20.0 Z"/>
          <path class="ln" d="M65.0,200.0 L185.0,20.0"/>
          <path class="ln" d="M335.0,200.0 L65.0,20.0"/>
          <path class="arc" d="M75.0,200.0 L75.0,190.0 L65.0,190.0"/>
          <path class="arc" d="M65.0,30.0 L75.0,30.0 L75.0,20.0"/>
          <path class="arc" d="M153.1,67.9 L160.6,72.9 L155.6,80.4"/>
          <text class="val" x="125.0" y="11.0" text-anchor="middle">4</text>
          <text class="val" x="200.0" y="219.0" text-anchor="middle">9</text>
          <text class="val" x="51.0" y="115.0" text-anchor="end">x</text>
          <circle class="pt" cx="65.0" cy="200.0" r="3.2"/>
          <circle class="pt" cx="335.0" cy="200.0" r="3.2"/>
          <circle class="pt" cx="185.0" cy="20.0" r="3.2"/>
          <circle class="pt" cx="65.0" cy="20.0" r="3.2"/>
          <circle class="pt" cx="148.1" cy="75.4" r="3.2"/>
          <text x="57.0" y="216.0" text-anchor="end">A</text>
          <text x="343.0" y="216.0">B</text>
          <text x="193.0" y="14.0">C</text>
          <text x="57.0" y="14.0" text-anchor="end">D</text>
          <text x="136.1" y="69.4" text-anchor="end">E</text>
        `,
    },
    given: [
      'ABCD bir dik yamuk',
    ...
    answer: 'D',
    hint: 'Köşegenler dik olduğundan ADC ve BAD dik üçgenlerindeki açıları karşılaştırın.',
    solution: [
      {
        title: 'Açılar',
        detail:
          'm(DAC) = α olsun. AED üçgeninde E açısı dik olduğundan m(ADB) = 90° − α; BAD üçgeninde de m(ABD) = α.',
      },
      {
        title: 'Benzerlik',
        detail:
          'ADC ve BAD dik üçgenlerinde birer açı α olduğundan ADC ∼ BAD ⇒ |DC| / |AD| = |AD| / |AB|.',
      },
      {
        title: 'Denklem',
        detail:
  ...
  {
    id: 'quadrilaterals-199',
    topic: 'Yamukta açıortayların kesişimi',
    figure: {
      viewBox: '0 0 400 240',
      caption: 'Şekil 199',
      label:
        'ABCD yamuğunda [AB] ∥ [DC]; A ve D açılarının açıortayları E de kesişiyor; |AE| = 8 cm, |DE| = 6 cm.',
      svg: `
          <path class="ln" d="M50.0,215.0 L370.0,215.0 L246.0,23.0 L106.0,23.0 Z"/>
          <path class="ln" d="M50.0,215.0 L178.0,119.0"/>
          <path class="ln" d="M106.0,23.0 L178.0,119.0"/>
          <path class="arc" d="M80.0,215.0 A30,30 0 0,0 74.0,197.0"/>
          <path class="arc" d="M74.0,197.0 A30,30 0 0,0 58.4,186.2"/>
          <path class="arc" d="M99.3,46.0 A24,24 0 0,0 120.4,42.2"/>
          <path class="arc" d="M98.2,49.9 A28,28 0 0,0 122.8,45.4"/>
          <path class="arc" d="M120.4,42.2 A24,24 0 0,0 130.0,23.0"/>
          <path class="arc" d="M122.8,45.4 A28,28 0 0,0 134.0,23.0"/>
          <text class="val" x="121.2" y="181.6">8</text>
          <text class="val" x="132.4" y="83.2" text-anchor="end">6</text>
          <circle class="pt" cx="50.0" cy="215.0" r="3.2"/>
          <circle class="pt" cx="370.0" cy="215.0" r="3.2"/>
          <circle class="pt" cx="246.0" cy="23.0" r="3.2"/>
          <circle class="pt" cx="106.0" cy="23.0" r="3.2"/>
          <circle class="pt" cx="178.0" cy="119.0" r="3.2"/>
          <text x="42.0" y="231.0" text-anchor="end">A</text>
          <text x="378.0" y="231.0">B</text>
          <text x="254.0" y="17.0">C</text>
          <text x="98.0" y="17.0" text-anchor="end">D</text>
          <text x="188.0" y="124.0">E</text>
        `,
    },
    given: [
      'ABCD bir yamuk',
    ...
    answer: 'A',
    hint: 'Yamukta aynı yan kenara komşu iki açının toplamı 180° dir.',
    solution: [
      {
        title: 'Açı toplamı',
        detail:
          '[AB] ∥ [DC] olduğundan m(DAB) + m(ADC) = 180°.',
      },
      {
        title: 'Yarım açılar',
        detail:
          'Açıortaylar bu açıları ikiye böler: m(EAD) + m(EDA) = 90°.',
      },
      {
        title: 'Dik üçgen',
        detail:
          'AED üçgeninde m(AED) = 180° − 90° = 90° olur.',
      },
      {
        title: 'Sonuç',
        detail:
          '|AD|² = 8² + 6² = 100 ⇒ |AD| = 10 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-200',
    topic: 'İkizkenar yamukta yükseklikle alan',
    figure: {
      viewBox: '0 0 400 260',
      caption: 'Şekil 200',
      label:
        'ABCD yamuğunda [AB] ∥ [DC]; A ve B açıları eşit; [DH] ⊥ [AB]; |DC| = 6 cm, |DH| = 8 cm, |AH| = 3 cm.',
      svg: `
          <path class="ln" d="M50.0,230.0 L350.0,230.0 L275.0,30.0 L125.0,30.0 Z"/>
          <path class="ln" d="M125.0,30.0 L125.0,230.0"/>
          <path class="arc" d="M125.0,220.0 L135.0,220.0 L135.0,230.0"/>
          <path class="arc" d="M76.0,230.0 A26,26 0 0,0 59.1,205.7"/>
          <path class="arc" d="M340.9,205.7 A26,26 0 0,0 324.0,230.0"/>
          <text class="val" x="200.0" y="21.0" text-anchor="middle">6</text>
          <text class="val" x="133.0" y="136.0">8</text>
          <text class="val" x="87.5" y="249.0" text-anchor="middle">3</text>
          <circle class="pt" cx="50.0" cy="230.0" r="3.2"/>
          <circle class="pt" cx="350.0" cy="230.0" r="3.2"/>
          <circle class="pt" cx="275.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="125.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="125.0" cy="230.0" r="3.2"/>
          <text x="42.0" y="246.0" text-anchor="end">A</text>
          <text x="358.0" y="246.0">B</text>
          <text x="283.0" y="24.0">C</text>
          <text x="117.0" y="24.0" text-anchor="end">D</text>
          <text x="125.0" y="250.0" text-anchor="middle">H</text>
        `,
    },
    given: [
      'ABCD bir yamuk',
    ...
    answer: 'B',
    hint: 'Taban açıları eşit olan yamuk ikizkenardır; C den de tabana bir dikme düşünün.',
    solution: [
      {
        title: 'İkizkenar yamuk',
        detail:
          'm(DAB) = m(ABC) olduğundan ABCD ikizkenar yamuktur; C den [AB] ye inilen dikmenin ayağı K olsun.',
      },
      {
        title: 'Yan parçalar',
        detail:
          'ADH ve BCK üçgenleri eş olduğundan |KB| = |AH| = 3 cm; HKCD dikdörtgen olduğundan |HK| = |DC| = 6 cm.',
      },
      {
        title: 'Alt taban',
        detail:
      ...
      },
      {
        title: 'Sonuç',
        detail:
          'Alan(ABCD) = (6 + 12) · 8 / 2 = 72 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-201',
    topic: 'Dik yamukta Öklit bağıntısıyla alan',
    figure: {
      viewBox: '0 0 400 200',
      caption: 'Şekil 201',
      label:
        'ABCD dik yamuğunda [AB] ∥ [DC]; A ve D açıları dik; [AC] ⊥ [BC]; |AB| = 20 cm, |DC| = 4 cm.',
      svg: `
          <path class="ln" d="M50.0,170.0 L350.0,170.0 L110.0,50.0 L50.0,50.0 Z"/>
          <path class="ln" d="M50.0,170.0 L110.0,50.0"/>
          <path class="arc" d="M60.0,170.0 L60.0,160.0 L50.0,160.0"/>
          <path class="arc" d="M50.0,60.0 L60.0,60.0 L60.0,50.0"/>
          <path class="arc" d="M105.5,58.9 L114.5,63.4 L118.9,54.5"/>
          <text class="val" x="80.0" y="41.0" text-anchor="middle">4</text>
          <text class="val" x="200.0" y="189.0" text-anchor="middle">20</text>
          <circle class="pt" cx="50.0" cy="170.0" r="3.2"/>
          <circle class="pt" cx="350.0" cy="170.0" r="3.2"/>
          <circle class="pt" cx="110.0" cy="50.0" r="3.2"/>
          <circle class="pt" cx="50.0" cy="50.0" r="3.2"/>
          <text x="42.0" y="186.0" text-anchor="end">A</text>
          <text x="358.0" y="186.0">B</text>
          <text x="118.0" y="44.0">C</text>
          <text x="42.0" y="44.0" text-anchor="end">D</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 200',
      ...
      svg: `
          ...
          <text class="val" x="80.0" y="41.0" text-anchor="middle">4</text>
          <text class="val" x="200.0" y="189.0" text-anchor="middle">20</text>
          <path class="aux" d="M110.0,50.0 L110.0,170.0"/>
          <path class="arc" d="M110.0,160.0 L120.0,160.0 L120.0,170.0"/>
          <circle class="pt" cx="110.0" cy="170.0" r="3.2"/>
          <text x="110.0" y="189.0" text-anchor="middle">H</text>
          <circle class="pt" cx="50.0" cy="170.0" r="3.2"/>
          <circle class="pt" cx="350.0" cy="170.0" r="3.2"/>
          <circle class="pt" cx="110.0" cy="50.0" r="3.2"/>
          <circle class="pt" cx="50.0" cy="50.0" r="3.2"/>
    ...
    answer: 'D',
    hint: 'C den [AB] ye dikme inin ve ACB dik üçgeninde Öklit bağıntısını kullanın.',
    solution: [
      {
        title: 'Dikme',
        detail:
          'C den [AB] ye [CH] dikmesini inelim. AHCD dikdörtgen olduğundan |AH| = |DC| = 4 cm, |HB| = 20 − 4 = 16 cm.',
      },
      {
        title: 'Öklit',
        detail:
          'ACB üçgeninde C açısı dik ve [CH] yükseklik olduğundan |CH|² = |AH| · |HB| = 4 · 16 = 64.',
      },
      {
        title: 'Yükseklik',
        detail:
      ...
      },
      {
        title: 'Sonuç',
        detail:
          'Alan(ABCD) = (4 + 20) · 8 / 2 = 96 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-202',
    topic: 'Yamukta eşit aralıklı paralel doğrular',
    figure: {
      viewBox: '0 0 400 260',
      caption: 'Şekil 202',
      label:
        'ABCD yamuğunda [AD] ∥ [BC]; [AB] kenarı E, F, K noktalarıyla ve [DC] kenarı H, G, L noktalarıyla dört eş parçaya ayrılmış; [EH], [FG], [KL] tabanlara paralel; |AD| = 6 cm, |BC| = 18 cm.',
      svg: `
          <path class="ln" d="M130.0,30.0 L226.0,30.0 L344.0,230.0 L56.0,230.0 Z"/>
          <path class="ln" d="M111.5,80.0 L255.5,80.0"/>
          <path class="ln" d="M93.0,130.0 L285.0,130.0"/>
          <path class="ln" d="M74.5,180.0 L314.5,180.0"/>
          <path class="tick" d="M116.1,53.3 L125.4,56.7"/>
          <path class="tick" d="M97.6,103.3 L106.9,106.7"/>
          <path class="tick" d="M79.1,153.3 L88.4,156.7"/>
          <path class="tick" d="M60.6,203.3 L69.9,206.7"/>
          <path class="tick" d="M235.2,55.4 L243.8,50.3"/>
          <path class="tick" d="M237.7,59.7 L246.3,54.6"/>
          <path class="tick" d="M264.7,105.4 L273.3,100.3"/>
          <path class="tick" d="M267.2,109.7 L275.8,104.6"/>
          <path class="tick" d="M294.2,155.4 L302.8,150.3"/>
          <path class="tick" d="M296.7,159.7 L305.3,154.6"/>
          <path class="tick" d="M323.7,205.4 L332.3,200.3"/>
          <path class="tick" d="M326.2,209.7 L334.8,204.6"/>
          <text class="val" x="178.0" y="21.0" text-anchor="middle">6</text>
          <text class="val" x="200.0" y="249.0" text-anchor="middle">18</text>
          <circle class="pt" cx="130.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="226.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="111.5" cy="80.0" r="3.2"/>
          <circle class="pt" cx="255.5" cy="80.0" r="3.2"/>
          <circle class="pt" cx="93.0" cy="130.0" r="3.2"/>
          <circle class="pt" cx="285.0" cy="130.0" r="3.2"/>
          <circle class="pt" cx="74.5" cy="180.0" r="3.2"/>
          <circle class="pt" cx="314.5" cy="180.0" r="3.2"/>
          <circle class="pt" cx="56.0" cy="230.0" r="3.2"/>
          <circle class="pt" cx="344.0" cy="230.0" r="3.2"/>
          <text x="122.0" y="24.0" text-anchor="end">A</text>
          <text x="234.0" y="24.0">D</text>
          <text x="48.0" y="246.0" text-anchor="end">B</text>
          <text x="352.0" y="246.0">C</text>
          <text x="101.5" y="85.0" text-anchor="end">E</text>
          <text x="265.5" y="85.0">H</text>
          <text x="83.0" y="135.0" text-anchor="end">F</text>
          <text x="295.0" y="135.0">G</text>
          <text x="64.5" y="185.0" text-anchor="end">K</text>
          <text x="324.5" y="185.0">L</text>
        `,
    },
    given: [
      'ABCD bir yamuk',
    ...
    stem: [],
    ask: 'Yukarıdaki verilere göre, |EH| + |FG| + |KL| toplamı kaç cm dir?',
    choices: [
      { key: 'A', text: '24' },
      { key: 'B', text: '28' },
      { key: 'C', text: '30' },
    ...
    answer: 'E',
    hint: 'Eş aralıklı paralel doğruların uzunlukları üstten alta eşit adımlarla artar.',
    solution: [
      {
        title: 'Orta taban',
        detail:
          '[FG], ABCD yamuğunun orta tabanıdır: |FG| = (6 + 18) / 2 = 12 cm.',
      },
      {
        title: 'Üst yarı',
        detail:
          '[EH], AFGD yamuğunun orta tabanıdır: |EH| = (6 + 12) / 2 = 9 cm.',
      },
      {
        title: 'Alt yarı',
        detail:
          '[KL], FBCG yamuğunun orta tabanıdır: |KL| = (12 + 18) / 2 = 15 cm.',
      },
      {
        title: 'Sonuç',
        detail:
          '|EH| + |FG| + |KL| = 9 + 12 + 15 = 36 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-203',
    topic: 'Dik yamukta dik köşegenler ve yan kenar',
    figure: {
      viewBox: '0 0 400 220',
      caption: 'Şekil 203',
      label:
        'ABCD dik yamuğunda [AD] ∥ [BC]; A ve B açıları dik; [AC] ve [BD] köşegenleri E de dik kesişiyor; |AD| = 3 cm, |BC| = 12 cm, |DC| = x.',
      svg: `
          <path class="ln" d="M50.0,40.0 L50.0,190.0 L350.0,190.0 L125.0,40.0 Z"/>
          <path class="ln" d="M50.0,40.0 L350.0,190.0"/>
          <path class="ln" d="M50.0,190.0 L125.0,40.0"/>
          <path class="arc" d="M50.0,50.0 L60.0,50.0 L60.0,40.0"/>
          <path class="arc" d="M60.0,190.0 L60.0,180.0 L50.0,180.0"/>
          <path class="arc" d="M114.5,61.1 L123.4,65.5 L118.9,74.5"/>
          <text class="val" x="87.5" y="31.0" text-anchor="middle">3</text>
          <text class="val" x="200.0" y="209.0" text-anchor="middle">12</text>
          <text class="val" x="245.0" y="108.0">x</text>
          <circle class="pt" cx="50.0" cy="40.0" r="3.2"/>
          <circle class="pt" cx="50.0" cy="190.0" r="3.2"/>
          <circle class="pt" cx="350.0" cy="190.0" r="3.2"/>
          <circle class="pt" cx="125.0" cy="40.0" r="3.2"/>
          <circle class="pt" cx="110.0" cy="70.0" r="3.2"/>
          <text x="42.0" y="34.0" text-anchor="end">A</text>
          <text x="42.0" y="206.0" text-anchor="end">B</text>
          <text x="358.0" y="206.0">C</text>
          <text x="133.0" y="34.0">D</text>
          <text x="94.0" y="72.0" text-anchor="end">E</text>
        `,
    },
    given: [
      'ABCD dik yamuğunda',
    ...
    answer: 'D',
    hint: 'Köşegenler dik olduğundan DAB ve ABC dik üçgenleri benzerdir; önce |AB| yi bulun.',
    solution: [
      {
        title: 'Benzerlik',
        detail:
          'm(ABD) = α olsun. [AC] ⊥ [BD] olduğundan m(BAC) = 90° − α ve m(BCA) = α; buradan DAB ∼ ABC.',
      },
      {
        title: 'Yükseklik',
        detail:
          '|AD| / |AB| = |AB| / |BC| ⇒ |AB|² = 3 · 12 = 36 ⇒ |AB| = 6 cm.',
      },
      {
        title: 'Dik üçgen',
        detail:
          'D den [BC] ye dikme inilirse dikey kenar 6 cm, yatay kenar 12 − 3 = 9 cm olur.',
      },
      {
        title: 'Sonuç',
        detail:
          'x² = 6² + 9² = 36 + 81 = 117 ⇒ x = √117 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-204',
    topic: 'Yan kenar ortasından dikmeyle yamuk alanı',
    figure: {
      viewBox: '0 0 400 235',
      caption: 'Şekil 204',
      label:
        'ABCD yamuğunda [AB] ∥ [DC]; E, [AD] kenarının orta noktası; [EH] ⊥ [BC]; |EH| = 8 cm, |BC| = 9 cm.',
      svg: `
          <path class="ln" d="M72.3,205.0 L348.3,205.0 L255.7,19.9 L120.3,19.9 Z"/>
          <path class="ln" d="M96.3,112.4 L260.9,30.1"/>
          <path class="arc" d="M251.9,34.6 L256.4,43.6 L265.4,39.1"/>
          <path class="tick" d="M89.1,160.0 L79.5,157.5"/>
          <path class="tick" d="M113.1,67.4 L103.5,64.9"/>
          <text class="val" x="178.6" y="63.3" text-anchor="middle">8</text>
          <text class="val" x="314.0" y="118.4">9</text>
          <circle class="pt" cx="72.3" cy="205.0" r="3.2"/>
          <circle class="pt" cx="348.3" cy="205.0" r="3.2"/>
          <circle class="pt" cx="255.7" cy="19.9" r="3.2"/>
          <circle class="pt" cx="120.3" cy="19.9" r="3.2"/>
          <circle class="pt" cx="96.3" cy="112.4" r="3.2"/>
          <circle class="pt" cx="260.9" cy="30.1" r="3.2"/>
          <text x="64.3" y="221.0" text-anchor="end">A</text>
          <text x="356.3" y="221.0">B</text>
          <text x="263.7" y="13.9">C</text>
          <text x="120.3" y="11.9" text-anchor="middle">D</text>
          <text x="86.3" y="117.4" text-anchor="end">E</text>
          <text x="274.9" y="38.1">H</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 235',
      caption: 'Şekil 204',
      label:
        'ABCD yamuğunda E den [BC] ye paralel çizilmiş; bu doğru [AB] yi P de, [DC] nin uzantısını Q da kesiyor ve PBCQ paralelkenarı oluşuyor.',
      svg: `
          <path class="ln" d="M72.3,205.0 L348.3,205.0 L255.7,19.9 L120.3,19.9 Z"/>
          <path class="ln" d="M96.3,112.4 L260.9,30.1"/>
          <path class="arc" d="M251.9,34.6 L256.4,43.6 L265.4,39.1"/>
          ...
          <text class="val" x="178.6" y="63.3" text-anchor="middle">8</text>
          <text class="val" x="314.0" y="118.4">9</text>
          <path class="aux" d="M50.0,19.9 L142.6,205.0"/>
          <path class="aux" d="M120.3,19.9 L50.0,19.9"/>
          <circle class="pt" cx="142.6" cy="205.0" r="3.2"/>
          <circle class="pt" cx="50.0" cy="19.9" r="3.2"/>
          <text x="142.6" y="223.0" text-anchor="middle">P</text>
          <text x="42.0" y="13.9" text-anchor="end">Q</text>
          <circle class="pt" cx="72.3" cy="205.0" r="3.2"/>
          <circle class="pt" cx="348.3" cy="205.0" r="3.2"/>
          <circle class="pt" cx="255.7" cy="19.9" r="3.2"/>
          <circle class="pt" cx="120.3" cy="19.9" r="3.2"/>
    ...
    answer: 'B',
    hint: 'E den [BC] ye paralel bir doğru çizip yamuğu bir paralelkenara dönüştürün.',
    solution: [
      {
        title: 'Paralel',
        detail:
          'E den [BC] ye paralel çizelim; [AB] yi P de, [DC] nin uzantısını Q da kessin. PBCQ bir paralelkenardır.',
      },
      {
        title: 'Eş üçgenler',
        detail:
          '|AE| = |ED| ve ters açılar eşit olduğundan EAP ≅ EDQ; bu yüzden Alan(ABCD) = Alan(PBCQ).',
      },
      {
        title: 'Paralelkenar',
        detail:
          'PBCQ nun [BC] tabanına ait yüksekliği, E nin [BC] ye uzaklığıdır: |EH| = 8 cm.',
      },
      {
        title: 'Sonuç',
        detail:
          'Alan(ABCD) = |BC| · |EH| = 9 · 8 = 72 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-205',
    topic: 'Dik yamukta açıortaylar ve orta taban',
    figure: {
      viewBox: '0 0 400 230',
      caption: 'Şekil 205',
      label:
        'ABCD dik yamuğunda [AD] ∥ [BC]; A ve B açıları dik; K, [AB] nin orta noktası; [KT] ⊥ [AB]; [DT] ve [CT], D ve C açılarının açıortayları; |KT| = 5 cm, |DC| = 14 cm.',
      svg: `
          <path class="ln" d="M47.0,25.0 L47.0,205.0 L351.2,205.0 L174.8,25.0 Z"/>
          <path class="ln" d="M47.0,115.0 L137.0,115.0"/>
          <path class="ln" d="M174.8,25.0 L137.0,115.0"/>
          <path class="ln" d="M137.0,115.0 L351.2,205.0"/>
          <path class="arc" d="M57.0,205.0 L57.0,195.0 L47.0,195.0"/>
          <path class="arc" d="M47.0,35.0 L57.0,35.0 L57.0,25.0"/>
          <path class="arc" d="M57.0,115.0 L57.0,105.0 L47.0,105.0"/>
          <path class="tick" d="M42.0,70.0 L52.0,70.0"/>
          <path class="tick" d="M42.0,160.0 L52.0,160.0"/>
          <path class="arc" d="M152.8,25.0 A22,22 0 0,0 166.3,45.3"/>
          <path class="arc" d="M166.3,45.3 A22,22 0 0,0 190.2,40.7"/>
          <path class="arc" d="M334.4,187.9 A24,24 0 0,0 329.1,195.7"/>
          <path class="arc" d="M331.6,185.0 A28,28 0 0,0 325.4,194.2"/>
          <path class="arc" d="M329.1,195.7 A24,24 0 0,0 327.2,205.0"/>
          <path class="arc" d="M325.4,194.2 A28,28 0 0,0 323.2,205.0"/>
          <text class="val" x="92.0" y="107.0" text-anchor="middle">5</text>
          <text class="val" x="279.0" y="109.0">14</text>
          <circle class="pt" cx="47.0" cy="25.0" r="3.2"/>
          <circle class="pt" cx="47.0" cy="205.0" r="3.2"/>
          <circle class="pt" cx="351.2" cy="205.0" r="3.2"/>
          <circle class="pt" cx="174.8" cy="25.0" r="3.2"/>
          <circle class="pt" cx="47.0" cy="115.0" r="3.2"/>
          <circle class="pt" cx="137.0" cy="115.0" r="3.2"/>
          <text x="39.0" y="19.0" text-anchor="end">A</text>
          <text x="39.0" y="221.0" text-anchor="end">B</text>
          <text x="359.2" y="221.0">C</text>
          <text x="176.8" y="17.0" text-anchor="middle">D</text>
          <text x="37.0" y="120.0" text-anchor="end">K</text>
          <text x="139.0" y="137.0" text-anchor="middle">T</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 230',
      caption: 'Şekil 205',
      label:
        'ABCD dik yamuğunda T den [DC] nin orta noktası M ye [TM] çizilmiş.',
      svg: `
          <path class="ln" d="M47.0,25.0 L47.0,205.0 L351.2,205.0 L174.8,25.0 Z"/>
          <path class="ln" d="M47.0,115.0 L137.0,115.0"/>
          <path class="ln" d="M174.8,25.0 L137.0,115.0"/>
          ...
          <text class="val" x="92.0" y="107.0" text-anchor="middle">5</text>
          <text class="val" x="279.0" y="109.0">14</text>
          <path class="aux" d="M137.0,115.0 L263.0,115.0"/>
          <circle class="pt" cx="263.0" cy="115.0" r="3.2"/>
          <text x="254.0" y="106.0" text-anchor="end">M</text>
          <circle class="pt" cx="47.0" cy="25.0" r="3.2"/>
          <circle class="pt" cx="47.0" cy="205.0" r="3.2"/>
          <circle class="pt" cx="351.2" cy="205.0" r="3.2"/>
          <circle class="pt" cx="174.8" cy="25.0" r="3.2"/>
    ...
    stem: [],
    ask: 'Yukarıdaki verilere göre, |AD| + |BC| toplamı kaç cm dir?',
    choices: [
      { key: 'A', text: '24' },
      { key: 'B', text: '26' },
      { key: 'C', text: '28' },
    ...
    answer: 'A',
    hint: 'D ve C açılarının açıortayları dik kesişir; DTC dik üçgeninde hipotenüse ait kenarortayı düşünün.',
    solution: [
      {
        title: 'Dik açı',
        detail:
          'm(ADC) + m(BCD) = 180° olduğundan yarıları toplamı 90° dir; DTC üçgeninde m(DTC) = 90°.',
      },
      {
        title: 'Orta taban',
        detail:
          'T, [AD] ve [BC] ye eşit uzaklıktadır; bu yüzden K den geçen orta taban üzerindedir. Orta taban [DC] yi orta noktası M de keser.',
      },
      {
        title: 'Kenarortay',
        detail:
          'DTC dik üçgeninde [TM] hipotenüse ait kenarortay olduğundan |TM| = 14 / 2 = 7 cm.',
      },
      {
        title: 'Orta taban uzunluğu',
        detail:
          '|KM| = |KT| + |TM| = 5 + 7 = 12 cm.',
      },
      {
  ...
  {
    id: 'quadrilaterals-218',
    topic: 'Dik yamukta dik köşegenler ve alan',
    figure: {
      viewBox: '0 0 400 214',
      caption: 'Şekil 218',
      label:
        'ABCD dik yamuğunda A ve D açıları dik; [AC] ve [BD] köşegenleri E noktasında dik kesişiyor; |DC| / |AB| = 4/9, |AD| = x.',
      svg: `
          <path class="ln" d="M74.0,190.0 L326.0,190.0 L186.0,22.0 L74.0,22.0 Z"/>
          <path class="ln" d="M74.0,190.0 L186.0,22.0"/>
          <path class="ln" d="M326.0,190.0 L74.0,22.0"/>
          <path class="arc" d="M84.0,190.0 L84.0,180.0 L74.0,180.0"/>
          <path class="arc" d="M74.0,32.0 L84.0,32.0 L84.0,22.0"/>
          <path class="arc" d="M157.1,65.4 L165.4,70.9 L159.9,79.2"/>
          <text class="val" x="64.0" y="106.0" text-anchor="end">x</text>
          <circle class="pt" cx="74.0" cy="190.0" r="3.2"/>
          <circle class="pt" cx="326.0" cy="190.0" r="3.2"/>
          <circle class="pt" cx="186.0" cy="22.0" r="3.2"/>
          <circle class="pt" cx="74.0" cy="22.0" r="3.2"/>
          <circle class="pt" cx="151.5" cy="73.7" r="3.2"/>
          <text x="66.0" y="206.0" text-anchor="end">A</text>
          <text x="334.0" y="206.0">B</text>
          <text x="194.0" y="16.0">C</text>
          <text x="66.0" y="16.0" text-anchor="end">D</text>
          <text x="147.5" y="57.7" text-anchor="middle">E</text>
        `,
    },
    given: [
      'ABCD dik yamuk',
    ...
    stem: [],
    ask: 'Yukarıdaki şekilde A(ABCD) = 156 cm² olduğuna göre, |AD| = x kaç cm dir?',
    choices: [
      { key: 'A', text: '6' },
      { key: 'B', text: '8' },
      { key: 'C', text: '10' },
    ...
    answer: 'D',
    hint: 'DAC ve ABD dik üçgenlerindeki eş açıları bulun; benzerlikten |AD|² ile tabanlar arasında bir bağıntı çıkar.',
    solution: [
      {
        title: 'Oranı yazma',
        detail:
          '|DC| = 4k ve |AB| = 9k diyelim.',
      },
      {
        title: 'Eş açılar',
        detail:
          'AED dik üçgeninde m(DAC) + m(ADB) = 90°, DAB dik üçgeninde m(ABD) + m(ADB) = 90° olduğundan m(DAC) = m(ABD).',
      },
      {
        title: 'Benzerlik',
        detail:
          'DAC ~ ABD: |DC| / |AD| = |AD| / |AB|, |AD|² = 4k · 9k = 36k², |AD| = 6k.',
      },
      {
        title: 'Alan',
        detail:
          'A(ABCD) = (4k + 9k) / 2 · 6k = 39k² = 156, k² = 4, k = 2.',
      },
      {
        title: 'Sonuç',
        detail:
  ...
  {
    id: 'quadrilaterals-219',
    topic: 'Yamukta ikizkenar üçgen ve benzerlik',
    figure: {
      viewBox: '0 0 400 182',
      caption: 'Şekil 219',
      label:
        'ABCD yamuğunda [DC] ∥ [AB]; [AC] ⊥ [CB]; D den [AC] ye [DH] dikmesi inilmiş; |AD| = |DC|; |AB| = 26 cm, |DH| = 5 cm.',
      svg: `
          <path class="ln" d="M24.5,150.0 L375.5,150.0 L323.6,25.4 L148.1,25.4 Z"/>
          <path class="ln" d="M24.5,150.0 L323.6,25.4"/>
          <path class="ln" d="M148.1,25.4 L174.0,87.7"/>
          <path class="arc" d="M314.3,29.2 L318.2,38.5 L327.4,34.6"/>
          <path class="arc" d="M170.2,78.5 L179.4,74.6 L183.3,83.8"/>
          <path class="tick" d="M82.7,84.2 L89.8,91.2"/>
          <path class="tick" d="M235.8,20.4 L235.8,30.4"/>
          <text class="val" x="200.0" y="172.0" text-anchor="middle">26</text>
          <text class="val" x="151.1" y="60.5" text-anchor="end">5</text>
          <circle class="pt" cx="24.5" cy="150.0" r="3.2"/>
          <circle class="pt" cx="375.5" cy="150.0" r="3.2"/>
          <circle class="pt" cx="323.6" cy="25.4" r="3.2"/>
          <circle class="pt" cx="148.1" cy="25.4" r="3.2"/>
          <circle class="pt" cx="174.0" cy="87.7" r="3.2"/>
          <text x="16.5" y="166.0" text-anchor="end">A</text>
          <text x="383.5" y="166.0">B</text>
          <text x="331.6" y="19.4">C</text>
          <text x="140.1" y="19.4" text-anchor="end">D</text>
          <text x="174.0" y="109.7" text-anchor="middle">H</text>
        `,
    },
    given: [
      'ABCD bir yamuk',
    ...
    answer: 'B',
    hint: '|AD| = |DC| ve [DC] ∥ [AB] birlikte [AC] için ne söyler? DHC ile BCA üçgenlerini karşılaştırın.',
    solution: [
      {
        title: 'Açıortay',
        detail:
          '[DC] ∥ [AB] olduğundan m(DCA) = m(CAB); |AD| = |DC| olduğundan m(DAC) = m(DCA). Yani [AC], A açısının açıortayı.',
      },
      {
        title: 'Orta nokta',
        detail:
          'ADC ikizkenar olduğundan [DH] yükseklik aynı zamanda kenarortay: |AH| = |HC|.',
      },
      {
        title: 'Benzerlik',
        detail:
          'DHC ~ BCA (H ve C dik, m(DCH) = m(BAC)): |DH| / |BC| = |HC| / |AC| = |DC| / |AB| = 1/2. Buradan |BC| = 10, |DC| = 13 cm.',
      },
      {
        title: 'Köşegen',
        detail:
          'DHC dik üçgeninde |HC|² = 13² − 5² = 144, |HC| = 12, |AC| = 24 cm.',
      },
      {
        title: 'Sonuç',
        detail:
          'A(ABCD) = A(ABC) + A(ADC) = 24 · 10 / 2 + 24 · 5 / 2 = 120 + 60 = 180 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-220',
    topic: 'Dik yamukta köşegen açıortay',
    figure: {
      viewBox: '0 0 400 262',
      caption: 'Şekil 220',
      label:
        'ABCD dik yamuğunda C ve B açıları dik; [AC] köşegeni A açısının açıortayı; |DA| = 8 cm, |AC| = 12 cm, |AB| = x.',
      svg: `
          <path class="ln" d="M83.0,230.0 L317.0,230.0 L317.0,23.6 L109.0,23.6 Z"/>
          <path class="ln" d="M83.0,230.0 L317.0,23.6"/>
          <path class="arc" d="M307.0,23.6 L307.0,33.6 L317.0,33.6"/>
          <path class="arc" d="M317.0,220.0 L307.0,220.0 L307.0,230.0"/>
          <path class="arc" d="M113.0,230.0 A30,30 0 0,0 105.5,210.2"/>
          <path class="arc" d="M105.5,210.2 A30,30 0 0,0 86.8,200.2"/>
          <path class="arc" d="M119.0,230.0 A36,36 0 0,0 110.0,206.2"/>
          <path class="arc" d="M110.0,206.2 A36,36 0 0,0 87.5,194.3"/>
          <text class="val" x="86.0" y="126.8" text-anchor="end">8</text>
          <text class="val" x="256.8" y="99.5">12</text>
          <text class="val" x="200.0" y="252.0" text-anchor="middle">x</text>
          <circle class="pt" cx="83.0" cy="230.0" r="3.2"/>
          <circle class="pt" cx="317.0" cy="230.0" r="3.2"/>
          <circle class="pt" cx="317.0" cy="23.6" r="3.2"/>
          <circle class="pt" cx="109.0" cy="23.6" r="3.2"/>
          <text x="75.0" y="246.0" text-anchor="end">A</text>
          <text x="325.0" y="246.0">B</text>
          <text x="325.0" y="17.6">C</text>
          <text x="101.0" y="17.6" text-anchor="end">D</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 262',
      caption: 'Şekil 220',
      label:
        'D den [AC] ye [DM] dikmesi inilmiş; M, [AC] nin orta noktası.',
      svg: `
          <path class="ln" d="M83.0,230.0 L317.0,230.0 L317.0,23.6 L109.0,23.6 Z"/>
          <path class="ln" d="M83.0,230.0 L317.0,23.6"/>
          <path class="arc" d="M307.0,23.6 L307.0,33.6 L317.0,33.6"/>
          ...
          <path class="arc" d="M119.0,230.0 A36,36 0 0,0 110.0,206.2"/>
          <path class="arc" d="M110.0,206.2 A36,36 0 0,0 87.5,194.3"/>
          <path class="aux" d="M109.0,23.6 L200.0,126.8"/>
          <path class="arc" d="M193.4,119.3 L200.9,112.7 L207.5,120.2"/>
          <circle class="pt" cx="200.0" cy="126.8" r="3.2"/>
          <text x="206.0" y="146.8">M</text>
          <text class="val" x="86.0" y="126.8" text-anchor="end">8</text>
          <text class="val" x="256.8" y="99.5">12</text>
          <text class="val" x="200.0" y="252.0" text-anchor="middle">x</text>
          <circle class="pt" cx="83.0" cy="230.0" r="3.2"/>
    ...
    solution: [
      {
        title: 'İkizkenar',
        detail:
          '[DC] ∥ [AB] olduğundan m(DCA) = m(CAB) = m(DAC); ADC ikizkenar ve |DC| = |DA| = 8 cm.',
      },
      {
        title: 'Dikme',
        detail:
          'D den [DM] ⊥ [AC] inelim; ikizkenar üçgende M orta nokta: |AM| = 12 / 2 = 6 cm.',
      },
      {
        title: 'Benzerlik',
        detail:
          'AMD ~ ABC (M ve B dik, A daki açılar eş): |AM| / |AB| = |AD| / |AC|.',
      },
      {
        title: 'Sonuç',
        detail:
          '6 / x = 8 / 12, x = 9 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-221',
    topic: 'İkizkenar yamukta dik köşegenler',
    figure: {
      viewBox: '0 0 400 256',
      caption: 'Şekil 221',
      label:
        'ABCD ikizkenar yamuğunda [DC] ∥ [AB], |AD| = |BC|; [AC] ve [BD] köşegenleri O noktasında dik kesişiyor; |DC| = 7 cm, |AB| = 23 cm.',
      svg: `
          <path class="ln" d="M50.5,225.0 L349.5,225.0 L245.5,30.0 L154.5,30.0 Z"/>
          <path class="ln" d="M50.5,225.0 L245.5,30.0"/>
          <path class="ln" d="M349.5,225.0 L154.5,30.0"/>
          <path class="arc" d="M206.4,69.1 L212.7,75.5 L206.4,81.9"/>
          <path class="tick" d="M98.1,125.1 L106.9,129.9"/>
          <path class="tick" d="M293.1,129.9 L301.9,125.1"/>
          <text class="val" x="200.0" y="20.0" text-anchor="middle">7</text>
          <text class="val" x="271.5" y="245.0" text-anchor="middle">23</text>
          <circle class="pt" cx="50.5" cy="225.0" r="3.2"/>
          <circle class="pt" cx="349.5" cy="225.0" r="3.2"/>
          <circle class="pt" cx="245.5" cy="30.0" r="3.2"/>
          <circle class="pt" cx="154.5" cy="30.0" r="3.2"/>
          <circle class="pt" cx="200.0" cy="75.5" r="3.2"/>
          <text x="42.5" y="241.0" text-anchor="end">A</text>
          <text x="357.5" y="241.0">B</text>
          <text x="253.5" y="24.0">C</text>
          <text x="146.5" y="24.0" text-anchor="end">D</text>
          <text x="186.0" y="80.5" text-anchor="end">O</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 256',
      caption: 'Şekil 221',
      label:
        'O dan geçen [KL] yüksekliği ve D den [DH] dikmesi çizilmiş.',
      svg: `
          <path class="ln" d="M50.5,225.0 L349.5,225.0 L245.5,30.0 L154.5,30.0 Z"/>
          <path class="ln" d="M50.5,225.0 L245.5,30.0"/>
          <path class="ln" d="M349.5,225.0 L154.5,30.0"/>
          ...
          <path class="tick" d="M98.1,125.1 L106.9,129.9"/>
          <path class="tick" d="M293.1,129.9 L301.9,125.1"/>
          <path class="aux" d="M200.0,30.0 L200.0,225.0"/>
          <path class="aux" d="M154.5,30.0 L154.5,225.0"/>
          <path class="arc" d="M154.5,215.0 L164.5,215.0 L164.5,225.0"/>
          <circle class="pt" cx="200.0" cy="30.0" r="3.2"/>
          <circle class="pt" cx="200.0" cy="225.0" r="3.2"/>
          <circle class="pt" cx="154.5" cy="225.0" r="3.2"/>
          <text x="200.0" y="20.0" text-anchor="middle">K</text>
          <text x="200.0" y="245.0" text-anchor="middle">L</text>
          <text x="154.5" y="245.0" text-anchor="middle">H</text>
          <text class="val" x="214.0" y="20.0">7</text>
          <text class="val" x="271.5" y="245.0" text-anchor="middle">23</text>
          <circle class="pt" cx="50.5" cy="225.0" r="3.2"/>
          <circle class="pt" cx="349.5" cy="225.0" r="3.2"/>
          <circle class="pt" cx="245.5" cy="30.0" r="3.2"/>
    ...
    stem: [],
    ask: 'Yukarıdaki ikizkenar yamukta köşegenler birbirine dik olduğuna göre, yamuğun çevresi kaç cm dir?',
    choices: [
      { key: 'A', text: '54' },
      { key: 'B', text: '58' },
      { key: 'C', text: '64' },
    ...
    answer: 'C',
    hint: 'Köşegenler dik ve eş olduğundan OAB ve ODC ikizkenar dik üçgenlerdir; yüksekliği tabanlardan bulun.',
    solution: [
      {
        title: 'İkizkenar dik üçgenler',
        detail:
          'İkizkenar yamukta |OA| = |OB| ve |OD| = |OC|; köşegenler dik olduğundan OAB ve ODC ikizkenar dik üçgenler.',
      },
      {
        title: 'Yükseklik',
        detail:
          'O dan geçen dikmenin parçaları tabanların yarısıdır: |OK| = 7 / 2, |OL| = 23 / 2, h = (7 + 23) / 2 = 15 cm.',
      },
      {
        title: 'Dikme',
        detail:
          'D den [DH] ⊥ [AB] inelim: |AH| = (23 − 7) / 2 = 8 cm, |DH| = 15 cm.',
      },
      {
        title: 'Yan kenar',
        detail:
          '|AD|² = 8² + 15² = 289, |AD| = |BC| = 17 cm.',
      },
      {
        title: 'Sonuç',
        detail:
          'Çevre = 7 + 23 + 17 + 17 = 64 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-222',
    topic: 'Dik yamukta köşegenler ve Tales',
    figure: {
      viewBox: '0 0 400 296',
      caption: 'Şekil 222',
      label:
        'ABCD dik yamuğunda [DC] ∥ [AB], A ve D açıları dik; köşegenler F noktasında kesişiyor; F den [AD] ye [FE] dikmesi inilmiş; |AE| = |DC|; |DE| = 8 cm, |AB| = 18 cm.',
      svg: `
          <path class="ln" d="M92.0,262.0 L308.0,262.0 L236.0,22.0 L92.0,22.0 Z"/>
          <path class="ln" d="M92.0,262.0 L236.0,22.0"/>
          <path class="ln" d="M308.0,262.0 L92.0,22.0"/>
          <path class="ln" d="M92.0,118.0 L178.4,118.0"/>
          <path class="arc" d="M102.0,262.0 L102.0,252.0 L92.0,252.0"/>
          <path class="arc" d="M92.0,32.0 L102.0,32.0 L102.0,22.0"/>
          <path class="arc" d="M102.0,118.0 L102.0,128.0 L92.0,128.0"/>
          <path class="tick" d="M164.0,17.0 L164.0,27.0"/>
          <path class="tick" d="M87.0,190.0 L97.0,190.0"/>
          <text class="val" x="82.0" y="75.0" text-anchor="end">8</text>
          <text class="val" x="200.0" y="284.0" text-anchor="middle">18</text>
          <circle class="pt" cx="92.0" cy="262.0" r="3.2"/>
          <circle class="pt" cx="308.0" cy="262.0" r="3.2"/>
          <circle class="pt" cx="236.0" cy="22.0" r="3.2"/>
          <circle class="pt" cx="92.0" cy="22.0" r="3.2"/>
          <circle class="pt" cx="92.0" cy="118.0" r="3.2"/>
          <circle class="pt" cx="178.4" cy="118.0" r="3.2"/>
          <text x="84.0" y="278.0" text-anchor="end">A</text>
          <text x="316.0" y="278.0">B</text>
          <text x="244.0" y="16.0">C</text>
          <text x="84.0" y="16.0" text-anchor="end">D</text>
          <text x="82.0" y="123.0" text-anchor="end">E</text>
          <text x="188.4" y="123.0">F</text>
        `,
    },
    given: [
      'ABCD dik yamuk',
    ...
    answer: 'B',
    hint: '[FE] tabanlara paraleldir; |DE| / |EA| oranını hem Tales hem de DFC ~ BFA benzerliğiyle yazın.',
    solution: [
      {
        title: 'Paralellik',
        detail:
          '[FE] ⊥ [AD] ve tabanlar da [AD] ye dik olduğundan [FE] ∥ [DC] ∥ [AB].',
      },
      {
        title: 'Oranlar',
        detail:
          'Tales: |DE| / |EA| = |DF| / |FB|. DFC ~ BFA: |DF| / |FB| = |DC| / |AB|.',
      },
      {
        title: 'Denklem',
        detail:
          '|AE| = |DC| = a diyelim: 8 / a = a / 18, a² = 144, a = 12 cm.',
      },
      {
        title: 'Yükseklik',
        detail:
      ...
      },
      {
        title: 'Sonuç',
        detail:
          'A(ABCD) = (12 + 18) / 2 · 20 = 300 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-223',
    topic: 'Yamukta uzatma ve benzerlik',
    figure: {
      viewBox: '0 0 400 224',
      caption: 'Şekil 223',
      label:
        'ABCD yamuğunda [DC] ∥ [AB]; E, [AD] üzerinde ve |AE| = 2|ED|; [EC] ⊥ [CB]; |EC| = 4 cm, |BC| = 9 cm, |AB| = 11 cm, |DC| = x.',
      svg: `
          <path class="ln" d="M123.0,196.0 L365.0,196.0 L246.2,37.6 L202.2,37.6 Z"/>
          <path class="ln" d="M175.8,90.4 L246.2,37.6"/>
          <path class="arc" d="M238.2,43.6 L244.2,51.6 L252.2,45.6"/>
          <text class="val" x="209.0" y="82.0" text-anchor="middle">4</text>
          <text class="val" x="317.6" y="114.8">9</text>
          <text class="val" x="244.0" y="218.0" text-anchor="middle">11</text>
          <text class="val" x="224.2" y="27.6" text-anchor="middle">x</text>
          <circle class="pt" cx="123.0" cy="196.0" r="3.2"/>
          <circle class="pt" cx="365.0" cy="196.0" r="3.2"/>
          <circle class="pt" cx="246.2" cy="37.6" r="3.2"/>
          <circle class="pt" cx="202.2" cy="37.6" r="3.2"/>
          <circle class="pt" cx="175.8" cy="90.4" r="3.2"/>
          <text x="119.0" y="216.0" text-anchor="middle">A</text>
          <text x="373.0" y="212.0">B</text>
          <text x="254.2" y="31.6">C</text>
          <text x="194.2" y="31.6" text-anchor="end">D</text>
          <text x="165.8" y="86.4" text-anchor="end">E</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 0 400 224',
      caption: 'Şekil 223',
      label:
        '[CE] ve [BA] uzatılmış, K noktasında kesişiyor.',
      svg: `
          <path class="aux" d="M35.0,196.0 L123.0,196.0"/>
          <path class="aux" d="M35.0,196.0 L175.8,90.4"/>
          <path class="ln" d="M123.0,196.0 L365.0,196.0 L246.2,37.6 L202.2,37.6 Z"/>
          <path class="ln" d="M175.8,90.4 L246.2,37.6"/>
          <path class="arc" d="M238.2,43.6 L244.2,51.6 L252.2,45.6"/>
          <text class="val" x="209.0" y="82.0" text-anchor="middle">4</text>
          ...
          <text class="val" x="244.0" y="218.0" text-anchor="middle">11</text>
          <text class="val" x="224.2" y="27.6" text-anchor="middle">x</text>
          <circle class="pt" cx="35.0" cy="196.0" r="3.2"/>
          <text x="27.0" y="212.0" text-anchor="end">K</text>
          <circle class="pt" cx="123.0" cy="196.0" r="3.2"/>
          <circle class="pt" cx="365.0" cy="196.0" r="3.2"/>
          <circle class="pt" cx="246.2" cy="37.6" r="3.2"/>
          <circle class="pt" cx="202.2" cy="37.6" r="3.2"/>
    ...
    stem: [],
    ask: 'Yukarıdaki yamukta |AE| = 2|ED| olduğuna göre, |DC| = x kaç cm dir?',
    choices: [
      { key: 'A', text: '3/2' },
      { key: 'B', text: '7/4' },
      { key: 'C', text: '2' },
    ...
    answer: 'C',
    hint: '[CE] yi, [BA] nın uzantısını kestiği K noktasına kadar uzatın.',
    solution: [
      {
        title: 'Uzatma',
        detail:
          '[CE] ve [BA] uzatılsın, K noktasında kesişsin.',
      },
      {
        title: 'Benzerlik',
        detail:
          '[DC] ∥ [AK] olduğundan KAE ~ CDE: |KE| / |EC| = |KA| / |DC| = |AE| / |ED| = 2.',
      },
      {
        title: 'Uzunluklar',
        detail:
          '|KE| = 2 · 4 = 8, |KC| = 12 cm ve |KA| = 2x.',
      },
      {
        title: 'Pisagor',
        detail:
          'KCB, C de dik: |KB|² = 12² + 9² = 225, |KB| = 15 cm.',
      },
      {
        title: 'Sonuç',
        detail:
          '|KA| = 15 − 11 = 4 = 2x, x = 2 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-224',
    topic: 'Yamukta orta taban ve alan oranı',
    figure: {
      viewBox: '0 0 400 222',
      caption: 'Şekil 224',
      label:
        'ABCD yamuğunda [DC] ∥ [AB]; E, [AD] nin, F de [BC] nin orta noktası; |DE| = |EA| ve |CF| = |FB|; [EF] orta tabanı çizilmiş.',
      svg: `
          <path class="ln" d="M70.0,196.0 L330.0,196.0 L196.7,31.0 L110.0,31.0 Z"/>
          <path class="ln" d="M90.0,113.5 L263.4,113.5"/>
          <path class="tick" d="M95.1,71.1 L104.9,73.4"/>
          <path class="tick" d="M75.1,153.6 L84.9,155.9"/>
          <path class="tick" d="M224.6,73.4 L232.3,67.2"/>
          <path class="tick" d="M227.7,77.3 L235.5,71.1"/>
          <path class="tick" d="M291.2,155.9 L299.0,149.7"/>
          <path class="tick" d="M294.4,159.8 L302.1,153.6"/>
          <circle class="pt" cx="70.0" cy="196.0" r="3.2"/>
          <circle class="pt" cx="330.0" cy="196.0" r="3.2"/>
          <circle class="pt" cx="196.7" cy="31.0" r="3.2"/>
          <circle class="pt" cx="110.0" cy="31.0" r="3.2"/>
          <circle class="pt" cx="90.0" cy="113.5" r="3.2"/>
          <circle class="pt" cx="263.4" cy="113.5" r="3.2"/>
          <text x="62.0" y="212.0" text-anchor="end">A</text>
          <text x="338.0" y="212.0">B</text>
          <text x="204.7" y="25.0">C</text>
          <text x="102.0" y="25.0" text-anchor="end">D</text>
          <text x="80.0" y="118.5" text-anchor="end">E</text>
          <text x="273.4" y="118.5">F</text>
        `,
    },
    given: [
      'ABCD bir yamuk',
    ...
    stem: [],
    ask: 'Yukarıdaki verilere göre, |DC| / |AB| oranı kaçtır?',
    choices: [
      { key: 'A', text: '1/2' },
      { key: 'B', text: '1/3' },
      { key: 'C', text: '1/4' },
    ...
    answer: 'B',
    hint: '[EF] orta taban olduğundan iki parçanın yükseklikleri eşittir; alan oranı paralel kenar toplamlarının oranıdır.',
    solution: [
      {
        title: 'Orta taban',
        detail:
          '|DC| = a, |AB| = b diyelim. E ve F orta noktalar olduğundan |EF| = (a + b) / 2.',
      },
      {
        title: 'Eş yükseklikler',
        detail:
          'EFCD ve ABFE yamuklarının yükseklikleri eşittir (h / 2), bu yüzden alanlar paralel kenar toplamlarıyla orantılıdır.',
      },
      {
        title: 'Denklem',
        detail:
          '(a + (a + b) / 2) / ((a + b) / 2 + b) = (3a + b) / (a + 3b) = 3 / 5.',
      },
      {
        title: 'Çözüm',
        detail:
      ...
      },
      {
        title: 'Sonuç',
        detail:
          '|DC| / |AB| = a / b = 1 / 3 bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-225',
    topic: 'Yamukta açıortay ve benzerlik',
    figure: {
      viewBox: '0 60 400 180',
      caption: 'Şekil 225',
      label:
        'ABCD yamuğunda [DC] ∥ [AB]; [AF], A açısının açıortayı ve [DC] yi E noktasında kesiyor; [BC] nin uzantısı F de [AF] ile dik kesişiyor; |AB| = 20 cm, |DE| = x.',
      svg: `
          <path class="ln" d="M40.0,212.0 L360.0,212.0 L302.8,89.4 Z"/>
          <path class="ln" d="M91.4,150.7 L331.4,150.7"/>
          <path class="ln" d="M40.0,212.0 L91.4,150.7"/>
          <path class="arc" d="M293.8,93.7 L298.0,102.7 L307.1,98.5"/>
          <circle class="pt" cx="40.0" cy="212.0" r="3.2"/>
          <circle class="pt" cx="360.0" cy="212.0" r="3.2"/>
          <circle class="pt" cx="331.4" cy="150.7" r="3.2"/>
          <circle class="pt" cx="91.4" cy="150.7" r="3.2"/>
          <circle class="pt" cx="171.4" cy="150.7" r="3.2"/>
          <circle class="pt" cx="302.8" cy="89.4" r="3.2"/>
          <text class="val" x="131.4" y="142.7" text-anchor="middle">x</text>
          <text class="val" x="200.0" y="234.0" text-anchor="middle">20</text>
          <text x="32.0" y="228.0" text-anchor="end">A</text>
          <text x="368.0" y="228.0">B</text>
          <text x="339.4" y="144.7">C</text>
          <text x="83.4" y="144.7" text-anchor="end">D</text>
          <text x="169.4" y="140.7" text-anchor="middle">E</text>
          <text x="302.8" y="79.4" text-anchor="middle">F</text>
        `,
    },
    given: [
      'ABCD bir yamuk',
    ...
    stem: [],
    ask: 'Yukarıdaki şekilde m(BAF) = m(FAD) olduğuna göre, |DE| = x kaç cm dir?',
    choices: [
      { key: 'A', text: '4' },
      { key: 'B', text: '9/2' },
      { key: 'C', text: '5' },
    ...
    answer: 'C',
    hint: '[AE] açıortay ve [DE] ∥ [AB] olduğundan ADE üçgeni ikizkenardır.',
    solution: [
      {
        title: 'İkizkenar üçgen',
        detail:
          'm(DEA) = m(EAB) = m(DAE) olduğundan |DA| = |DE| = x; buradan |EC| = 2x.',
      },
      {
        title: 'Dik üçgen',
        detail:
          'm(BAF) = α diyelim. AFB, F de dik: |AF| = 20 · cos α.',
      },
      {
        title: 'ADE üçgeni',
        detail:
          'Tepe açısı D de olan ikizkenar üçgende taban |AE| = 2x · cos α; öyleyse |FE| = (20 − 2x) · cos α.',
      },
      {
        title: 'Benzerlik',
        detail:
          '[EC] ∥ [AB] olduğundan FEC ~ FAB: |FE| / |FA| = |EC| / |AB|, (20 − 2x) / 20 = 2x / 20.',
      },
      {
        title: 'Sonuç',
        detail:
          '20 − 2x = 2x, x = 5 cm bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-226',
    topic: 'Dik yamukta açıortay ve dikme',
    figure: {
      viewBox: '0 0 400 248',
      caption: 'Şekil 226',
      label:
        'ABCD dik yamuğunda [DC] ∥ [AB], A ve D açıları dik; E, [AB] üzerinde; [DB] ile [EC] F noktasında dik kesişiyor; |DC| = 13 cm, |AE| = 5 cm.',
      svg: `
          <path class="ln" d="M65.0,216.0 L335.0,216.0 L260.0,36.0 L65.0,36.0 Z"/>
          <path class="ln" d="M65.0,36.0 L335.0,216.0"/>
          <path class="ln" d="M140.0,216.0 L260.0,36.0"/>
          <path class="arc" d="M75.0,216.0 L75.0,206.0 L65.0,206.0"/>
          <path class="arc" d="M65.0,46.0 L75.0,46.0 L75.0,36.0"/>
          <path class="arc" d="M205.0,118.5 L212.5,123.5 L207.5,131.0"/>
          <circle class="pt" cx="65.0" cy="216.0" r="3.2"/>
          <circle class="pt" cx="335.0" cy="216.0" r="3.2"/>
          <circle class="pt" cx="260.0" cy="36.0" r="3.2"/>
          <circle class="pt" cx="65.0" cy="36.0" r="3.2"/>
          <circle class="pt" cx="140.0" cy="216.0" r="3.2"/>
          <circle class="pt" cx="200.0" cy="126.0" r="3.2"/>
          <text class="val" x="162.5" y="28.0" text-anchor="middle">13</text>
          <text class="val" x="102.5" y="238.0" text-anchor="middle">5</text>
          <text x="57.0" y="232.0" text-anchor="end">A</text>
          <text x="343.0" y="232.0">B</text>
          <text x="268.0" y="30.0">C</text>
          <text x="57.0" y="30.0" text-anchor="end">D</text>
          <text x="140.0" y="238.0" text-anchor="middle">E</text>
          <text x="200.0" y="114.0" text-anchor="middle">F</text>
        `,
    },
    given: [
      'ABCD bir dik yamuk',
    ...
    stem: [],
    ask: 'Yukarıdaki şekilde m(CBD) = m(DBA) olduğuna göre, ABCD dik yamuğunun alanı kaç cm² dir?',
    choices: [
      { key: 'A', text: '162' },
      { key: 'B', text: '174' },
      { key: 'C', text: '180' },
    ...
    answer: 'D',
    hint: '[DC] ∥ [AB] olduğundan m(BDC) = m(DBA); BCD üçgenine bakın.',
    solution: [
      {
        title: 'İkizkenar üçgen',
        detail:
          'm(BDC) = m(DBA) = m(CBD) olduğundan BCD ikizkenar: |CB| = |CD| = 13 cm.',
      },
      {
        title: 'Açıortaya dikme',
        detail:
          '[BF] hem açıortay hem de [EC] ye dik olduğundan EBC ikizkenar: |BE| = |BC| = 13 cm.',
      },
      {
        title: 'Alt taban',
        detail:
      ...
      },
      {
        title: 'Yükseklik',
        detail:
          'C den inen dikmenin ayağı ile B arası 18 − 13 = 5 cm: h² = 13² − 5² = 144, h = 12 cm.',
      },
      {
        title: 'Sonuç',
        detail:
          'A(ABCD) = (13 + 18) / 2 · 12 = 186 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-227',
    topic: 'İkizkenar yamukta köşegen ve alan',
    figure: {
      viewBox: '0 20 400 110',
      caption: 'Şekil 227',
      label:
        'ABCD ikizkenar yamuğunda [DC] ∥ [AB], |AD| = |BC|; [BD] köşegeni 12 cm ve [AB] ile 15° lik açı yapıyor.',
      svg: `
          <path class="ln" d="M36.4,100.0 L363.7,100.0 L245.0,44.1 L155.0,44.1 Z"/>
          <path class="ln" d="M363.7,100.0 L155.0,44.1"/>
          <path class="arc" d="M319.7,100.0 A44,44 0 0 1 321.2,88.6"/>
          <text class="val" x="279.7" y="96.0" text-anchor="end">15°</text>
          <text class="val" x="234.5" y="83.5" text-anchor="middle">12</text>
          <path class="tick" d="M97.9,76.6 L93.6,67.5"/>
          <path class="tick" d="M306.5,67.5 L302.2,76.6"/>
          <circle class="pt" cx="36.4" cy="100.0" r="3.2"/>
          <circle class="pt" cx="363.7" cy="100.0" r="3.2"/>
          <circle class="pt" cx="245.0" cy="44.1" r="3.2"/>
          <circle class="pt" cx="155.0" cy="44.1" r="3.2"/>
          <text x="28.4" y="116.0" text-anchor="end">A</text>
          <text x="371.7" y="116.0">B</text>
          <text x="253.0" y="38.1">C</text>
          <text x="147.0" y="38.1" text-anchor="end">D</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 20 400 110',
      caption: 'Şekil 227',
      label:
        'D den [AB] ye [DH] dikmesi inilmiş.',
      svg: `
          <path class="ln" d="M36.4,100.0 L363.7,100.0 L245.0,44.1 L155.0,44.1 Z"/>
          <path class="ln" d="M363.7,100.0 L155.0,44.1"/>
          <path class="arc" d="M319.7,100.0 A44,44 0 0 1 321.2,88.6"/>
          ...
          <path class="tick" d="M97.9,76.6 L93.6,67.5"/>
          <path class="tick" d="M306.5,67.5 L302.2,76.6"/>
          <path class="aux" d="M155.0,44.1 L155.0,100.0"/>
          <path class="arc" d="M163.0,100.0 L163.0,92.0 L155.0,92.0"/>
          <circle class="pt" cx="155.0" cy="100.0" r="3.2"/>
          <text x="155.0" y="122.0" text-anchor="middle">H</text>
          <circle class="pt" cx="36.4" cy="100.0" r="3.2"/>
          <circle class="pt" cx="363.7" cy="100.0" r="3.2"/>
          <circle class="pt" cx="245.0" cy="44.1" r="3.2"/>
          <circle class="pt" cx="155.0" cy="44.1" r="3.2"/>
    ...
    answer: 'A',
    hint: 'D den [AB] ye dikme inin; ikizkenar yamukta |HB| orta taban uzunluğuna eşittir.',
    solution: [
      {
        title: 'Dikme',
        detail:
          'D den [DH] ⊥ [AB] inelim: h = |DH| = 12 · sin 15°, |HB| = 12 · cos 15°.',
      },
      {
        title: 'Orta taban',
        detail:
          'İkizkenar yamukta |HB| = (|AB| + |DC|) / 2 dir.',
      },
      {
        title: 'Alan',
        detail:
          'A(ABCD) = (|AB| + |DC|) / 2 · h = 12 cos 15° · 12 sin 15° = 144 · sin 15° · cos 15°.',
      },
      {
        title: 'Yarım açı',
        detail:
          '2 · sin 15° · cos 15° = sin 30° = 1 / 2 olduğundan 144 · 1 / 4 = 36.',
      },
      {
        title: 'Sonuç',
        detail:
          'A(ABCD) = 36 cm² bulunur.',
      },
    ],
  },
  {
    id: 'quadrilaterals-228',
    topic: 'Dik yamuklardan dikdörtgen',
    figure: {
      viewBox: '0 0 400 212',
      caption: 'Şekil 228',
      label:
        'ABCD dik yamuğunda [DC] ∥ [AB], [DA] ⊥ [AB], B açısı 45°; |AD| = |DC| + 4.',
      svg: `
          <path class="ln" d="M80.0,186.0 L320.0,186.0 L160.0,26.0 L80.0,26.0 Z"/>
          <path class="arc" d="M90.0,186.0 L90.0,176.0 L80.0,176.0"/>
          <path class="arc" d="M80.0,36.0 L90.0,36.0 L90.0,26.0"/>
          <path class="arc" d="M290.0,186.0 A30,30 0 0 1 298.8,164.8"/>
          <text class="val" x="282.0" y="176.0" text-anchor="end">45°</text>
          <circle class="pt" cx="80.0" cy="186.0" r="3.2"/>
          <circle class="pt" cx="320.0" cy="186.0" r="3.2"/>
          <circle class="pt" cx="160.0" cy="26.0" r="3.2"/>
          <circle class="pt" cx="80.0" cy="26.0" r="3.2"/>
          <text x="72.0" y="202.0" text-anchor="end">A</text>
          <text x="328.0" y="202.0">B</text>
          <text x="168.0" y="20.0">C</text>
          <text x="72.0" y="20.0" text-anchor="end">D</text>
        `,
    },
    given: [
      'ABCD dik yamuk',
    ...
    stem: [],
    ask: 'Şekildeki ABCD dik yamuğundan dört tanesi kullanılarak alanı 256 cm² olan bir dikdörtgen elde ediliyor. Buna göre, bu dikdörtgenin çevresi kaç cm olabilir?',
    choices: [
      { key: 'A', text: '56' },
      { key: 'B', text: '64' },
      { key: 'C', text: '72' },
    ...
    answer: 'B',
    hint: 'Önce bir yamuğun alanını bulun: 256 / 4. C den inen dikme 45° lik bir ikizkenar dik üçgen ayırır.',
    solution: [
      {
        title: 'Kenarlar',
        detail:
          '|DC| = a dersek |AD| = a + 4; B açısı 45° olduğundan |AB| = a + (a + 4) = 2a + 4.',
      },
      {
        title: 'Bir yamuğun alanı',
        detail:
          '(a + 2a + 4) / 2 · (a + 4) = 256 / 4 = 64, (3a + 4)(a + 4) = 128.',
      },
      {
        title: 'Çözüm',
        detail:
          '3a² + 16a − 112 = 0, (a − 4)(3a + 28) = 0, a = 4: |DC| = 4, |AD| = 8, |AB| = 12 cm.',
      },
      {
        title: 'İki yamuk',
        detail:
          'Biri ters çevrilip eğik kenarlar çakıştırılınca 8 × (4 + 12) = 8 × 16 lık dikdörtgen oluşur.',
      },
      {
        title: 'Sonuç',
        detail:
          'İki tane 8 × 16 dikdörtgen 16 × 16 (çevre 64) ya da 8 × 32 (çevre 80) verir; seçeneklerde olan 64 cm dir.',
      },
    ],
  },
  {
    id: 'quadrilaterals-229',
    topic: 'Yamukta yükseklik ve üçgen alanı',
    figure: {
      viewBox: '0 10 400 150',
      caption: 'Şekil 229',
      label:
        'ABCD yamuğunda [DC] ∥ [AB]; E, [AB] üzerinde; DCE üçgeni taralı; |DC| = 10 cm, |AD| = 9 cm, |BC| = |AE| = 12 cm, |EB| = 13 cm.',
      svg: `
          <path class="shade" d="M107.7,36.4 L237.7,36.4 L193.5,130.0 Z"/>
          <path class="ln" d="M37.5,130.0 L362.5,130.0 L237.7,36.4 L107.7,36.4 Z"/>
          <path class="ln" d="M107.7,36.4 L193.5,130.0"/>
          <path class="ln" d="M237.7,36.4 L193.5,130.0"/>
          <text class="val" x="172.7" y="28.4" text-anchor="middle">10</text>
          <text class="val" x="64.6" y="83.2" text-anchor="end">9</text>
          <text class="val" x="310.1" y="83.2">12</text>
          <text class="val" x="115.5" y="152.0" text-anchor="middle">12</text>
          <text class="val" x="278.0" y="152.0" text-anchor="middle">13</text>
          <circle class="pt" cx="37.5" cy="130.0" r="3.2"/>
          <circle class="pt" cx="362.5" cy="130.0" r="3.2"/>
          <circle class="pt" cx="237.7" cy="36.4" r="3.2"/>
          <circle class="pt" cx="107.7" cy="36.4" r="3.2"/>
          <circle class="pt" cx="193.5" cy="130.0" r="3.2"/>
          <text x="29.5" y="146.0" text-anchor="end">A</text>
          <text x="370.5" y="146.0">B</text>
          <text x="245.7" y="30.4">C</text>
          <text x="99.7" y="30.4" text-anchor="end">D</text>
          <text x="193.5" y="152.0" text-anchor="middle">E</text>
        `,
    },
    solutionFigure: {
      viewBox: '0 10 400 150',
      ...
      svg: `
          ...
          <text class="val" x="115.5" y="152.0" text-anchor="middle">12</text>
          <text class="val" x="278.0" y="152.0" text-anchor="middle">13</text>
          <path class="aux" d="M237.7,36.4 L167.5,130.0"/>
          <path class="aux" d="M237.7,36.4 L237.7,130.0"/>
          <path class="arc" d="M245.7,130.0 L245.7,122.0 L237.7,122.0"/>
          <circle class="pt" cx="167.5" cy="130.0" r="3.2"/>
          <circle class="pt" cx="237.7" cy="130.0" r="3.2"/>
          <text x="167.5" y="152.0" text-anchor="middle">K</text>
          <text x="237.7" y="152.0" text-anchor="middle">H</text>
          <circle class="pt" cx="37.5" cy="130.0" r="3.2"/>
          <circle class="pt" cx="362.5" cy="130.0" r="3.2"/>
          <circle class="pt" cx="237.7" cy="36.4" r="3.2"/>
          <circle class="pt" cx="107.7" cy="36.4" r="3.2"/>
    ...
    stem: [],
    ask: 'Yukarıdaki şekilde |AE| = |CB| = 12 cm olduğuna göre, A(DCE) kaç cm² dir?',
    choices: [
      { key: 'A', text: '24' },
      { key: 'B', text: '27' },
      { key: 'C', text: '30' },
    ...
    answer: 'E',
    hint: 'DCE nin [DC] tabanına ait yüksekliği yamuğun yüksekliğidir; C den [DA] ya paralel çizin.',
    solution: [
      {
        title: 'Alt taban',
        detail:
      ...
      },
      {
        title: 'Paralel çizme',
        detail:
          'C den [CK] ∥ [DA] çizelim: AKCD paralelkenar, |AK| = 10, |KC| = 9, |KB| = 25 − 10 = 15 cm.',
      },
      {
        title: 'Dik üçgen',
        detail:
          'KCB de 9² + 12² = 225 = 15² olduğundan C açısı diktir.',
      },
      {
        title: 'Yükseklik',
        detail:
          'h = |CH| = 9 · 12 / 15 = 36 / 5 cm.',
      },
      {
        title: 'Sonuç',
        detail:
          'A(DCE) = 10 · (36 / 5) / 2 = 36 cm² bulunur.',
      },
    ],
  },
];
...
export const UNIT_4_QUADRILATERALS: Unit = {
  ...
  modules: [
    ...
    {
      id: 'quadrilaterals-m23',
      order: 23,
      title: 'Dikdörtgen, kare ve deltoidde dikme, benzerlik ve alan',
      summary:
        'Köşegene dikmeyle Öklit bağıntısı, karede eş üçgenlerle açı, dik açıyla benzerlik, deltoidde simetri ekseni ve karede köşegen üzerinde Pisagor.',
      questions: pick(
        'quadrilaterals-134',
        'quadrilaterals-135',
        'quadrilaterals-136',
    ...
    {
      id: 'quadrilaterals-m24',
      order: 24,
      title: 'Dikdörtgen, kare ve deltoidde eş köşegen, yamuk ve benzerlik',
      summary:
        'Eş köşegenle ikizkenar üçgen, karede üçgen alanı, köşegene dikmeyle alan, karede yamukların alan oranı, deltoidde 30° ile alan ve dikdörtgende benzerlik.',
      questions: pick(
        'quadrilaterals-140',
        'quadrilaterals-141',
        'quadrilaterals-142',
    ...
    {
      id: 'quadrilaterals-m26',
      order: 26,
      title: 'Kare, dikdörtgen ve eşkenar dörtgende uzunluk, çevre ve alan',
      summary:
        'Karede köşegen üzerindeki nokta, kare ile dikdörtgenin çevresi, açıortayla ikizkenar üçgen, eşkenar dörtgen ve kare, dikmeyle uzunluk ve karede dik açı.',
      questions: pick(
        'quadrilaterals-152',
        'quadrilaterals-153',
        'quadrilaterals-154',
    ...
    {
      id: 'quadrilaterals-m27',
      order: 27,
      title: 'Dikdörtgen, kare ve paralelkenarda benzerlik ve alan',
      summary:
        'Açıortay teoremiyle 30°, dikmeyle eş dik üçgenler, kelebek benzerliği, üçgen içinde kare, paralelkenarla yamuk alanı ve kesişen doğrularda oran.',
      questions: pick(
        'quadrilaterals-158',
        'quadrilaterals-159',
        'quadrilaterals-160',
    ...
    {
      id: 'quadrilaterals-m28',
      order: 28,
      title: 'Deltoid, kare, altıgen ve dikdörtgende uzunluk ve alan',
      summary:
        'Deltoidde dikme, karede kelebek benzerliği, altıgen ve kare ile üçgen alanı, karede eş dik üçgenler, orta taban ile Öklit ve alan oranı.',
      questions: pick(
        'quadrilaterals-164',
        'quadrilaterals-165',
        'quadrilaterals-166',
    ...
    {
      id: 'quadrilaterals-m29',
      order: 29,
      title: 'Dikdörtgen, kare ve paralelkenarda benzerlik, eşlik ve alan',
      summary:
        'Benzer dikdörtgenler, karede köşegenlerle dik açı, paralelkenar içinde dikdörtgen, iki karede açı, üçgen içinde dikdörtgen ve karede döndürme.',
      questions: pick(
        'quadrilaterals-170',
        'quadrilaterals-171',
        'quadrilaterals-172',
    ...
    {
      id: 'quadrilaterals-m30',
      order: 30,
      title: 'Yamukta uzunluk, açı ve alan',
      summary:
        'Paralel çizerek taban, alan eşitliğiyle kısa taban, kenarortay uzatması, köşegenlerle alan, dik köşegenli ikizkenar yamuk ve dik yamukta açı.',
      questions: pick(
        'quadrilaterals-176',
        'quadrilaterals-177',
        'quadrilaterals-178',
    ...
    {
      id: 'quadrilaterals-m31',
      order: 31,
      title: 'Yamukta orta taban, köşegen ve alan',
      summary:
        'Orta tabanla alan oranı, üçgen alanından taban, orta taban parçalarıyla paralel doğru, ikizkenar yamukta köşegen, eş tabanlı üçgenler ve dik yamukta alan.',
      questions: pick(
        'quadrilaterals-182',
        'quadrilaterals-183',
        'quadrilaterals-184',
    ...
    {
      id: 'quadrilaterals-m32',
      order: 32,
      title: 'Yamukta uzatma, açıortay ve alan',
      summary:
        'Kenar ortasından uzatmayla alan, dikme ve paralelle uzunluk, açıortaylarla dik yamuk, paralelkenar ile üçgen, dik köşegenler ve Öklit.',
      questions: pick(
        'quadrilaterals-188',
        'quadrilaterals-189',
        'quadrilaterals-190',
    ...
    {
      id: 'quadrilaterals-m33',
      order: 33,
      title: 'Yamukta dikme, orta taban ve köşegen',
      summary:
        'Dik yamukta 45° açı, orta tabanla köşegenler, 60°–45° yamuk, ikizkenar yamukta alan, dik köşegenli dik yamuk ve açıortaylar.',
      questions: pick(
        'quadrilaterals-194',
        'quadrilaterals-195',
        'quadrilaterals-196',
    ...
    {
      id: 'quadrilaterals-m34',
      order: 34,
      title: 'Yamukta dikme, orta taban ve alan',
      summary:
        'İkizkenar yamukta alan, dik yamukta Öklit, eş aralıklı paraleller, dik köşegenler, yan kenar ortasından dikme ve açıortaylar.',
      questions: pick(
        'quadrilaterals-200',
        'quadrilaterals-201',
        'quadrilaterals-202',
    ...
    {
      id: 'quadrilaterals-m37',
      order: 37,
      title: 'Yamukta köşegen, benzerlik ve uzatma',
      summary:
        'Dik köşegenli dik yamukta alan, açıortay köşegenle ikizkenar üçgen, ikizkenar yamukta dik köşegenler, köşegenlerle Tales ve kenarı uzatarak benzerlik.',
      questions: pick(
        'quadrilaterals-218',
        'quadrilaterals-219',
        'quadrilaterals-220',
    ...
    {
      id: 'quadrilaterals-m38',
      order: 38,
      title: 'Yamukta orta taban, açıortay ve alan',
      summary:
        'Orta tabanla alan oranı, açıortay ve dik açıyla benzerlik, dik yamukta açıortaya dikme, köşegenden alan, yamuklardan dikdörtgen ve taralı üçgen.',
      questions: pick(
        'quadrilaterals-224',
        'quadrilaterals-225',
        'quadrilaterals-226',
